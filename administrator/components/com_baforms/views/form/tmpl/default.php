...
<script type="text/javascript" src="components/com_baforms/assets/libraries/minicolors/minicolors.js"></script>
...
<div id="integration-element-options-modal" class="ba-modal-cp modal hide">
    ...
    <div class="modal-body">
        ...
        <div class="integration-options" data-group="yandex_kassa">
            <div class="ba-settings-group">
                <div class="ba-settings-item ba-settings-input-type">
                    <span class="ba-settings-item-title">ShopID</span>
                    <input type="text" data-key="shop_id">
                </div>
                <div class="ba-settings-item ba-settings-input-type">
                    <span class="ba-settings-item-title">Scid</span>
                    <input type="text" data-key="scid">
                </div>
                <div class="ba-settings-item ba-settings-select-type">
                    <span class="ba-settings-item-title">Environment</span>
                    <select data-key="environment">
        ...
        <div class="integration-options" data-group="zoho_crm">
            <div class="ba-settings-group">
                <div class="ba-settings-item ba-settings-select-type">
                    <span class="ba-settings-item-title">Host</span>
                    <select class="connect-zoho-crm" data-key="host">
                        <option value="" hidden></option>
                ...
                <div class="ba-settings-item ba-settings-input-type">
                    <span class="ba-settings-item-title">Email</span>
                    <input type="text" data-key="email" class="connect-zoho-crm">
                </div>
                <div class="ba-settings-item ba-settings-input-type">
                    <span class="ba-settings-item-title">Redirect URL</span>
<?php
    $zohoRedirect = JUri::root().'administrator/index.php?option=com_baforms&task=form.generateZohoCRMAccessToken';
?>
                    <input type="text" disabled onfocus="this.blur()" value="<?php echo $zohoRedirect; ?>"
                ...
                <div class="ba-settings-item ba-settings-input-type">
                    <span class="ba-settings-item-title">Scope</span>
<?php
    $zohoScope = 'ZohoCRM.users.ALL,Aaaserver.profile.read,ZohoCRM.settings.all,ZohoCRM.modules.ALL';
?>
                    <input type="text" disabled onfocus="this.blur()" value="<?php echo $zohoScope; ?>"
                        class="select-input field-id-input zoho-redirect-uri">
                    <div class="copy-to-clipboard input-action-icon">
                        <i class="zmdi zmdi-copy"></i>
                        <span class="ba-tooltip ba-top ba-hide-element"><?php echo JText::_('COPY_TO_CLIPBOARD'); ?></span>
                ...
                <div class="ba-settings-item ba-settings-input-type">
                    <span class="ba-settings-item-title">Grant Token</span>
                    <input type="text" data-key="grant_token" class="connect-zoho-crm">
                </div>
                <div class="ba-subgroup-element">
                    <div class="ba-settings-item ba-settings-select-type">
                        <span class="ba-settings-item-title">Select a Layout</span>
                        <select class="zoho-crm-list " data-key="layout_id">
                            <option value="" hidden></option>
                        </select>
                    </div>
                </div>
                            ...
                            <div class="accordion-body collapse in">
                                <div class="accordion-inner">
                                    <div class="ba-settings-group">
                                        ...
                                        <div class="ba-settings-item ba-settings-input-type message-options">
                        ...
                        <div class="ba-settings-group">
                            ...
                            <div class="ba-settings-item ba-settings-font-type">
                                ...
                                <div class="trigger-picker-modal default-country-select" data-modal="default-country-dialog">
                                    ...
                                    <input type="hidden" data-option="default" data-callback="calculationAction">
                                </div>
                            </div>
                            <div class="ba-settings-item ba-settings-input-type">
                                <span class="ba-settings-item-title"><?php echo JText::_('HELP_TEXT'); ?></span>
        ...
        <div class="accordion">
            ...
            <div class="accordion-group">
                ...
                <div class="accordion-body collapse">
                    <div class="accordion-inner">
                        <div class="ba-settings-group">
                            <div class="ba-settings-item ba-settings-select-type not-mask-type">
                            ...
                            <div class="ba-settings-item ba-settings-input-type email-type-options email-confirm-options">
                                <span class="ba-settings-item-title"><?php echo JText::_('ICON'); ?></span>
                                <input type="text" readonly onfocus="this.blur()" class="select-input select-icon" data-group="confirm"
                        ...
                        <div class="ba-settings-group not-email-type-options not-mask-type">
                            <div class="ba-settings-item ba-settings-number-type">
                                <span class="ba-settings-item-title">
            ...
            <div class="ba-integrations-group-wrapper">
                <div class="integrations-group">
                    <div class="integrations-element ba-work-area-element" data-group="payment" data-type="twocheckout">
                        <img src="<?php echo JUri::root().'administrator/components/com_baforms/assets/images/2co.png' ?>">
                        <i class="zmdi zmdi-check-circle"></i>
                        <span>2Checkout</span>
                    </div>
                    <div class="integrations-element ba-work-area-element" data-group="emailling" data-type="activecampaign">
                        <img src="<?php echo JUri::root().'administrator/components/com_baforms/assets/images/activecampaign.png' ?>">
                        <i class="zmdi zmdi-check-circle"></i>
                        <span>ActiveCampaign</span>
                    </div>
                    <div class="integrations-element ba-work-area-element" data-group="emailling" data-type="acymailing">
                        <img src="<?php echo JUri::root().'administrator/components/com_baforms/assets/images/acymailing.png' ?>">
                        <i class="zmdi zmdi-check-circle"></i>
                        <span>AcyMailing</span>
                    </div>
                    <div class="integrations-element ba-work-area-element" data-group="payment" data-type="authorize">
                        <img src="<?php echo JUri::root().'administrator/components/com_baforms/assets/images/authorize-net.png' ?>">
                        <i class="zmdi zmdi-check-circle"></i>
                    ...
                    <div class="integrations-element ba-work-area-element<?php echo baformsHelper::checkIntegration('campaign_monitor'); ?>"
                        ...
                        <img src="<?php echo JUri::root().'administrator/components/com_baforms/assets/images/campaignmonitor.png' ?>">
                        <i class="zmdi zmdi-check-circle"></i>
                        <span>Campaign Monitor</span>
                    </div>
                    <div class="integrations-element ba-work-area-element" data-group="payment" data-type="cloudpayments">
                        <img src="<?php echo JUri::root().'administrator/components/com_baforms/assets/images/cloudpayments.png' ?>">
                        <i class="zmdi zmdi-check-circle"></i>
                        <span>Cloudpayments</span>
                    </div>
                    <div class="integrations-element ba-work-area-element" data-group="emailling" data-type="getresponse">
                        <img src="<?php echo JUri::root().'administrator/components/com_baforms/assets/images/getresponse.png' ?>">
                        <i class="zmdi zmdi-check-circle"></i>
                    ...
                    <div class="integrations-element ba-work-area-element<?php echo baformsHelper::checkIntegration('google_drive'); ?>"
                        ...
                        <img src="<?php echo JUri::root().'administrator/components/com_baforms/assets/images/google-drive.png' ?>">
                        <i class="zmdi zmdi-check-circle"></i>
                        <span>Google Drive</span>
                    </div>
                    <div class="integrations-element ba-work-area-element" data-group="mapping" data-type="google_maps">
                        <img src="<?php echo JUri::root().'administrator/components/com_baforms/assets/images/google-maps.png' ?>">
                        <i class="zmdi zmdi-check-circle"></i>
                    ...
                    <div class="integrations-element ba-work-area-element<?php echo baformsHelper::checkIntegration('google_sheets'); ?>"
                        ...
                        <img src="<?php echo JUri::root().'administrator/components/com_baforms/assets/images/google-sheets.png' ?>">
                        <i class="zmdi zmdi-check-circle"></i>
                        <span>Google Sheets</span>
                    </div>
                    <div class="integrations-element ba-work-area-element" data-group="payment" data-type="liqpay">
                        <img src="<?php echo JUri::root().'administrator/components/com_baforms/assets/images/liqpay.png' ?>">
                        <i class="zmdi zmdi-check-circle"></i>
                        <span>LiqPay</span>
                    </div>
                    <div class="integrations-element ba-work-area-element" data-group="emailling" data-type="mailchimp">
                        <img src="<?php echo JUri::root().'administrator/components/com_baforms/assets/images/mailchimp.png' ?>">
                        <i class="zmdi zmdi-check-circle"></i>
                        <span>Mailchimp</span>
                    </div>
                    <div class="integrations-element ba-work-area-element" data-group="payment" data-type="mollie">
                        <img src="<?php echo JUri::root().'administrator/components/com_baforms/assets/images/mollie.png' ?>">
                        <i class="zmdi zmdi-check-circle"></i>
                        <span>Mollie</span>
                    </div>
                    <div class="integrations-element ba-work-area-element" data-group="payment" data-type="payfast">
                        <img src="<?php echo JUri::root().'administrator/components/com_baforms/assets/images/payfast.png' ?>">
                        <i class="zmdi zmdi-check-circle"></i>
                        <span>PayFast</span>
                    </div>
                    <!--
                    ...
                    <div class="integrations-element ba-work-area-element" data-group="payment" data-type="payu_latam">
                        <img src="<?php echo JUri::root().'administrator/components/com_baforms/assets/images/payu.png' ?>">
                        <i class="zmdi zmdi-check-circle"></i>
                    ...
                    <div class="integrations-element ba-work-area-element<?php echo baformsHelper::checkIntegration('pdf_submissions'); ?>"
                        data-group="data-storage" data-type="pdf_submissions">
                        <img src="<?php echo JUri::root().'administrator/components/com_baforms/assets/images/pdf-submissions.png' ?>">
                        <i class="zmdi zmdi-check-circle"></i>
                    ...
                    <div class="integrations-element ba-work-area-element<?php echo baformsHelper::checkIntegration('redsys'); ?>"
                        ...
                        <img src="<?php echo JUri::root().'administrator/components/com_baforms/assets/images/redsys.png'; ?>">
                        <i class="zmdi zmdi-check-circle"></i>
                        <span>Redsys</span>
                    </div>
                    <div class="integrations-element ba-work-area-element" data-group="payment" data-type="robokassa">
                        <img src="<?php echo JUri::root().'administrator/components/com_baforms/assets/images/robokassa.png'; ?>">
                        <i class="zmdi zmdi-check-circle"></i>
                        <span>Robokassa</span>
                    </div>
                    <div class="integrations-element ba-work-area-element" data-group="payment" data-type="stripe">
                        <img src="<?php echo JUri::root().'administrator/components/com_baforms/assets/images/stripe.png' ?>">
                        <i class="zmdi zmdi-check-circle"></i>
                        <span>Stripe</span>
                    </div>
                    <div class="integrations-element ba-work-area-element" data-group="other" data-type="telegram">
                        <img src="<?php echo JUri::root().'administrator/components/com_baforms/assets/images/telegram.png' ?>">
                        <i class="zmdi zmdi-check-circle"></i>
                        <span>Telegram</span>
                    </div>
                    <div class="integrations-element ba-work-area-element" data-group="payment" data-type="yandex_kassa">
                        <img src="<?php echo JUri::root().'administrator/components/com_baforms/assets/images/yandex-kassa.png' ?>">
                        <i class="zmdi zmdi-check-circle"></i>
                        <span>Yandex Kassa</span>
                    </div>
                    <div class="integrations-element ba-work-area-element<?php echo baformsHelper::checkIntegration('zoho_crm'); ?>"
