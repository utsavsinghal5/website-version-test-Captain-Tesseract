...
class EasyBlogBlockHandlerLiveleak extends EasyBlogBlockHandlerAbstract
{
    public $icon = 'icon-videos-liveleak';
    ...
    public function meta()
    {
        ...
        $meta->player = $template->output('site/composer/blocks/handlers/liveleak/player');
        $meta->wrapper = $template->output('site/composer/blocks/handlers/liveleak/wrapper');
    ...
    public function getHtml($block, $textOnly = false)
    {
        ...
        $contents = $template->output('site/blogs/blocks/liveleak');
