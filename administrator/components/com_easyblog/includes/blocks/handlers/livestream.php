...
class EasyBlogBlockHandlerLiveStream extends EasyBlogBlockHandlerAbstract
{
    public $icon = 'icon-videos-livestream';
    ...
    public function meta()
    {
        ...
        $meta->player = $template->output('site/composer/blocks/handlers/livestream/player');
        $meta->wrapper = $template->output('site/composer/blocks/handlers/livestream/wrapper');
    ...
    public function getHtml($block, $textOnly = false)
    {
        ...
        $contents = $template->output('site/blogs/blocks/livestream');
