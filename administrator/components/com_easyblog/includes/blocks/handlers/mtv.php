...
class EasyBlogBlockHandlerMtv extends EasyBlogBlockHandlerAbstract
{
    public $icon = 'icon-videos-mtv';
    ...
    public function meta()
    {
        ...
        $meta->player = $template->output('site/composer/blocks/handlers/mtv/player');
        $meta->wrapper = $template->output('site/composer/blocks/handlers/mtv/wrapper');
    ...
    public function getHtml($block, $textOnly = false)
    {
        ...
        $contents = $template->output('site/blogs/blocks/mtv');
