...
class EasyBlogStylesheetBuilder
{
	...
	public function run($preset='cache', $options=array())
	{
		...
		$this->task = new EasyBlogStylesheetTask("Building $location stylesheet '$name' using '$preset' preset.");
		$task = $this->task;
	...
	{
		$task = new EasyBlogStylesheetTask("Compiling all sections for group '$group'.");
	...
	{
		$task = new EasyBlogStylesheetTask("Minifying all sections for group '$group'.");
	...
	{
		$task = new EasyBlogStylesheetTask("Building group '$group'.");
	...
	public function writeTarget($group, $type, $mode)
	{
		...
		$task = new EasyBlogStylesheetTask("Writing $type target for '$group'.");
	...
	public function generateIndex($sections=array(), $type='css')
	{
		...
		$task = new EasyBlogStylesheetTask("Generating index for $type sections.");
	...
	{
		$task = new EasyBlogStylesheetTask("Joining $type sections.");
