...
class EasyBlogVideoYoutube extends EasyBlogVideoProvider
{
	...
	public function getEmbedHTML($url, $width = null, $height = null, $amp = false)
	{
		...
		$iframeHtml = '<iframe title="YouTube video player" ' . $width . $height . ' src="' . $url . '&wmode=transparent" frameborder="0" allowfullscreen></iframe>';
		...
		if ($code) {
			...
			$iframeHtml = '<iframe ' . $width . $height . ' src="https://www.youtube.com/embed/' . $code . '?wmode=transparent' . $rel . '" frameborder="0" allowfullscreen></iframe>';
		}
