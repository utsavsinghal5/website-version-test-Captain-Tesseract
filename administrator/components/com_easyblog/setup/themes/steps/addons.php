...
<form name="installation" data-installation-form>
	...
	<div class="hide" style="margin-top: 30px;" data-sync-progress>
		...
		<div class="install-progress" style="border-bottom: 1px #ddd;">
			...
			<div class="row-table">
				<div class="col-cell">
					<div class="hide" data-sync-progress-complete-message><?php echo JText::_('COM_EB_INSTALLATION_MAINTENANCE_EXEC_SCRIPTS_SUCCESS');?></div>
					<div data-sync-progress-active-message=""><?php echo JText::_('COM_EASYBLOG_INSTALLATION_MAINTENANCE_EXEC_SCRIPTS');?></div>
				</div>
				<div class="col-cell cell-result text-right">
			...
			<ol class="install-logs list-reset" data-progress-logs="">
				<li class="pending" data-progress-execscript>
					<div class="notes">
						<ul class="list-unstyled" data-progress-execscript-items>
						</ul>
					</div>
				</li>
			</ol>
