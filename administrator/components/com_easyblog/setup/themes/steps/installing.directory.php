...
$(document).ready(function(){
	...
	<?php if ($reinstall) { ?>
		eb.ajaxUrl = "<?php echo JURI::root();?>administrator/index.php?option=com_easyblog&ajax=1&reinstall=1";
	<?php } ?>

	<?php if ($update) { ?>
		eb.ajaxUrl = "<?php echo JURI::root();?>administrator/index.php?option=com_easyblog&ajax=1&update=1";
	<?php } ?>
	...
	<div data-install-progress>
		...
		<ol class="install-logs list-reset" data-progress-logs="">
			<li class="active" data-progress-extract>
				...
				<div class="split__title"><?php echo JText::_('COM_EASYBLOG_INSTALLATION_INSTALLING_EXTRACTING_FILES');?></div>
				<span class="progress-state text-info"><?php echo JText::_('COM_EASYBLOG_INSTALLATION_INSTALLING_EXTRACTING');?></span>
			</li>
