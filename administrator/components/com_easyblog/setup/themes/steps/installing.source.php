...
$(document).ready(function() {
	...
	<?php if (EB_INSTALLER == 'full') { ?>
		$('[data-installation-form]').submit();
	<?php } ?>

	<?php if (EB_INSTALLER == 'launcher') { ?>
...
<form action="index.php?option=com_easyblog" method="post" name="installation" data-installation-form>
	<div class="hide alert alert-danger" data-source-errors data-api-errors>
		<p data-error-message style="margin-bottom: 15px;"><?php echo JText::_('COM_EASYBLOG_INSTALLATION_METHOD_API_KEY_INVALID'); ?></p>
		<br />
		<a href="https://stackideas.com/forums" class="btn btn-danger btn-sm" target="_blank"><?php echo JText::_('COM_EASYBLOG_INSTALLATION_CONTACT_SUPPORT');?></a>
	</div>
	...
	<div class="installation-methods">
		...
		<input type="text" value="<?php echo EB_KEY;?>" name="apikey" class="hidden" data-api-key />
		<?php } ?>

		<?php if (EB_INSTALLER == 'full' || EB_BETA) { ?>
