		...
		<table class="app-table table table-striped table-eb table-hover">
			...
			<?php if( $reports ){ ?>
				...
				<tr>
					...
					<td class="center">
						<a href="javascript:void(0);" class="btn btn-default btn-xs" data-id="<?php echo $report->id;?>" data-unpublish-post>
							<?php echo JText::_('COM_EASYBLOG_UNPUBLISH_POST'); ?>
						</a>
						<a href="javascript:void(0);" class="btn btn-danger btn-xs" data-id="<?php echo $report->id;?>" data-delete-post>
