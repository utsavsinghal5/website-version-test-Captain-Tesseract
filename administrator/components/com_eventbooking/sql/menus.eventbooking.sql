...
(34, 'EB_SPEAKERS', 2, 'index.php?option=com_eventbooking&view=speakers', 1, 4, 'user'),
(35, 'EB_SPONSORS', 2, 'index.php?option=com_eventbooking&view=sponsors', 1, 5, 'user'),
(23,'EB_DISCOUNT_BUNDLES', 2, 'index.php?option=com_eventbooking&view=discounts', 1, 6, 'tags'),
(7, 'EB_COUNTRIES', 2, 'index.php?option=com_eventbooking&view=countries', 1, 7, 'flag'),
(8, 'EB_STATES', 2, 'index.php?option=com_eventbooking&view=states', 1, 8, 'book'),
(33, 'EB_THEMES', 2, 'index.php?option=com_eventbooking&view=themes', 1, 9, 'tablet'),
