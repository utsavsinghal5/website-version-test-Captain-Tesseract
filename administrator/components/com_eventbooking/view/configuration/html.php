...
class EventbookingViewConfigurationHtml extends RADViewHtml
{
	public function display()
	{
		...
		$options                       = [];
		$options[]                     = JHtml::_('select.option', 0, JText::_('EB_UNTIL_END_OF_DAY'));
		$options[]                     = JHtml::_('select.option', 1, JText::_('EB_UNTIL_CURRENT_TIME_GREATER'));
		$lists['show_upcoming_events'] = JHtml::_('select.genericlist', $options, 'show_upcoming_events', '', 'value', 'text', $config->get('show_upcoming_events', 0));
		...
		$options   = [];
		$options[] = JHtml::_('select.option', '', JText::_('EB_SELECT'), 'name', 'title');
		$options   = array_merge($options, $db->loadObjectList());
		...
		$lists['default_free_event_registration_status'] = JHtml::_('select.genericlist', $options, 'default_free_event_registration_status', '', 'value', 'text', $config->get('default_free_event_registration_status', 1));
		...
		$options[] = JHtml::_('select.option', 'crop_resize', JText::_('EB_CROP_RESIZE'));
		...
		$options[] = JHtml::_('select.option', 2, JText::_('JNO'));
		...
		$options[] = JHtml::_('select.option', 'india', JText::_('India'));
		...
		$options[] = JHtml::_('select.option', 'USLETTER', JText::_('USLETTER'));
