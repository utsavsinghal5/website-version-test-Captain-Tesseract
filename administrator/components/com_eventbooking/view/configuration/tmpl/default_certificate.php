...
<div class="control-group">
    <div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('default_certificate_bg_left', JText::_('EB_DEFAULT_BG_POSITION')); ?>
    </div>
    <div class="controls">
...
<div class="control-group">
    ...
    <div class="controls">
		<?php echo JText::_('EB_WIDTH') . ' (mm)   ';?><input type="text" name="default_certificate_bg_width" class="input-mini" value="<?php echo (int) $config->get('default_certificate_bg_width', 210); ?>" />
		<?php echo JText::_('EB_HEIGHT') . ' (mm)   ';?><input type="text" name="default_certificate_bg_height" class="input-mini" value="<?php echo (int) $config->get('default_certificate_bg_height', 297); ?>" />
    </div>
</div>
<div class="control-group">
	<div class="control-label">
