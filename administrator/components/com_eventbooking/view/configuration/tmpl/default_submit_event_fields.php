...
<div class="control-group">
    <div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('fes_show_thumb_image', JText::sprintf('EB_FES_SUBMIT_EVENT', JText::_('EB_IMAGE'))); ?>
    </div>
    <div class="controls">
...
<div class="control-group">
    <div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('fes_show_group_registration_rates_tab', JText::sprintf('EB_FES_SUBMIT_EVENT_TAB', JText::_('EB_GROUP_REGISTRATION_RATES'))); ?>
    </div>
    <div class="controls">
...
<div class="control-group">
    <div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('fes_show_misc_tab', JText::sprintf('EB_FES_SUBMIT_EVENT_TAB', JText::_('EB_MISC'))); ?>
    </div>
    <div class="controls">
...
<div class="control-group">
    <div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('fes_show_discount_setting_tab', JText::sprintf('EB_FES_SUBMIT_EVENT_TAB', JText::_('EB_DISCOUNT_SETTING'))); ?>
    </div>
    <div class="controls">
...
<div class="control-group">
    <div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('fes_show_extra_information_tab', JText::sprintf('EB_FES_SUBMIT_EVENT_TAB', JText::_('EB_EXTRA_INFORMATION'))); ?>
    </div>
    <div class="controls">
