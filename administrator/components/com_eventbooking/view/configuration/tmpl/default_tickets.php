...
<div class="control-group">
    <div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('default_ticket_bg_left', JText::_('EB_DEFAULT_BG_POSITION')); ?>
    </div>
    <div class="controls">
		<?php echo JText::_('EB_LEFT') . '    ';?><input type="text" name="default_ticket_bg_left" class="input-mini" value="<?php echo (int) $config->default_ticket_bg_left; ?>" />
		<?php echo JText::_('EB_TOP') . '    ';?><input type="text" name="default_ticket_bg_top" class="input-mini" value="<?php echo (int) $config->default_ticket_bg_top; ?>" />
    </div>
</div>
<div class="control-group">
    <div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('default_ticket_bg_width', JText::_('EB_DEFAULT_BG_SIZE')); ?>
    </div>
    <div class="controls">
		<?php echo JText::_('EB_WIDTH') . ' (mm)    ';?><input type="text" name="default_ticket_bg_width" class="input-mini" value="<?php echo (int) $config->get('default_ticket_bg_width', 210); ?>" />
		<?php echo JText::_('EB_HEIGHT') . ' (mm)    ';?><input type="text" name="default_ticket_bg_height" class="input-mini" value="<?php echo (int) $config->get('default_ticket_bg_height', 297); ?>" />
    </div>
</div>
<div class="control-group">
	<div class="control-label">
