	...
	<div id="j-main-container">
		<div id="filter-bar" class="btn-toolbar">
			<div class="filter-search btn-group pull-left">
				<label for="filter_search" class="element-invisible"><?php echo JText::_('EB_FILTER_SEARCH_COUPONS_DESC');?></label>
		...
		<table class="adminlist table table-striped">
			...
			<tr>
                ...
                <th width="15%" class="center title" nowrap="nowrap">
					<?php echo JHtml::_('grid.sort',  JText::_('EB_NOTE'), 'tbl.note', $this->state->filter_order_Dir, $this->state->filter_order ); ?>
                </th>
