	...
	<div id="j-main-container">
		...
		<table class="adminlist table table-striped">
			...
			$emailTypes = [
				...
				'event_update_emails'              => JText::_('EB_EVENT_UPDATE_EMAILS'),
				'waiting_list_notification_emails' => JText::_('EB_WAITING_LIST_NOTIFICATION_EMAILS'),
				'request_payment_emails'           => JText::_('EB_REQUEST_PAYMENT_EMAILS'),
			];
