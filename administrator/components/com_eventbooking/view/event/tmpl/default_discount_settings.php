...
<div class="control-group">
	...
	<div class="controls">
		<?php echo JHtml::_('calendar', $this->item->early_bird_discount_date, 'early_bird_discount_date', 'early_bird_discount_date', $this->datePickerFormat . ' %H:%M', ['class' => 'input-medium', 'showTime' => true]); ?>
	</div>
</div>
...
<div class="control-group">
	...
	<div class="controls">
		<?php echo JHtml::_('calendar', $this->item->late_fee_date, 'late_fee_date', 'late_fee_date', $this->datePickerFormat . ' %H:%M', ['class' => 'input-medium', 'showTime' => true]); ?>
	</div>
</div>
