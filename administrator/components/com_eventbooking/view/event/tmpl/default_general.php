...
JFactory::getDocument()->addScript(JUri::root(true) . '/media/com_eventbooking/assets/js/eventbookingjq.min.js');
...
<fieldset class="form-horizontal options-form">
    ...
    <?php
        if (JPluginHelper::isEnabled('system', 'eventbookingsms'))
        {
        ?>
            <div class="control-group">
                <div class="control-label">
			        <?php echo JText::_('EB_ENABLE_SMS'); ?>
                </div>
                <div class="controls">
