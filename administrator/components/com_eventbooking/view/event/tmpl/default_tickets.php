...
<div class="control-group">
	<div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('ticket_bg_left', JText::_('EB_BG_POSITION')); ?>
	</div>
	<div class="controls">
...
<div class="control-group">
    ...
    <div class="controls">
		<?php echo JText::_('EB_WIDTH') . ' (mm)    ';?><input type="text" name="ticket_bg_width" class="input-mini" value="<?php echo (int) $this->item->ticket_bg_width; ?>" />
		<?php echo JText::_('EB_HEIGHT') . ' (mm)    ';?><input type="text" name="ticket_bg_height" class="input-mini" value="<?php echo (int) $this->item->ticket_bg_height; ?>" />
    </div>
</div>
<div class="control-group">
	<div class="control-label">
