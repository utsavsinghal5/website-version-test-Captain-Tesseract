...
<form action="index.php?option=com_eventbooking&view=message" method="post" name="adminForm" id="adminForm" class="form-horizontal eb-configuration">
	...
	<?php echo JHtml::_('bootstrap.endTab'); ?>
	<?php echo JHtml::_('bootstrap.addTab', 'message', 'waitinglist-messages-page', JText::_('EB_WAITING_LIST_MESSAGES', true)); ?>
	...
	echo JHtml::_('bootstrap.addTab', 'message', 'sms-page', JText::_('EB_SMS_MESSAGES', true));
