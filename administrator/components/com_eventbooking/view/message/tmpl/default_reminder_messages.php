...
<div class="control-group">
    <div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('second_reminder_email_subject', JText::_('EB_SECOND_REMINDER_EMAIL_SUBJECT')); ?>
        <p class="eb-available-tags">
			<?php echo JText::_('EB_AVAILABLE_TAGS'); ?>: [EVENT_TITLE]
        </p>
    </div>
...
<div class="control-group">
    <div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('second_reminder_email_body', JText::_('EB_SECOND_REMINDER_EMAIL_BODY')); ?>
        <p class="eb-available-tags">
			<?php echo JText::_('EB_AVAILABLE_TAGS'); ?>: <strong>[REGISTRATION_DETAIL], [EVENT_DATE], [FIRST_NAME], [LAST_NAME], [EVENT_TITLE]</strong>
        </p>
    </div>
...
<div class="control-group">
    <div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('offline_payment_reminder_email_subject', JText::_('EB_OFFLINE_PAYMENT_REMINDER_EMAIL_SUBJECT')); ?>
        <p class="eb-available-tags">
			<?php echo JText::_('EB_AVAILABLE_TAGS'); ?>: [EVENT_TITLE]
        </p>
    </div>
...
<div class="control-group">
    <div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('offline_payment_reminder_email_body', JText::_('EB_OFFLINE_PAYMENT_REMINDER_EMAIL_BODY')); ?>
        <p class="eb-available-tags">
			<?php echo JText::_('EB_AVAILABLE_TAGS'); ?>: <strong>[EVENT_DATE], [FIRST_NAME], [LAST_NAME], [EVENT_TITLE], [AMOUNT], [REGISTRATION_ID]</strong>
        </p>
    </div>
    <div class="controls">
