...
<div class="control-group">
    <div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('new_registration_admin_sms', JText::_('EB_NEW_REGISTRATION_ADMIN_SMS')); ?>
    </div>
    <div class="controls">
...
<div class="control-group">
    <div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('first_reminder_sms', JText::_('EB_FIRST_REMINDER_SMS')); ?>
    </div>
    <div class="controls">
...
<div class="control-group">
    <div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('second_reminder_sms', JText::_('EB_SECOND_REMINDER_SMS')); ?>
    </div>
    <div class="controls">
