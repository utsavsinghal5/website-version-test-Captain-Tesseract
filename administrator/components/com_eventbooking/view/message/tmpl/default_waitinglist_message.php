...
<div class="control-group">
	<div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('waitinglist_form_message', JText::_('EB_WAITING_LIST_FORM_MESSAGE'), JText::_('EB_WAITING_LIST_FORM_MESSAGE_EXPLAIN')); ?>
...
<div class="control-group">
	<div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('waitinglist_complete_message', JText::_('EB_WAITING_LIST_COMPLETE_MESSAGE'), JText::_('EB_WAITING_LIST_COMPLETE_MESSAGE_EXPLAIN')); ?>
		<p class="eb-available-tags">
...
<div class="control-group">
	<div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('watinglist_confirmation_subject', JText::_('EB_WAITING_LIST_CONFIRMATION_SUBJECT'), JText::_('EB_WAITING_LIST_CONFIRMATION_SUBJECT_EXPLAIN')); ?>
	</div>
	<div class="controls">
...
<div class="control-group">
	<div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('watinglist_confirmation_body', JText::_('EB_WAITING_LIST_CONFIRMATION_BODY'), JText::_('EB_WAITING_LIST_COMPLETE_MESSAGE_EXPLAIN')); ?>
		<p class="eb-available-tags">
			<?php echo JText::_('EB_AVAILABLE_TAGS'); ?>: <strong>[EVENT_TITLE], [FIRST_NAME], [LAST_NAME]</strong>
		</p>
	</div>
...
<div class="control-group">
	<div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('watinglist_notification_subject', JText::_('EB_WAITING_LIST_NOTIFICATION_SUBJECT'), JText::_('EB_WAITING_LIST_NOTIFICATION_SUBJECT_EXPLAIN')); ?>
	</div>
	<div class="controls">
...
<div class="control-group">
	<div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('watinglist_notification_body', JText::_('EB_WAITING_LIST_NOTIFICATION_BODY'), JText::_('EB_WAITING_LIST_NOTIFICATION_BODY_EXPLAIN')); ?>
		<p class="eb-available-tags">
			<?php echo JText::_('EB_AVAILABLE_TAGS'); ?>: <strong>[EVENT_TITLE], [FIRST_NAME], [LAST_NAME]</strong>
		</p>
	</div>
...
<div class="control-group">
	<div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('registrant_waitinglist_notification_subject', JText::_('EB_REGISTRANT_WAITING_LIST_NOTIFICATION_SUBJECT'), JText::_('EB_REGISTRANT_WAITING_LIST_NOTIFICATION_SUBJECT_EXPLAIN')); ?>
	</div>
	<div class="controls">
...
<div class="control-group">
	<div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('registrant_waitinglist_notification_body', JText::_('EB_REGISTRANT_WAITING_LIST_NOTIFICATION_BODY'), JText::_('EB_REGISTRANT_WAITING_LIST_NOTIFICATION_BODY_EXPLAIN')); ?>
		<p class="eb-available-tags">
...
<div class="control-group">
    <div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('request_payment_email_subject_pdr', JText::_('EB_REQUEST_PAYMENT_EMAIL_SUBJECT_FOR_PENDING_REGISTRATION'), JText::_('EB_REQUEST_PAYMENT_EMAIL_SUBJECT_FOR_PENDING_REGISTRATION_EXPLAIN')); ?>
    </div>
    <div class="controls">
        <input type="text" name="request_payment_email_subject_pdr" class="input-xlarge" size="70" value="<?php echo $this->message->request_payment_email_subject_pdr ; ?>" />
    </div>
</div>
<div class="control-group">
    <div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('request_payment_email_body_pdr', JText::_('EB_REQUEST_PAYMENT_EMAIL_BODY_FOR_PENDING_REGISTRATION'), JText::_('EB_REQUEST_PAYMENT_EMAIL_BODY_FOR_PENDING_REGISTRATION_EXPLAIN')); ?>
        <p class="eb-available-tags">
			<?php echo JText::_('EB_AVAILABLE_TAGS'); ?>: <strong>[FIRST_NAME], [LAST_NAME],[EVENT_TITLE] , [EVENT_DATE], [PAYMENT_LINK]</strong>
        </p>
    </div>
