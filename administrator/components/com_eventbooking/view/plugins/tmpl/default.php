...
JText::script('EB_CHOOSE_PLUGIN', true);
JFactory::getDocument()->addScript(JUri::root(true) . '/media/com_eventbooking/js/admin-plugins-default.min.js');
?>
				...
				<td>
					<fieldset class="adminform">
						...
						<table>
							<tr>
								<td>
									<input type="file" name="plugin_package" id="plugin_package" size="50" class="inputbox" /> <input type="button" class="button" id="btn-install-plugin" value="<?php echo JText::_('EB_INSTALL'); ?>" onclick="installPlugin();" />
								</td>
							</tr>
						</table>
					</fieldset>
