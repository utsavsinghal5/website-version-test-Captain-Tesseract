...
JFactory::getDocument()->addScript(JUri::root(true).'/media/com_eventbooking/js/admin-registrants-default.min.js');
	...
	<div id="j-main-container">
		<div id="filter-bar" class="btn-toolbar">
			<div class="filter-search btn-group pull-left">
				...
				<?php
                    echo JHtml::_('calendar', $this->state->filter_from_date, 'filter_from_date', 'filter_from_date', $this->datePickerFormat, array('class' => 'input-small', 'placeholder' => JText::_('EB_FROM')));
                    echo JHtml::_('calendar', $this->state->filter_to_date, 'filter_to_date', 'filter_to_date', $this->datePickerFormat, array('class' => 'input-small', 'placeholder' => JText::_('EB_TO')));
				?>
			</div>
