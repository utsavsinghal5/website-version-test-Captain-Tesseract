...
if ($saveOrder)
{
    ...
    {
	    JHtml::_('sortablelist.sortable', 'speakersList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
    }
}
        ...
        <table class="adminlist table table-striped" id="speakersList">
            <thead>
                <tr>
                    ...
                    <th class="title">
                        <?php echo JHtml::_('grid.sort',  JText::_('EB_DESCRIPTION'), 'tbl.description', $this->state->filter_order_Dir, $this->state->filter_order ); ?>
                    </th>
                    <th class="title">
                        <?php echo JHtml::_('grid.sort',  JText::_('EB_URL'), 'tbl.url', $this->state->filter_order_Dir, $this->state->filter_order ); ?>
                    </th>
            ...
            {
                $row       = $this->items[$i];
                $link      = JRoute::_('index.php?option=com_eventbooking&view=speaker&id=' . $row->id);
