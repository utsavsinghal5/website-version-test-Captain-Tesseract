...
JText::script('EB_CHOOSE_THEME', true);

JFactory::getDocument()->addScript(JUri::root(true) . '/media/com_eventbooking/js/admin-themes-default.min.js');
?>
				...
				<td>
					<fieldset class="adminform">
						...
						<table>
							<tr>
								<td>
									<input type="file" name="theme_package" id="theme_package" size="50" class="inputbox" /> <input type="button" class="button" id="btn-install-theme" value="<?php echo JText::_('EB_INSTALL'); ?>" onclick="installPlugin();" />
								</td>
							</tr>
						</table>
					</fieldset>
