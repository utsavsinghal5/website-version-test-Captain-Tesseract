...
class gridboxModelPaymentmethods extends JModelList
{
    ...
    public function getMethod($key)
    {
        ...
        switch ($key) {
            ...
            case 'mollie':
                ...
                break;
            case 'yandex-kassa':
                $obj->title = 'Yandex Checkout';
                $obj->image = 'yandex-checkout.png';
                break;
            case 'klarna':
                $obj->title = 'Klarna';
    ...
    {
        $keys = array('offline', 'twocheckout', 'authorize', 'cloudpayments', 'klarna', 'liqpay', 'mollie',
            'payfast', 'paypal', 'payupl', 'stripe', 'yandex-kassa');
