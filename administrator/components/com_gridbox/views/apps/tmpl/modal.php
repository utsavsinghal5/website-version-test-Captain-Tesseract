    ...
    document.addEventListener('DOMContentLoaded', function(){
        ...
        for (var i = 0; i < items.length; i++) {
            items[i].addEventListener('click', function(event){
                ...
                var url = 'index.php?option=com_gridbox&view=category&tmpl=component&id='+this.dataset.id,
                ...
                window.parent.document.querySelector('#jform_request_id_id').value = 0;
                ...
                url = 'index.php?option=com_gridbox&view=blog&app='+this.dataset.id;
