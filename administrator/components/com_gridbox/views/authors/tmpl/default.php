...
<div id="ba-author-users-dialog" class="ba-modal-lg modal hide" style="display:none">
    <div class="modal-header">
...
<?php
                               foreach ($this->items as $i => $item) { 
                                    ...
                                    if (strpos($avatar, 'balbooa.com') === false) {
...
?>
                                <tr>
                                    ...
                                    <td class="status-td">
                                        <?php echo JHtml::_('gridboxhtml.jgrid.published', $item->published, $i, 'authors.', $canChange); ?>
                                    </td>
                                    <td class="title-cell">
