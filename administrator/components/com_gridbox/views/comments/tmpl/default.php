                    ...
                    <div class="ba-options-group">
                        ...
                        <div class="ba-subgroup-element">
                            <div class="ba-group-element">
                                ...
                                <input type="text" class="website-comments-settings"
                                    placeholder="App id"
                                    data-website="comments_facebook_login_key">
                            </div>
                        </div>
                    </div>
                    <div class="ba-options-group">
                        ...
                        <div class="ba-subgroup-element">
                            <div class="ba-group-element">
                                ...
                                <input type="text" class="website-comments-settings"
                                    ...
                                    data-website="comments_google_login_key">
                            </div>
                        </div>
                    </div>
                    <div class="ba-options-group">
                        ...
                        <div class="ba-subgroup-element">
                            <div class="ba-group-element">
                                ...
                                <input type="text" class="website-comments-settings"
                                    placeholder="App id"
                                    data-website="comments_vk_login_key">
                            </div>
                        </div>
                    </div>
                </div>
...
<?php
                            foreach ($this->items as $i => $item) {
                                ...
                                $avatar = $item->avatar;
                                if (empty($avatar)) {
                                    $avatar = gridboxHelper::getGravatarImage($item->email);
                                }
?>
