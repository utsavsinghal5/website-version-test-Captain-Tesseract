                        ...
                        <div class="filter-search-wrapper">
                            ...
                            <div class="order-date-range">
                                <div class="">
                                    ...
                                    <input type="text" class="open-calendar-dialog" placeholder="<?php echo JText::_('FROM'); ?>"
                                ...
                                <div class="">
                                    <i class="zmdi zmdi-calendar-alt"></i>
                                    <input type="text" class="open-calendar-dialog" placeholder="<?php echo JText::_('TO'); ?>"
...
<?php
                           foreach ($this->items as $i => $item) { 
                                $date = JDate::getInstance($item->date)->format('M d, Y, H:i');
    ...
    <div class="modal-body">
        <div class="orders-details-header">
            ...
            <div class="orders-details-icons">
                <span>
                    <i class="zmdi zmdi-edit edit-exist-order"></i>
                    <span class="ba-tooltip ba-bottom ba-hide-element"><?php echo JText::_('EDIT'); ?></span>
                </span>
                <span>
                    <i class="zmdi zmdi-assignment-returned download-exist-order" data-layout="pdf"></i>
                    <span class="ba-tooltip ba-bottom ba-hide-element"><?php echo JText::_('DOWNLOAD'); ?></span>
                </span>
                <span>
                    <i class="zmdi zmdi-print download-exist-order" data-layout="print"></i>
...
<?php
                $className = empty($this->shipping) && empty($this->promo) ? ' ba-hide-element' : '';
?>
                <div class="ba-options-group-wrapper<?php echo $className; ?>">
...
<div id="extra-options-dialog" class="modal hide ba-modal-picker picker-modal-arrow ba-modal-list-picker" style="display: none;">
    <div class="modal-body modal-list-type-wrapper">
        <div class="ba-settings-item ba-settings-input-type">
            <input type="text" placeholder="<?php echo JText::_('JSEARCH_FILTER'); ?>" class="picker-search">
            <i class="zmdi zmdi-search"></i>
...
<div id="order-coupon-code-dialog" class="modal hide ba-modal-picker picker-modal-arrow ba-modal-list-picker" style="display: none;">
    <div class="modal-body modal-list-type-wrapper">
        <div class="ba-settings-item ba-settings-input-type">
            <input type="text" placeholder="<?php echo JText::_('JSEARCH_FILTER'); ?>" class="picker-search">
            <i class="zmdi zmdi-search"></i>
