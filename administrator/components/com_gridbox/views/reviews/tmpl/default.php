                    ...
                    <div class="ba-options-group">
                        ...
                        <div class="ba-subgroup-element">
                            <div class="ba-group-element">
                                ...
                                <input type="text" class="website-comments-settings"
                                    placeholder="App id"
                                    data-website="reviews_facebook_login_key">
                            </div>
                        </div>
                    </div>
                    <div class="ba-options-group">
                        ...
                        <div class="ba-subgroup-element">
                            <div class="ba-group-element">
                                ...
                                <input type="text" class="website-comments-settings"
                                    ...
                                    data-website="reviews_google_login_key">
                            </div>
                        </div>
                    </div>
                    <div class="ba-options-group">
                        <div class="ba-group-element">
                            <label>VK Login</label>
                            <label class="ba-checkbox">
                                <input type="checkbox" class="website-comments-settings set-group-display ba-hide-element"
                        ...
                        <div class="ba-subgroup-element">
                            <div class="ba-group-element">
                                ...
                                <input type="text" class="website-comments-settings"
                                    placeholder="App id"
                                    data-website="reviews_vk_login_key">
                            </div>
                        </div>
                    </div>
                </div>
...
<div id="ba-comments-users-dialog" class="ba-modal-lg modal hide" style="display:none">
    <div class="modal-header">
...
<?php
                            foreach ($this->items as $i => $item) {
                                ...
                                $avatar = $item->avatar;
                                if (empty($avatar)) {
                                    $avatar = gridboxHelper::getReviewsGravatarImage($item->email);
                                }
?>
