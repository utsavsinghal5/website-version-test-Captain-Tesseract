...
<link rel="stylesheet" href="components/com_gridbox/assets/css/ba-admin.css?<?php echo $this->about->version; ?>" type="text/css"/>
                ...
                <div class="ba-work-area" style="width: 70%;">
                    <div class="table-head">
                        <div class="files-name ba-hide-checkbox">
                            ...
                            <i class="zmdi zmdi-check-circle check-all ba-icon-md"></i>
