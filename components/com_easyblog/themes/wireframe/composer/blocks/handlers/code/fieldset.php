	...
	<div class="eb-composer-fieldset-content o-form-horizontal">
		<div class="o-form-group">
			...
			<div class="o-control-input">
				<select class="o-form-control" data-code-mode>
		...
		<div class="o-form-group">
			...
			<div class="o-control-input">
				<select class="o-form-control" data-code-fontsize>
		...
		<div class="o-form-group">
			...
			<div class="o-control-input">
				<select id="theme" class="o-form-control" data-code-theme>
		...
		<div class="o-form-group">
			<label class="o-control-label eb-composer-field-label" for="code-height">
				<?php echo JText::_('COM_EB_COMPOSER_HEIGHT'); ?>
			</label>
			<div class="o-control-input">
		...
		<?php echo $this->html('composer.field', 'form.toggler', 'gutter', 'COM_EASYBLOG_COMPOSER_BLOCKS_CODE_SHOW_GUTTER', $data->show_gutter, 'data-code-gutter'); ?>
	</div>
</div>