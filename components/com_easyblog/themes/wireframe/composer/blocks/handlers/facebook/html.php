...
<div class="eb-composer-placeholder eb-composer-link-placeholder text-center" data-fb-form>
	<i class="eb-composer-placeholder-icon fa fa-facebook-official"></i>
	<b class="eb-composer-placeholder-title"><?php echo JText::_('COM_EASYBLOG_COMPOSER_BLOCKS_FACEBOOK_EMBED_POST');?></b>
	<p class="eb-composer-placeholder-brief"><?php echo JText::_('COM_EASYBLOG_COMPOSER_BLOCKS_FACEBOOK_EMBED_POST_NOTE');?></p>
