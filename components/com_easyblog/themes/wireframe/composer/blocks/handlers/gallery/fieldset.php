			...
			<div class="eb-gallery-ratio-info-field" data-eb-gallery-ratio-info-field data-name="gallery-ratio-info">
				<div class="eb-composer-fieldgroup-content">
					<div class="o-row">
						...
						<div class="o-col-sm"><button type="button" class="btn btn--sm btn-eb-default-o pull-right" data-eb-gallery-ratio-button><?php echo JText::_('COM_EASYBLOG_CHANGE_BUTTON'); ?></button></div>
					</div>
				</div>
			</div>
