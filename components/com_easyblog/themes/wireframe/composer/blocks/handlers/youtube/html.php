...
<div class="eb-composer-placeholder eb-composer-link-placeholder text-center" data-youtube-form>
	<i class="eb-composer-placeholder-icon fa fa-youtube"></i>

	<b class="eb-composer-placeholder-title">
		<?php echo JText::_('COM_EASYBLOG_COMPOSER_BLOCKS_YOUTUBE_PLACEHOLDER_TITLE');?>
	</b>
	<p class="eb-composer-placeholder-brief">
		<?php echo JText::_('COM_EASYBLOG_COMPOSER_BLOCKS_YOUTUBE_PLACEHOLDER_NOTE');?>
	</p>
