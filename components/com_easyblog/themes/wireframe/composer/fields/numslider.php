...
?>
<div class="o-form-group eb-numslider<?php echo $classname; ?>" data-type="numslider" data-eb-numslider<?php echo $attrs; ?>>
	...
	<div class="row-table eb-composer-fieldrow" <?php echo $container; ?>>
		...
		<?php if ($resetToggle) { ?>
			<a href="javascript:void(0);" class="btn btn-eb-default-o btn--xs" data-eb-numslider-toggle>
