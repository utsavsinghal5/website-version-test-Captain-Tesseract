...
<dialog>
	...
	<buttons>
		<button data-close-button type="button" class="btn btn-eb-default btn--sm"><?php echo JText::_('COM_EASYBLOG_CLOSE_BUTTON'); ?></button>
		<button data-submit-button type="button" class="btn btn-eb-primary btn--sm"><?php echo JText::_('COM_EASYBLOG_CREATE_FOLDER_BUTTON'); ?></button>
	</buttons>
</dialog>
