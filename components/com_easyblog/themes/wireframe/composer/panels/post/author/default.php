...
<div class="eb-composer-fieldset">
	<div class="eb-composer-fieldset-header">
		<strong><?php echo JText::_('COM_EASYBLOG_COMPOSER_PANEL_AUTHOR'); ?></strong>
	</div>
		...
		<div class="o-form-group o-form-group--eb-style-bordered t-lg-p--md">
			...
			<div class="eb-sub-author current-author" data-eb-composer-author>
				...
				<div class="o-grid">
					...
					<?php if (EB::isSiteAdmin() || $this->acl->get('moderate_entry') || $post->getAuthor()->hasTeams() || $post->getAuthor()->hasAssociations()) { ?>
