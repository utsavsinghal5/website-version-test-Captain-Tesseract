		...
		<table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				<td style="padding: 20px 20px 0px; font-family: sans-serif; font-size: 13px; line-height: 20px; color: #999999; text-align: left;">
					<p style="margin: 0;"><?php echo JText::_('COM_EB_MAIL_TEMPLATE_NEW_COMMENT_REJECTED_SUBHEADING'); ?></p>
				</td>
			</tr>
			<tr>
				<td style="padding: 0px 20px 20px; text-align: left;">
					<h1 style="margin: 0; font-family: sans-serif; font-size: 22px; line-height: 27px; color: #666666; font-weight: normal;"><?php echo JText::sprintf('COM_EB_MAIL_TEMPLATE_NEW_COMMENT_REJECTED_HEADING');?></h1>
				</td>
			</tr>
		</table>
	</td>
							...
							<tr>
								<td dir="ltr" style="font-family: sans-serif; font-size: 20px; line-height: 28px; color: #555555; padding: 0px 10px 0; text-align: left;" class="center-on-narrow">
									...
									<p style="margin:0px 0 10px 0;font-size: 14px; line-height: 28px;">
										<?php if ($templatePreview) { ?>
											<?php echo JText::sprintf('COM_EB_MAIL_TEMPLATE_NEW_COMMENT_MESSAGE_REJECTED', 'Test post', 'http://test.com/');?>
										<?php } else { ?>
											<?php echo JText::sprintf('COM_EB_MAIL_TEMPLATE_NEW_COMMENT_MESSAGE_REJECTED', $blogTitle, $blogLink);?>
										<?php } ?>
									</p>
								</td>
							</tr>
