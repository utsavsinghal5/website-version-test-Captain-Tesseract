		...
		<table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				<td style="padding: 20px 20px 0px; font-family: sans-serif; font-size: 13px; line-height: 20px; color: #999999; text-align: left;">
					<p style="margin: 0;"><?php echo JText::_('COM_EASYBLOG_MAIL_TEMPLATE_POST_REPORTED_SUBHEADING'); ?></p>
				</td>
			</tr>
			<tr>
				<td style="padding: 0px 20px 20px; text-align: left;">
					<h1 style="margin: 0; font-family: sans-serif; font-size: 22px; line-height: 27px; color: #666666; font-weight: normal;"><?php echo JText::sprintf('COM_EASYBLOG_MAIL_TEMPLATE_POST_REPORTED_HEADING');?></h1>
				</td>
			</tr>
		</table>
	</td>
						...
						<table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
							<tr>
								<td dir="ltr" style="padding: 0 10px 10px 10px;">
									...
									<?php } else { ?>
										<img src="<?php echo $reporterAvatar;?>" aria-hidden="true" width="64" height="64" border="0" alt="" class="center-on-narrow" style="width: 100%; max-width: 64px; height: auto; background: #dddddd; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
									<?php } ?>
								</td>
							</tr>
						</table>
							...
							<tr>
								<td dir="ltr" style="font-family: sans-serif; font-size: 20px; line-height: 28px; color: #555555; padding: 0px 10px 0; text-align: left;" class="center-on-narrow">
									<p style="margin:0px 0 10px 0;font-size: 14px; line-height: 28px;">
										<a href="<?php echo $templatePreview ? 'javascript:void(0);' : $reporterLink;?>" target="_blank" style="color: #4E92DF; text-decoration: none;"><?php echo $templatePreview ? 'Reporter Name' : $reporterName;?></a> 
										<?php if ($templatePreview) { ?>
											<?php echo JText::sprintf('COM_EASYBLOG_MAIL_TEMPLATE_REPORTED_ON', '13th August 2017');?>
										<?php } else { ?>
											<?php echo JText::sprintf('COM_EASYBLOG_MAIL_TEMPLATE_REPORTED_ON', $reportDate);?>
										<?php } ?>
									</p>
								</td>
							</tr>
		...
		<table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				<td style="padding: 0 20px 40px; font-family: sans-serif; font-size: 14px; color: #555555; text-align: left;">
					<p style="margin: 0;"><?php echo JText::_('COM_EASYBLOG_MAIL_TEMPLATE_POST_REPORTED_MESSAGE'); ?></p>
					<p style="padding: 40px 30px; background: #eee;"><?php echo $templatePreview ? 'Reported reason ...' : $reason; ?></p>
				</td>
			</tr>
			<tr>
					...
					<table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" align="left" >
						<tr>
							<td style="border-radius: 3px; background: #54C063; text-align: center;" class="button-td">
								<a href="<?php echo $templatePreview ? 'javascript:void(0);' : $blogLink;?>" style="background: #54C063; border: 15px solid #54C063; font-family: sans-serif; font-size: 13px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" class="button-a">
									<span style="color:#ffffff;" class="button-link">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo JText::_('COM_EASYBLOG_NOTIFICATION_VIEW_REPORTED_POST');?>&nbsp;&nbsp;&nbsp;&nbsp;</span>
								</a>
							</td>
						</tr>
					</table>
