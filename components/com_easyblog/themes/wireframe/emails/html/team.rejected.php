		...
		<table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				<td style="padding: 20px 20px 0px; font-family: sans-serif; font-size: 13px; line-height: 20px; color: #999999; text-align: left;">
					<p style="margin: 0;"><?php echo JText::_('COM_EASYBLOG_MAIL_TEMPLATE_TEAM_REJECTED_SUBHEADING'); ?></p>
				</td>
			</tr>
			<tr>
				<td style="padding: 0px 20px 20px; text-align: left;">
					<h1 style="margin: 0; font-family: sans-serif; font-size: 22px; line-height: 27px; color: #666666; font-weight: normal;"><?php echo JText::sprintf('COM_EASYBLOG_MAIL_TEMPLATE_TEAM_REJECTED_HEADING');?></h1>
				</td>
			</tr>
		</table>
	</td>
			...
			<tr>
				<td style="padding: 0 20px 40px; font-family: sans-serif; font-size: 14px; color: #555555; text-align: left;">
					<?php if ($templatePreview) { ?>
						<p style="margin: 0;"><?php echo JText::sprintf('COM_EASYBLOG_MAIL_TEMPLATE_TEAM_REJECTED_MESSAGE', '<b>Preview Team</b>');?></p>
					<?php } else { ?>
						<p style="margin: 0;"><?php echo JText::sprintf('COM_EASYBLOG_MAIL_TEMPLATE_TEAM_REJECTED_MESSAGE', '<b>' . $teamName . '</b>');?></p>
					<?php } ?>
				</td>
			</tr>
			<tr>
