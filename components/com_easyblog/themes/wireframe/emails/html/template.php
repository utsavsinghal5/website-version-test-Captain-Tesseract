					...
					<td style="padding: 40px 10px;width: 100%;font-size: 12px; font-family: sans-serif; line-height:18px; text-align: center; color: #888888;" class="x-gmail-data-detectors">
						...
						<unsubscribe style="color:#888888;">
							<?php if (!is_array($unsubscribe)) { ?>
								<?php echo JText::_('COM_EASYBLOG_NOTIFICATION_UNSUBSCRIBE'); ?> <a href="<?php echo $unsubscribe;?>" style="color:#888888; text-decoration:underline;"><?php echo JText::_('COM_EASYBLOG_NOTIFICATION_HERE');?></a>
							<?php } else { ?>
								<?php foreach ($unsubscribe as $type => $link) { ?>
									<?php echo JText::_('COM_EASYBLOG_NOTIFICATION_UNSUBSCRIBE_' . strtoupper($type)); ?>
									<a href="<?php echo $link;?>" style="color:#888888; text-decoration:underline;"><?php echo JText::_('COM_EASYBLOG_NOTIFICATION_HERE');?></a><br />
								<?php } ?>
							<?php } ?>
						</unsubscribe>
						<?php } ?>
						...
						<unsubscribe style="color:#888888;">
							<?php echo JText::_('COM_EB_NOTIFICATION_DELETE_INFO'); ?> <a href="<?php echo $deleteinforequest;?>" style="color:#888888; text-decoration:underline;"><?php echo JText::_('COM_EASYBLOG_NOTIFICATION_HERE');?></a>
						</unsubscribe>
						<?php } ?>
					</td>
				</tr>
