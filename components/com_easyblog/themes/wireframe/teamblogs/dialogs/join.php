...
<dialog>
	...
	<content>
		...
		<form data-form-response method="post" action="<?php echo JRoute::_('index.php');?>">
			...
			<?php echo $this->html('form.action', 'teamblogs.join'); ?>
		</form>
	</content>
	<buttons>
		<button data-close-button type="button" class="btn btn-default btn-sm"><?php echo JText::_('COM_EASYBLOG_CLOSE_BUTTON'); ?></button>
		<button data-submit-button type="button" class="btn btn-primary btn-sm"><?php echo JText::_('COM_EASYBLOG_JOIN_BUTTON'); ?></button>
	</buttons>
</dialog>
