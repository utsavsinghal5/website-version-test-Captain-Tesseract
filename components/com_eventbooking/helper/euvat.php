...
class EventbookingHelperEuvat
{
	...
	public static function validateEUVATNumber($vatNumber)
	{
		...
		$validatedVatNumbers = JFactory::getSession()->get('eb_validated_eu_vat_numbers');
		...
		JFactory::getSession()->set('eb_validated_eu_vat_numbers', json_encode($validatedVatNumbers));
