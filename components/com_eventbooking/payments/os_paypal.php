...
class os_paypal extends RADPayment
{
	...
	public function processPayment($row, $data)
	{
		...
		if ($row->process_deposit_payment)
		{
			...
			{
				$this->setParameter('return', $siteUrl . 'index.php?option=com_eventbooking&view=payment&layout=complete&Itemid=' . $Itemid . '&pt=' . time() . $langLink);
			}
			else
			{
				$this->setParameter('return', $siteUrl . 'index.php?option=com_eventbooking&view=payment&layout=complete&Itemid=' . $Itemid . $langLink);
			}
		}
		else
		{
			$this->setParameter('return', $siteUrl . 'index.php?option=com_eventbooking&view=complete&registration_code=' . $row->registration_code . '&Itemid=' . $Itemid . $langLink);
		}
