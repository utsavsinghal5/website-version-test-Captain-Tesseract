...
<div id="eb-calendar-page" class="eb-container">
	...
	?>
	<form method="post" name="adminForm" id="adminForm" action="<?php echo JRoute::_('index.php?option=com_eventbooking&view=calendar&layout=default&Itemid=' . $this->Itemid); ?>">
        <div id="eb-calendarwrap">
            <?php
                ...
                $layoutData = [
                    ...
                    'nextMonth'         => $nextMonth,
                    'previousMonthLink' => JRoute::_('index.php?option=com_eventbooking&view=calendar&layout=default&month=' . $previousMonth . '&year=' . $previousYear . '&Itemid=' . $this->Itemid),
                    'nextMonthLink'     => JRoute::_('index.php?option=com_eventbooking&view=calendar&layout=default&month=' . $nextMonth . '&year=' . $nextYear . '&next=1&Itemid=' . $this->Itemid),
