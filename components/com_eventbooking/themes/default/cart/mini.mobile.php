			...
			<div class="row-fluid">
				...
				<div class="<?php echo $span12; ?> eb-mobile-quantity">
					...
					<div class="btn-wrapper input-append">
						<input id="quantity" type="number"<?php if ($item->max_group_number > 0) echo ' max="' . $item->max_group_number . '"'; ?> class="input-mini inputbox quantity_box" size="3" value="<?php echo $item->quantity ; ?>" name="quantity[]" <?php echo $readOnly ; ?> onchange="updateCart();" />
