...
?>
<script src="<?php echo JUri::root(true); ?>/media/com_eventbooking/assets/js/cartpopup.min.js"></script>
					...
					<tr>
						...
						<td class="col_quantity">
							<div class="btn-wrapper input-append">
								<input id="quantity" type="number"<?php if ($item->max_group_number > 0) echo ' max="' . $item->max_group_number . '"'; ?> class="input-mini inputbox quantity_box" size="3" value="<?php echo $item->quantity ; ?>" name="quantity[]" <?php echo $readOnly ; ?> onchange="updateCart(<?php echo (int) $this->Itemid; ?>);" />
