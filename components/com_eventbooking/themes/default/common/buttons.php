...
if (empty($hideRegisterButtons) && !$isMultipleDate)
{
	if ($canRegister)
	{
		...
		?>
			<li>
				<a class="<?php echo $btnBtnPrimary.' eb-register-button eb-external-registration-link'; ?>" href="<?php echo $registrationUrl; ?>" target="_blank"><?php echo JText::_('EB_REGISTER');; ?></a>
			</li>
		<?php
		}
		else
