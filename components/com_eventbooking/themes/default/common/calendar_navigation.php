...
<div class="eb-topmenu-calendar">
	<ul class="eb-menu-calendar <?php echo $bootstrapHelper->getClassMapping('nav'); ?> <?php echo $bootstrapHelper->getClassMapping('nav-pills'); ?>">
		...
		?>
			<li>
				<a class="eb-calendar-view-link<?php if ($layout == 'weekly') echo ' active'; ?>" href="<?php echo JRoute::_("index.php?option=com_eventbooking&view=calendar&layout=weekly&date=$date&Itemid=$Itemid"); ?>" rel="nofollow">
		...
		?>
			<li>
				<a class="eb-calendar-view-link<?php if ($layout == 'daily') echo ' active'; ?>" href="<?php echo JRoute::_("index.php?option=com_eventbooking&view=calendar&layout=daily&day=$day&Itemid=$Itemid"); ?>" rel="nofollow">
