		...
		<div class="eb-category">
			<div class="eb-box-heading">
				<h3 class="eb-category-title">
                    ...
                    {
	                ?>
                        <span class="<?php echo $bootstrapHelper->getClassMapping('badge badge-info'); ?>"><?php echo $category->total_events ;?> <?php echo $category->total_events == 1 ? JText::_('EB_EVENT') :  JText::_('EB_EVENTS') ; ?></span>
	                <?php
                    }
                    ?>
				</h3>
