...
<div id="eb-events" class="<?php echo $rowFluidClass . ' ' . $clearfixClass; ?> eb-columns-layout-container">
	<?php
        ...
        <div class="<?php echo $span.$newRowClass; ?> eb-row-<?php echo $rowCount; ?>">
			<div class="eb-event-wrapper eb-category-<?php echo $event->category_id; ?><?php if ($event->featured) echo ' eb-featured-event'; ?> eb-event-box eb-event-<?php echo $event->id . ' ' . $clearfixClass; ?>">
				<?php
					...
					<ul>
						...
						if ($config->get('show_register_buttons', 1) && !$event->is_multiple_date)
						{
							if ($event->can_register)
							{
								...
								?>
									<li>
										<a class="<?php echo $btnBtnPrimary; ?>" href="<?php echo $registrationUrl; ?>" target="_blank"><?php echo JText::_('EB_REGISTER');; ?></a>
									</li>
								<?php
								}
								else
								{
									...
									?>
										<li>
											<a class="<?php echo $btnBtnPrimary; ?>" href="<?php echo JRoute::_('index.php?option=com_eventbooking&task=register.group_registration&event_id=' . $event->id . '&Itemid=' . $Itemid, false, $ssl); ?>"><?php echo JText::_('EB_REGISTER_GROUP');; ?></a>
										</li>
									<?php
									}
								}
							...
							elseif ($event->waiting_list)
							{
								...
								?>
									<li>
										<a class="<?php echo $btnBtnPrimary; ?>" href="<?php echo JRoute::_('index.php?option=com_eventbooking&task=register.group_registration&event_id=' . $event->id . '&Itemid=' . $Itemid, false, $ssl); ?>"><?php echo JText::_('EB_REGISTER_GROUP_WAITING_LIST');; ?></a>
									</li>
								<?php
								}
							}
