...
?>
<div id="eb-registration-history-page" class="eb-container">
				...
				<?php
					...
					?>
                        <td class="tdno<?php echo $i; ?> center" data-content="<?php echo JText::_('EB_EVENT_DATE'); ?>">
							...
							{
								echo JHtml::_('date', $row->event_date, $this->config->event_date_format, null);
							}
							?>
						</td>
					<?php
				...
				?>
					<td style="text-align: right;" class="tdno<?php echo $i; ?>" data-content="<?php echo JText::_('EB_DUE_AMOUNT'); ?>">
						...
						if ($row->payment_status != 1 && $row->published != 2)
						{
							...
							{
							?>
								<a class="<?php echo $btnPrimary; ?>" href="<?php echo JRoute::_('index.php?option=com_eventbooking&view=payment&order_number=' . $row->registration_code . '&Itemid=' . $this->Itemid); ?>"><?php echo JText::_('EB_MAKE_PAYMENT'); ?></a>
							<?php
							}
						}
						?>
