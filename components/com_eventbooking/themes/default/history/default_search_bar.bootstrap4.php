...
<div class="filter-search btn-group pull-left">
	<div class="input-group">
		<label for="filter_search" class="sr-only"><?php echo JText::_('EB_FILTER_SEARCH_REGISTRATION_RECORDS_DESC');?></label>
		<input type="text" name="filter_search" id="filter_search" placeholder="<?php echo JText::_('JSEARCH_FILTER'); ?>" value="<?php echo $this->escape($this->state->filter_search); ?>" class="hasTooltip form-control" title="<?php echo JHtml::tooltipText('EB_SEARCH_REGISTRATION_RECORDS_DESC'); ?>" />
