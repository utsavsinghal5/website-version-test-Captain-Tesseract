...
<?php
	...
	<div class="form-actions">
		<input type="button" class="<?php echo $btnPrimary; ?>" name="btn-group-billing-back" id="btn-group-billing-back" value="<?php echo  JText::_('EB_BACK') ;?>">
		...
		var eb_current_page = 'group_billing';
			Eb.jQuery(document).ready(function($){
				...
				<?php
                    ...
                    {
                    ?>
                        $('#<?php echo $this->config->eu_vat_number_field; ?>').after('<span class="invalid" id="vatnumber_validate_msg" style="display: none;"><?php echo ' ' . JText::_('EB_INVALID_VATNUMBER'); ?></span></div>');
