...
?>
	<div class="form-actions">
		<?php
			...
			{
			?>
				<input type="button" id="btn-group-members-back" name="btn-group-members-back" class="<?php echo $btnPrimaryClass; ?>" value="<?php echo JText::_('EB_BACK'); ?>"/>
			<?php
			}
		?>
		<input type="<?php echo $this->showBillingStep ? "button" : "submit";?>" id="btn-process-group-members" name="btn-process-group-members" class="<?php echo $btnPrimaryClass; ?>" value="<?php echo $this->showBillingStep ? JText::_('EB_NEXT'): JText::_('EB_PROCESS_REGISTRATION'); ?>" />
	</div>
