...
<form name="eb-form-number-group-members" id="eb-form-number-group-members" autocomplete="off" class="<?php echo $formHorizontalClass; ?>">
	...
	<div class="form-actions">
		<input type="button" name="btn-number-members-back" id="btn-number-members-back" class="<?php echo $btnPrimaryClass; ?>" value="<?php echo JText::_('EB_BACK'); ?>" onclick="window.history.go(-1) ;" />
		<input type="button" name="btn-process-number-members" id="btn-process-number-members" class="<?php echo $btnPrimaryClass; ?>" value="<?php echo JText::_('EB_NEXT'); ?>" />
	</div>
</form>
