...
<form action="" method="post" name="adminForm" id="adminForm">
	...
	<tr>
		<td align="left">
			<div class="btn-wrapper input-append">
				<input type="text" name="filter_search" style="width: 200px !important"  id="filter_search" value="<?php echo $this->escape($this->state->filter_search); ?>" size="40" title="<?php echo JText::_('EB_SEARCH_IN_NAME'); ?>" />
				...
				<button class="btn button-select" type="button" onclick="if (window.parent) window.parent.<?php echo $this->escape($function);?>('', '<?php echo JText::_('EB_SELECT_USER') ?>');"><?php echo JText::_('EB_NO_USER')?></button>
			</div>
		</td>	
		<td style="float: right;">		
			<label for="filter_group_id">
				<?php echo JText::_('EB_FILTER_USER_GROUP'); ?>
			</label>
	...
	<table class="adminlist table table-striped table-condensed" style="width: 100%">
		<thead>
			<tr>
				<th align="left">
					<?php echo JHtml::_('grid.sort', 'EB_NAME', 'tbl.name', $listDirn, $listOrder); ?>
				</th>
				<th class="nowrap" width="25%" align="left">
					<?php echo JHtml::_('grid.sort', 'EB_USERNAME', 'tbl.username', $listDirn, $listOrder); ?>
				</th>
