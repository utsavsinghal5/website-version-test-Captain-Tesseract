...
openstreetmapScript.type = 'text/javascript';
...
app.openstreetmapEditor = function() {
    ...
    $g('#openstreetmap-editor-dialog .section-access-select input[type="hidden"]').val(app.edit.access);
    var value = $g('#text-editor-dialog .section-access-select li[data-value="'+app.edit.access+'"]').text();
    $g('#openstreetmap-editor-dialog .section-access-select input[readonly]').val($g.trim(value));
    $g('#openstreetmap-editor-dialog .class-suffix').val(app.edit.suffix);
    value = app.getValue('margin', 'top');
    $g('#openstreetmap-editor-dialog [data-group="margin"][data-option="top"]').val(value);
    value = app.getValue('margin', 'bottom');
    $g('#openstreetmap-editor-dialog [data-group="margin"][data-option="bottom"]').val(value);
    setDisableState('#openstreetmap-editor-dialog');
    value = app.getValue('height');
    value = $g('#openstreetmap-editor-dialog input[data-option="height"]').val(value).prev().val(value);
    setLinearWidth(value);
    value = app.getValue('shadow', 'value');
    value = $g('#openstreetmap-editor-dialog input[data-option="value"][data-group="shadow"]').val(value).prev().val(value);
    setLinearWidth(value);
    value = app.getValue('shadow', 'color');
    updateInput($g('#openstreetmap-editor-dialog input[data-option="color"][data-group="shadow"]'), value);
    ...
    setTimeout(function(){
        $g('#openstreetmap-editor-dialog').modal();
    }, 150);
}
