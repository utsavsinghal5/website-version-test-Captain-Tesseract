...
app.preloaderEditor = function(){
    ...
    value = $g('#preloader-settings-dialog input[data-option="width"]').val(value).prev().val(value);
    ...
    value = $g('#preloader-settings-dialog input[data-option="size"]').val(value).prev().val(value);
    setLinearWidth(value);
    ...
    value = $g('#preloader-settings-dialog input[data-option="delay"]').val(app.edit.delay).prev().val(app.edit.delay);
    setLinearWidth(value);
    $g('#preloader-settings-dialog .section-access-select input[type="hidden"]').val(app.edit.access);
    value = $g('#preloader-settings-dialog .section-access-select li[data-value="'+app.edit.access+'"]').text().trim();
    $g('#preloader-settings-dialog .section-access-select input[readonly]').val(value);
    $g('#preloader-settings-dialog .class-suffix').val(app.edit.suffix);
    setDisableState('#preloader-settings-dialog');
    $g('#preloader-settings-dialog').attr('data-edit', app.edit.type);
    setTimeout(function(){
        $g('#preloader-settings-dialog').modal();
    }, 150);
}
