...
jQuery(document).on('ready', function(){
    ...
    jQuery('.ba-create-page').each(function(){
        let $this = jQuery(this),
            inputs = this.querySelectorAll('input[name]'),
...
<?php
                ...
                if ($type == 'products' && empty($this->category)) {
?>
                    <div class="ba-custom-select select-product-type">
                        ...
                        <ul>
                            <li data-value="physical"><?php echo JText::_('PHYSICAL_PRODUCT') ?></li>
                            <li data-value="digital"><?php echo JText::_('DIGITAL_PRODUCT') ?></li>
                        </ul>
                        <i class="zmdi zmdi-caret-down"></i>
                    </div>
<?php
