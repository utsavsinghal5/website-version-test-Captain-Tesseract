...
?>
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/ckeditor/4.5.0/ckeditor.js"></script>
<script type="text/javascript" src="<?php echo JURI::root(); ?>components/com_gridbox/libraries/ckeditor/js/link.js"></script>
<script type="text/javascript" src="<?php echo JURI::root(); ?>components/com_gridbox/libraries/ckeditor/js/unlink.js"></script>
<script type="text/javascript" src="<?php echo JURI::root(); ?>components/com_gridbox/libraries/ckeditor/js/textColor.js"></script>
<script type="text/javascript" src="<?php echo JURI::root(); ?>components/com_gridbox/libraries/ckeditor/js/gridboxImage.js"></script>
<script type="text/javascript" src="<?php echo JURI::root(); ?>components/com_gridbox/libraries/ckeditor/js/gridboxVideo.js"></script>
<script type="text/javascript" src="<?php echo JURI::root(); ?>components/com_gridbox/libraries/ckeditor/js/gridboxPlugins.js"></script>
<script type="text/javascript" src="<?php echo JURI::root(); ?>components/com_gridbox/libraries/ckeditor/js/anchor.js"></script>
<script type="text/javascript" src="<?php echo JURI::root(); ?>components/com_gridbox/libraries/ckeditor/js/justifyLeft.js"></script>
<script type="text/javascript">
