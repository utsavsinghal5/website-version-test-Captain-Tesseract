...
<div style="border-bottom: 1px solid #f3f3f3;">
    <div style="margin-bottom: 25px;"><?php echo JText::_('ORDER_DETAILS'); ?></div>
<?php
foreach ($products as $product) {
    ...
    $image = !empty($product->image) && strpos($product->image, 'balbooa.com') === false ? JUri::root().$product->image : $product->image;
    $info = array();
