...
<script type="text/javascript">
    ...
    jQuery(document).on('ready', function(){
        jQuery('body').on('keydown', 'input', function(event){
            event.stopPropagation();
        });
    });
</script>
<link rel="stylesheet" href="components/com_gridbox/assets/css/ba-style-editor.css?<?php echo $this->about->version; ?>" type="text/css"/>
...
<div id="ba-media-manager">
    <form  target="form-target" action="<?php echo JRoute::_('index.php?option=com_gridbox&layout=uploader&id=&tmpl=component'); ?>"
        ...
        <div id="create-folder-modal" class="ba-modal-sm modal hide" style="display:none">
            <div class="modal-body">
                ...
                <input type="hidden" name="current-dir" value="<?php echo $this->folder; ?>">
            </div>
...
?>
                        ...
                        <div class="control-toolbar">
                            ...
                            <label>
                                ...
                                <span class="ba-tooltip ba-bottom"><?php echo JText::_('UPLOAD_FILE'); ?></span>
                            </label>
                            <label>
                            ...
                            <div class="pagination-limit">
                                <div class="ba-custom-select">
                                    <input readonly value="<?php echo $pagLimit[$this->_limit]; ?>"
                                       data-value="<?php echo $this->_limit; ?>" onfocus="this.blur()"
                ...
                <div class="ba-work-area" style="width: 70%;">
                    ...
                    <div>
                        <table class="ba-items-list">
                            <tbody>
<?php
                                $img = JUri::root().'index.php?option=com_gridbox&task=uploader.showImage&image=';
                                $now = strtotime('now');
