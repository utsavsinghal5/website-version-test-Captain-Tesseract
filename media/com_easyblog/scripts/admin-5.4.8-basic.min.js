...
},activate:function(a){g.deactivate(),g.activeItem=a.addClass("active")},deactivate:function(){g.activeItem.removeClass("active"),g.activeItem=a()},use:function(c){var c=a(c),d=c.text(),e=c.data("id"),f=h.addItem({id:e,title:d,key:e,locked:!1});f&&(b.textfield().focus(),c.is(g.activeItem)&&(nextItem=c.next(b.item)[0]||c.prev(b.item)[0],g.deactivate(c),nextItem&&g.activate(a(nextItem))),suggestions.refresh(),b.textfield().val(""))}}}}),b.resolve()})}),EasyBlog.require().library("dialog").script("admin/grid","shared/toggler","admin/vendors/select2").done(function(a){var b=a("[data-table-grid-filter]"),c=function(b,c){var d=a.extend({},{width:"resolve",minimumResultsForSearch:3},c);
a(b).select2(d)};b.each(function(){var b=a(this),d=b.children().length;c(b,{theme:"backend",minimumResultsForSearch:d>5?3:1/0})}),c("[data-eb-select]"),a("[data-table-grid-filter]").on("select2:open",function(){a("body").addClass("has-select2-dropdown")}),a("[data-table-grid-filter]").on("select2:close",function(){a("body").removeClass("has-select2-dropdown")});var d=a("#toolbar"),e=a("[data-toolbar-actions]");e.length>0&&e.each(function(){var b=a(this),c=b.data("position")||"append";b.removeClass("hidden"),"append"==c?b.appendTo(d):b.prependTo(d),b.find("[data-action]").each(function(){var b=a(this),c=b.data("action");
b.on("click",function(){Joomla.submitbutton(c)})})});var f=a("body.com_easyblog #toolbar-apply"),g=a("body.com_easyblog #toolbar-save"),h=a("body.com_easyblog #toolbar-save-new");if(f.length>0&&(g.length>0||h.length>0)){var i=a("[data-primary-save-group]");if(i.length<1)return;f.hide(),g.hide(),h.hide();var j=a(i.html());j.prepend(f),f.show();var k=j.find("[data-dropdown-items]");g.length>0&&g.appendTo(k).show(),h.length>0&&h.appendTo(k).show(),j.prependTo("#toolbar")}}),EasyBlog.module("admin/grid",function(a){var b=this;
EasyBlog.Controller("Grid",{defaultOptions:{"{sortColumns}":"[data-table-grid-sort]","{ordering}":"[data-table-grid-ordering]","{direction}":"[data-table-grid-direction]","{task}":"[data-table-grid-task]","{searchInput}":"[data-table-grid-search-input]","{search}":"[data-table-grid-search]","{resetSearch}":"[data-table-grid-search-reset]","{publishItems}":"[data-table-grid-publishing]","{filters}":"[data-table-grid-filter]","{checkAll}":"[data-table-grid-checkall]","{row}":"tbody > tr","{checkbox}":"[data-table-grid-id]","{boxChecked}":"[data-table-grid-box-checked]","{checkboxWrapper}":"[data-table-grid-checkbox]","{attachFile}":"[data-attach-exported-templates-file]",overrideCheckbox:!0}},function(b,c){return{init:function(){b.implementSortable(),b.implementPublishing()
},submitForm:function(){b.element.submit()},setTask:function(a){b.task().val(a)},setOrdering:function(a){b.ordering().val(a)},setDirection:function(a){b.direction().val(a)},updateTotalChecked:function(){var a=b.checkbox(":checked").length;b.boxChecked().val(a).trigger("change")},selectRow:function(a){var b=a.find("input[name=cid\\[\\]]");b.prop("checked",!0)},implementSortable:function(){b.sortColumns().implement(EasyBlog.Controller.Grid.Sort,{"{parent}":b})},implementPublishing:function(){b.publishItems().implement(EasyBlog.Controller.Grid.Publishing,{"{parent}":b})
},updateCheckbox:function(a,c){var d=!c.is(":checked"),e=c.is(":radio");e&&b.row().removeClass("is-checked"),a.toggleClass("is-checked",d),c.prop("checked",d).trigger("change")},"{checkboxWrapper} click":function(a){if(!c.overrideCheckbox){var e=a.find(b.checkbox),f=a.parents(b.row);b.updateCheckbox(f,e)}},"{checkbox} change":function(){b.updateTotalChecked()},"{row} click":function(a){if(c.overrideCheckbox){var e=a.find(b.checkbox);b.updateCheckbox(a,e)}},"{checkAll} change":function(a){var d=a.is(":checked");
b.checkbox().prop("checked",d);a.is(":checked")?b.checkbox().length:0;b.updateTotalChecked()},"{filters} change":function(){b.setTask(""),b.submitForm()},"{search} click":function(){b.submitForm()},"{resetSearch} click":function(){b.searchInput().val(""),b.submitForm()},"{boxChecked} change":function(b){var c=a("body").hasClass("is-joomla-4");if(c){var d=b.val();if(d>0){var e=document.querySelectorAll("joomla-toolbar-button");a(e).each(function(a,b){b.listSelection&&b.setDisabled(!1)})}}}}}),EasyBlog.Controller("Grid.Sort",{defaultOptions:{items:"[data-grid-sort-item]"}},function(a){return{"{self} click":function(){var b=a.element.data("direction"),c=a.element.data("sort");
a.parent.setOrdering(c),a.parent.setDirection(b),a.parent.setTask(""),a.parent.submitForm()}}}),EasyBlog.Controller("Grid.Sort",{defaultOptions:{}},function(a){return{"{self} click":function(){var c=a.element.parents("tr"),d=a.element.data("task");a.parent.selectRow(c),a.parent.setTask(d),a.parent.submitForm()}}}),EasyBlog.Controller("Grid.Publishing",{defaultOptions:{}},function(a){return{"{self} click":function(){var c=a.element.parents("tr"),d=a.element.data("task");a.parent.selectRow(c),a.parent.setTask(d),a.parent.submitForm()
}}}),b.resolve()}),EasyBlog.module("admin/maintenance/database",function(){var b=this;EasyBlog.Controller("Maintenance.Database",{defaultOptions:{"{start}":"[data-start]","{progress}":"[data-progress]","{progressBox}":"[data-progress-box]","{progressBar}":"[data-progress-bar]","{progressPercentage}":"[data-progress-percentage]","{errorBox}":"[data-error]","{successBox}":"[data-success]"}},function(a){return{init:function(){},"{start} click":function(b){b.hide(),a.progress().show(),a.process()},counter:0,versions:[],process:function(){a.getStats().done(function(b){a.versions=b,a.execute()
})},getStats:function(){return EasyBlog.ajax("admin/controllers/maintenance/getDatabaseStats")},execute:function(){return void 0===a.versions[a.counter]?a.completed():(a.successBox().hide(),EasyBlog.ajax("admin/controllers/maintenance/synchronizeDatabase",{version:a.versions[a.counter]}).fail(function(b){a.errorBox().show(),a.errorBox().append('<div class="alert alert-danger">'+b+"</div>")}).always(function(){a.counter++;var b=Math.floor(a.counter/a.versions.length*100)+"%";a.progressBar().css("width",b),a.progressPercentage().text(b),a.execute()
}),void 0)},completed:function(){a.progressBar().css("width","100%"),a.progressPercentage().text("100%"),a.progressBox().removeClass("progress-info").addClass("progress-success"),a.successBox().delay(1e3).fadeIn(400)}}}),b.resolve()}),EasyBlog.module("admin/maintenance/form",function(){var b=this;EasyBlog.Controller("Maintenance.Form",{defaultOptions:{"{row}":"[data-row]"}},function(a){return{init:function(){a.runscript()},counter:0,success:0,fail:0,runscript:function(){var b=a.row().eq(a.counter);if(0===b.length)return a.completed();
var c=b.data("key");EasyBlog.ajax("admin/controllers/maintenance/runscript",{key:c}).done(function(){a.setStatus(b,1),a.success++}).fail(function(){a.setStatus(b,0),a.fail++}).always(function(){a.counter++,a.runscript()})},completed:function(){a.fail<1&&(window.location="index.php?option=com_easyblog&view=maintenance&success="+a.success)},setStatus:function(a,b){var c=a.find("[data-status]"),d=a.find("[data-icon]"),e=["label-danger","label-success","label-warning"],f=["ies-warning-2","ies-checkmark","ies-wrench-3"];
...
},"{moveDown} click":function(){b.selectRow(),a.Joomla("submitform",["moveDown"])}}}),b.resolve()}),EasyBlog.module("admin/tabs",function(){var b=this;EasyBlog.Controller("Admin.Tabs",{defaultOptions:{"{tab}":"[data-form-tabs]","{activeTabInput}":"[data-eb-form-activetab]"}},function(a){return{"{tab} click":function(b){var d=b.attr("href").replace("#","");a.activeTabInput().val(d)}}}),b.resolve()}),EasyBlog.module("admin/tag/suggest",function(){var b=this;EasyBlog.require().library("textboxlist").done(function(a){EasyBlog.Controller("Tag.Suggest",{defaultOptions:{max:null,exclusive:!1,exclusion:[],minLength:1,highlight:!0,name:"uid[]",type:"",query:{suggest:"admin/controllers/blogs/suggest"},includeSelf:!1}},function(b,c){return{init:function(){b.element.textboxlist({component:"eb",name:c.name,max:c.max,plugin:{autocomplete:{exclusive:c.exclusive,minLength:c.minLength,highlight:c.highlight,showLoadingHint:!0,showEmptyHint:!0,query:function(a){return EasyBlog.ajax(c.query.suggest,{search:a,inputName:c.name,exclusion:c.exclusion})
}}}}).textboxlist("enable")},"{self} filterItem":function(b,c,d){var e=a("<div/>").html(d.html),f=e.find("[data-tag-title]").text(),g=e.find("[data-tag-id]").val();d.id=g,d.title=f,d.menuHtml=d.html},"{self} filterMenu":function(c,d,e,f,g,h){var i=h.getAddedItems(),j=a.pluck(i,"id"),j=j.concat(b.options.exclusion);f.each(function(){var b=a(this),c=b.data("item");b.toggleClass("hidden",a.inArray(c.id.toString(),j)>-1)})}}}),b.resolve()})}),EasyBlog.module("admin/toolbar",function(a){var b=this;EasyBlog.Controller("Admin.Toolbar",{defaultOptions:{"{action}":"[data-action]",hints:{empty:""},bindings:{}}},function(b,c){return{init:function(){b.element.removeClass("hide").appendTo("#toolbar")
},getTableController:function(){var b=a("[data-grid-eb]").controller();return b},getSelectedItems:function(){var b=new Array;return a("[data-table-grid]").find("input[name=cid\\[\\]]:checked").each(function(){var c=a(this).val();b.push(c)}),b},submitForm:function(a){table=b.getTableController(),table.setTask(a),table.submitForm()},renderDialog:function(a){EasyBlog.dialog({content:EasyBlog.ajax(a),bindings:{"{submitButton} click":function(){"function"==typeof c.bindings[a].submit&&c.bindings[a].submit()}}})},"{action} click":function(a){var e=b.getSelectedItems();
if(e.length<=0)return alert(c.hints.empty),void 0;var f=a.data("type"),g=a.data("action");return"post"==f?(b.submitForm(g),void 0):("dialog"==f&&b.renderDialog(g),void 0)}}}),b.resolve()}),EasyBlog.module("admin/user/suggest",function(){var b=this;EasyBlog.require().library("textboxlist").done(function(a){EasyBlog.Controller("User.Suggest",{defaultOptions:{max:null,exclusive:!1,exclusion:[],minLength:1,highlight:!0,name:"uid[]",type:"",query:{suggest:"admin/views/bloggers/suggest"},includeSelf:!1}},function(b,c){return{init:function(){b.element.textboxlist({component:"eb",name:c.name,max:c.max,plugin:{autocomplete:{exclusive:c.exclusive,minLength:c.minLength,highlight:c.highlight,showLoadingHint:!0,showEmptyHint:!0,query:function(a){return EasyBlog.ajax(c.query.suggest,{search:a,inputName:c.name,exclusion:c.exclusion})
}}}}).textboxlist("enable")},"{self} filterItem":function(b,c,d){var e=a("<div/>").html(d.html),f=e.find("[data-user-name]").text(),g=e.find("[data-user-id]").val();d.id=g,d.title=f,d.menuHtml=d.html},"{self} filterMenu":function(c,d,e,f,g,h){var i=h.getAddedItems(),j=a.pluck(i,"id"),j=j.concat(b.options.exclusion);f.each(function(){var b=a(this),c=b.data("item");b.toggleClass("hidden",a.inArray(c.id.toString(),j)>-1)})}}}),b.resolve()})})});