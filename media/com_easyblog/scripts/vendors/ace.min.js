!function(){var a=function(a){var b=this,c=function(){!function(){function g(a){var e=function(a,b){return d("",a,b)},f=b;a&&(b[a]||(b[a]={}),f=b[a]),f.define&&f.define.packaged||(c.original=f.define,f.define=c,f.define.packaged=!0),f.require&&f.require.packaged||(d.original=f.require,f.require=e,f.require.packaged=!0)}var a="ace",b=function(){return this}();if(a||"undefined"==typeof requirejs){var c=function(a,b,d){return"string"!=typeof a?(c.original?c.original.apply(window,arguments):(console.error("dropping module because define wasn't a string."),console.trace()),void 0):(2==arguments.length&&(d=b),c.modules||(c.modules={},c.payloads={}),c.payloads[a]=d,c.modules[a]=null,void 0)
},d=function(a,b,c){if("[object Array]"===Object.prototype.toString.call(b)){for(var e=[],g=0,h=b.length;h>g;++g){var i=f(a,b[g]);if(!i&&d.original)return d.original.apply(window,arguments);e.push(i)}c&&c.apply(null,e)}else{if("string"==typeof b){var j=f(a,b);return!j&&d.original?d.original.apply(window,arguments):(c&&c(),j)}if(d.original)return d.original.apply(window,arguments)}},e=function(a,b){if(-1!==b.indexOf("!")){var c=b.split("!");return e(a,c[0])+"!"+e(a,c[1])}if("."==b.charAt(0)){var d=a.split("/").slice(0,-1).join("/");
for(b=d+"/"+b;-1!==b.indexOf(".")&&f!=b;){var f=b;b=b.replace(/\/\.\//,"/").replace(/[^\/]+\/\.\.\//,"")}}return b},f=function(a,b){b=e(a,b);var f=c.modules[b];if(!f){if(f=c.payloads[b],"function"==typeof f){var g={},h={id:b,uri:"",exports:g,packaged:!0},i=function(a,c){return d(b,a,c)},j=f(i,g,h);g=j||h.exports,c.modules[b]=g,delete c.payloads[b]}f=c.modules[b]=g||f}return f};g(a)}}(),ace.define("ace/ace",["require","exports","module","ace/lib/fixoldbrowsers","ace/lib/dom","ace/lib/event","ace/editor","ace/edit_session","ace/undomanager","ace/virtual_renderer","ace/multi_select","ace/worker/worker_client","ace/keyboard/hash_handler","ace/placeholder","ace/mode/folding/fold_mode","ace/theme/textmate","ace/ext/error_marker","ace/config"],function(a,b){a("./lib/fixoldbrowsers");
...
},b=function(a,b){return b.shift(),b.shift()||"start"};this.normalizeRules=function(){function e(f){var g=d[f];g.processed=!0;for(var h=0;h<g.length;h++){var i=g[h];!i.regex&&i.start&&(i.regex=i.start,i.next||(i.next=[]),i.next.push({defaultToken:i.token},{token:i.token+".end",regex:i.end||i.start,next:"pop"}),i.token=i.token+".start",i.push=!0);var j=i.next||i.push;if(j&&Array.isArray(j)){var k=i.stateName;k||(k=i.token,"string"!=typeof k&&(k=k[0]||""),d[k]&&(k+=c++)),d[k]=j,i.next=k,e(k)}else"pop"==j&&(i.next=b);
if(i.push&&(i.nextState=i.next||i.push,i.next=a,delete i.push),i.rules)for(var l in i.rules)d[l]?d[l].push&&d[l].push.apply(d[l],i.rules[l]):d[l]=i.rules[l];if(i.include||"string"==typeof i)var m=i.include||i,n=d[m];else Array.isArray(i)&&(n=i);if(n){var o=[h,1].concat(n);i.noEscape&&(o=o.filter(function(a){return!a.next})),g.splice.apply(g,o),h--,n=null}i.keywordMap&&(i.token=this.createKeywordMapper(i.keywordMap,i.defaultToken||"text",i.caseInsensitive),delete i.defaultToken)}}var c=0,d=this.$rules;Object.keys(d).forEach(e,this)
...
}),this.cache[i]=j.length?j:"");for(var k=j.length;k--;)b.drawSingleLineMarker(a,j[k].toScreenRange(c),this.clazz,e)}}}).call(g.prototype),b.SearchHighlight=g}),ace.define("ace/edit_session/folding",["require","exports","module","ace/range","ace/edit_session/fold_line","ace/edit_session/fold","ace/token_iterator"],function(a,b){function h(){this.getFoldAt=function(a,b,c){var d=this.getFoldLine(a);if(!d)return null;for(var e=d.folds,f=0;f<e.length;f++){var g=e[f];if(g.range.contains(a,b)){if(1==c&&g.range.isEnd(a,b))continue;
...
break}g>=a&&(d-=h>=a?g-h:g-a+1)}return d},this.$addFoldLine=function(a){return this.$foldData.push(a),this.$foldData.sort(function(a,b){return a.start.row-b.start.row}),a},this.addFold=function(a,b){var g,c=this.$foldData,d=!1;a instanceof f?g=a:(g=new f(b,a),g.collapseChildren=b.collapseChildren),this.$clipRangeToDocument(g.range);var h=g.start.row,i=g.start.column,j=g.end.row,k=g.end.column;if(!(j>h||h==j&&k-2>=i))throw new Error("The range has to be at least 2 characters width");var l=this.getFoldAt(h,i,1),m=this.getFoldAt(j,k,-1);
if(l&&m==l)return l.addSubFold(g);if(l&&!l.range.isStart(h,i)||m&&!m.range.isEnd(j,k))throw new Error("A fold can't intersect already existing fold"+g.range+l.range);var n=this.getFoldsInRange(g.range);n.length>0&&(this.removeFolds(n),n.forEach(function(a){g.addSubFold(a)}));for(var o=0;o<c.length;o++){var p=c[o];if(j==p.start.row){p.addFold(g),d=!0;break}if(h==p.end.row){if(p.addFold(g),d=!0,!g.sameRow){var q=c[o+1];if(q&&q.start.row==j){p.merge(q);break}}break}if(j<=p.start.row)break}return d||(p=this.$addFoldLine(new e(this.$foldData,g))),this.$useWrapMode?this.$updateWrapData(p.start.row,p.start.row):this.$updateRowLengthCache(p.start.row,p.start.row),this.$modified=!0,this._emit("changeFold",{data:g,action:"add"}),g
},this.addFolds=function(a){a.forEach(function(a){this.addFold(a)},this)},this.removeFold=function(a){var b=a.foldLine,c=b.start.row,d=b.end.row,e=this.$foldData,f=b.folds;if(1==f.length)e.splice(e.indexOf(b),1);else if(b.range.isEnd(a.end.row,a.end.column))f.pop(),b.end.row=f[f.length-1].end.row,b.end.column=f[f.length-1].end.column;else if(b.range.isStart(a.start.row,a.start.column))f.shift(),b.start.row=f[0].start.row,b.start.column=f[0].start.column;else if(a.sameRow)f.splice(f.indexOf(a),1);else{var g=b.split(a.start.row,a.start.column);
f=g.folds,f.shift(),g.start.row=f[0].start.row,g.start.column=f[0].start.column}this.$updating||(this.$useWrapMode?this.$updateWrapData(c,d):this.$updateRowLengthCache(c,d)),this.$modified=!0,this._emit("changeFold",{data:a,action:"remove"})},this.removeFolds=function(a){for(var b=[],c=0;c<a.length;c++)b.push(a[c]);b.forEach(function(a){this.removeFold(a)},this),this.$modified=!0},this.expandFold=function(a){this.removeFold(a),a.subFolds.forEach(function(b){a.restoreRange(b),this.addFold(b)},this),a.collapseChildren>0&&this.foldAll(a.start.row+1,a.end.row,a.collapseChildren-1),a.subFolds=[]
},this.expandFolds=function(a){a.forEach(function(a){this.expandFold(a)},this)},this.unfold=function(a,b){var c,e;if(null==a?(c=new d(0,0,this.getLength(),0),b=!0):c="number"==typeof a?new d(a,0,a,this.getLine(a).length):"row"in a?d.fromPoints(a,a):a,e=this.getFoldsInRangeList(c),b)this.removeFolds(e);else for(var f=e;f.length;)this.expandFolds(f),f=this.getFoldsInRangeList(c);return e.length?e:void 0},this.isRowFolded=function(a,b){return!!this.getFoldLine(a,b)},this.getRowFoldEnd=function(a,b){var c=this.getFoldLine(a,b);
return c?c.end.row:a},this.getRowFoldStart=function(a,b){var c=this.getFoldLine(a,b);return c?c.start.row:a},this.getFoldDisplayLine=function(a,b,c,d,e){null==d&&(d=a.start.row,e=0),null==b&&(b=a.end.row,c=this.getLine(b).length);var f=this.doc,g="";return a.walk(function(a,b,c,h){if(!(d>b)){if(b==d){if(e>c)return;h=Math.max(e,h)}g+=null!=a?a:f.getLine(b).substring(h,c)}},b,c),g},this.getDisplayLine=function(a,b,c,d){var e=this.getFoldLine(a);if(e)return this.getFoldDisplayLine(e,a,b,c,d);var f;return f=this.doc.getLine(a),f.substring(d||0,b||f.length)
},this.$cloneFoldData=function(){var a=[];return a=this.$foldData.map(function(b){var c=b.folds.map(function(a){return a.clone()});return new e(a,c)})},this.toggleFold=function(a){var d,e,b=this.selection,c=b.getRange();if(c.isEmpty()){var f=c.start;if(d=this.getFoldAt(f.row,f.column))return this.expandFold(d),void 0;(e=this.findMatchingBracket(f))?1==c.comparePoint(e)?c.end=e:(c.start=e,c.start.column++,c.end.column--):(e=this.findMatchingBracket({row:f.row,column:f.column+1}))?(1==c.comparePoint(e)?c.end=e:c.start=e,c.start.column++):c=this.getCommentFoldRange(f.row,f.column)||c
}else{var g=this.getFoldsInRange(c);if(a&&g.length)return this.expandFolds(g),void 0;1==g.length&&(d=g[0])}if(d||(d=this.getFoldAt(c.start.row,c.start.column)),d&&d.range.toString()==c.toString())return this.expandFold(d),void 0;var h="...";if(!c.isMultiLine()){if(h=this.getTextRange(c),h.length<4)return;h=h.trim().substring(0,2)+".."}this.addFold(h,c)},this.getCommentFoldRange=function(a,b,c){var e=new g(this,a,b),f=e.getCurrentToken();if(f&&/^comment|string/.test(f.type)){var h=new d,i=new RegExp(f.type.replace(/\..*/,"\\."));
if(1!=c){do f=e.stepBackward();while(f&&i.test(f.type));e.stepForward()}if(h.start.row=e.getCurrentTokenRow(),h.start.column=e.getCurrentTokenColumn()+2,e=new g(this,a,b),-1!=c){do f=e.stepForward();while(f&&i.test(f.type));f=e.stepBackward()}else f=e.getCurrentToken();return h.end.row=e.getCurrentTokenRow(),h.end.column=e.getCurrentTokenColumn()+f.value.length-2,h}},this.foldAll=function(a,b,c){void 0==c&&(c=1e5);var d=this.foldWidgets;if(d){b=b||this.getLength(),a=a||0;for(var e=a;b>e;e++)if(null==d[e]&&(d[e]=this.getFoldWidget(e)),"start"==d[e]){var f=this.getFoldWidgetRange(e);
if(f&&f.isMultiLine()&&f.end.row<=b&&f.start.row>=a){e=f.end.row;try{var g=this.addFold("...",f);g&&(g.collapseChildren=c)}catch(h){}}}}},this.$foldStyles={manual:1,markbegin:1,markbeginend:1},this.$foldStyle="markbegin",this.setFoldStyle=function(a){if(!this.$foldStyles[a])throw new Error("invalid fold style: "+a+"["+Object.keys(this.$foldStyles).join(", ")+"]");if(this.$foldStyle!=a){this.$foldStyle=a,"manual"==a&&this.unfold();var b=this.$foldMode;this.$setFolding(null),this.$setFolding(b)}},this.$setFolding=function(a){if(this.$foldMode!=a){if(this.$foldMode=a,this.removeListener("change",this.$updateFoldWidgets),this._emit("changeAnnotation"),!a||"manual"==this.$foldStyle)return this.foldWidgets=null,void 0;
this.foldWidgets=[],this.getFoldWidget=a.getFoldWidget.bind(a,this,this.$foldStyle),this.getFoldWidgetRange=a.getFoldWidgetRange.bind(a,this,this.$foldStyle),this.$updateFoldWidgets=this.updateFoldWidgets.bind(this),this.on("change",this.$updateFoldWidgets)}},this.getParentFoldRangeData=function(a,b){var c=this.foldWidgets;if(!c||b&&c[a])return{};for(var e,d=a-1;d>=0;){var f=c[d];if(null==f&&(f=c[d]=this.getFoldWidget(d)),"start"==f){var g=this.getFoldWidgetRange(d);if(e||(e=g),g&&g.end.row>=a)break}d--}return{range:-1!==d&&g,firstRange:e}
},this.onFoldWidgetClick=function(a,b){b=b.domEvent;var c={children:b.shiftKey,all:b.ctrlKey||b.metaKey,siblings:b.altKey},d=this.$toggleFoldWidget(a,c);if(!d){var e=b.target||b.srcElement;e&&/ace_fold-widget/.test(e.className)&&(e.className+=" ace_invalid")}},this.$toggleFoldWidget=function(a,b){if(this.getFoldWidget){var c=this.getFoldWidget(a),d=this.getLine(a),e="end"===c?-1:1,f=this.getFoldAt(a,-1===e?0:d.length,e);if(f)return b.children||b.all?this.removeFold(f):this.expandFold(f),void 0;var g=this.getFoldWidgetRange(a,!0);
if(g&&!g.isMultiLine()&&(f=this.getFoldAt(g.start.row,g.start.column,1),f&&g.isEqual(f.range)))return this.removeFold(f),void 0;if(b.siblings){var h=this.getParentFoldRangeData(a);if(h.range)var i=h.range.start.row+1,j=h.range.end.row;this.foldAll(i,j,b.all?1e4:0)}else b.children?(j=g?g.end.row:this.getLength(),this.foldAll(a+1,g.end.row,b.all?1e4:0)):g&&(b.all&&(g.collapseChildren=1e4),this.addFold("...",g));return g}},this.toggleFoldWidget=function(){var b=this.selection.getCursor().row;b=this.getRowFoldStart(b);
var c=this.$toggleFoldWidget(b,{});if(!c){var d=this.getParentFoldRangeData(b,!0);if(c=d.range||d.firstRange){b=c.start.row;var e=this.getFoldAt(b,this.getLine(b).length,1);e?this.removeFold(e):this.addFold("...",c)}}},this.updateFoldWidgets=function(a){var b=a.data,c=b.range,d=c.start.row,e=c.end.row-d;if(0===e)this.foldWidgets[d]=null;else if("removeText"==b.action||"removeLines"==b.action)this.foldWidgets.splice(d,e+1,null);else{var f=Array(e+1);f.unshift(d,1),this.foldWidgets.splice.apply(this.foldWidgets,f)
}}}var d=a("../range").Range,e=a("./fold_line").FoldLine,f=a("./fold").Fold,g=a("../token_iterator").TokenIterator;b.Folding=h}),ace.define("ace/edit_session/fold_line",["require","exports","module","ace/range"],function(a,b){function e(a,b){this.foldData=a,Array.isArray(b)?this.folds=b:b=this.folds=[b];var c=b[b.length-1];this.range=new d(b[0].start.row,b[0].start.column,c.end.row,c.end.column),this.start=this.range.start,this.end=this.range.end,this.folds.forEach(function(a){a.setFoldLine(this)},this)}var d=a("../range").Range;
(function(){this.shiftRow=function(a){this.start.row+=a,this.end.row+=a,this.folds.forEach(function(b){b.start.row+=a,b.end.row+=a})},this.addFold=function(a){if(a.sameRow){if(a.start.row<this.startRow||a.endRow>this.endRow)throw new Error("Can't add a fold to this FoldLine as it has no connection");this.folds.push(a),this.folds.sort(function(a,b){return-a.range.compareEnd(b.start.row,b.start.column)}),this.range.compareEnd(a.start.row,a.start.column)>0?(this.end.row=a.end.row,this.end.column=a.end.column):this.range.compareStart(a.end.row,a.end.column)<0&&(this.start.row=a.start.row,this.start.column=a.start.column)
}else if(a.start.row==this.end.row)this.folds.push(a),this.end.row=a.end.row,this.end.column=a.end.column;else{if(a.end.row!=this.start.row)throw new Error("Trying to add fold to FoldRow that doesn't have a matching row");this.folds.unshift(a),this.start.row=a.start.row,this.start.column=a.start.column}a.foldLine=this},this.containsRow=function(a){return a>=this.start.row&&a<=this.end.row},this.walk=function(a,b,c){var f,g,h,d=0,e=this.folds,i=!0;null==b&&(b=this.end.row,c=this.end.column);for(var j=0;j<e.length;j++){if(f=e[j],g=f.range.compareStart(b,c),-1==g)return a(null,b,c,d,i),void 0;
if(h=a(null,f.start.row,f.start.column,d,i),h=!h&&a(f.placeholder,f.start.row,f.start.column,d),h||0==g)return;i=!f.sameRow,d=f.end.column}a(null,b,c,d,i)},this.getNextFoldTo=function(a,b){for(var c,d,e=0;e<this.folds.length;e++){if(c=this.folds[e],d=c.range.compareEnd(a,b),-1==d)return{fold:c,kind:"after"};if(0==d)return{fold:c,kind:"inside"}}return null},this.addRemoveChars=function(a,b,c){var e,f,d=this.getNextFoldTo(a,b);if(d)if(e=d.fold,"inside"==d.kind&&e.start.column!=b&&e.start.row!=a)window.console&&window.console.log(a,b,e);
else if(e.start.row==a){f=this.folds;var g=f.indexOf(e);for(0==g&&(this.start.column+=c),g;g<f.length;g++){if(e=f[g],e.start.column+=c,!e.sameRow)return;e.end.column+=c}this.end.column+=c}},this.split=function(a,b){var c=this.getNextFoldTo(a,b).fold,d=this.folds,f=this.foldData;if(!c)return null;var g=d.indexOf(c),h=d[g-1];this.end.row=h.end.row,this.end.column=h.end.column,d=d.splice(g,d.length-g);var i=new e(f,d);return f.splice(f.indexOf(this)+1,0,i),i},this.merge=function(a){for(var b=a.folds,c=0;c<b.length;c++)this.addFold(b[c]);
var d=this.foldData;d.splice(d.indexOf(a),1)},this.toString=function(){var a=[this.range.toString()+": ["];return this.folds.forEach(function(b){a.push("  "+b.toString())}),a.push("]"),a.join("\n")},this.idxToPosition=function(a){for(var c,b=0,d=0;d<this.folds.length;d++){var c=this.folds[d];if(a-=c.start.column-b,0>a)return{row:c.start.row,column:c.start.column+a};if(a-=c.placeholder.length,0>a)return c.start;b=c.end.column}return{row:this.end.row,column:this.end.column+a}}}).call(e.prototype),b.FoldLine=e}),ace.define("ace/tokenizer",["require","exports","module"],function(a,b){var d=1e3,e=function(a){this.states=a,this.regExps={},this.matchMappings={};
...
j.tokenArray=j.token,j.token=null,j.onMatch=this.$arrayTokens}else"function"!=typeof j.token||j.onMatch||(j.onMatch=l>1?this.$applyToken:j.token);l>1&&(/\\\d/.test(j.regex)?k=j.regex.replace(/\\([0-9]+)/g,function(a,b){return"\\"+(parseInt(b,10)+e+1)}):(l=1,k=this.removeCapturingGroups(j.regex)),j.splitRegex||"string"==typeof j.token||h.push(j)),f[e]=i,e+=l,d.push(k),j.onMatch||(j.onMatch=null),j.__proto__=null}}h.forEach(function(a){a.splitRegex=this.createSplitterRegexp(a.regex,g)},this),this.regExps[b]=new RegExp("("+d.join(")|(")+")|($)",g)
...
break}if(o)if("string"==typeof m)n&&n.merge===!1||l.type!==m?(l.type&&j.push(l),l={type:m,value:o}):l.value+=o;else if(m){l.type&&j.push(l),l={type:null,value:""};for(var r=0;r<m.length;r++)j.push(m[r])}if(k==a.length)break;if(k=p,j.length>d){for(;k<a.length;)l.type&&j.push(l),l={value:a.substring(k,k+=2e3),type:"overflow"};e="start",c=[];break}}return l.type&&j.push(l),c.length>1&&c[0]!==e&&c.unshift(e),{tokens:j,state:c.length?c:e}}}).call(e.prototype),b.Tokenizer=e}),ace.define("ace/edit_session/fold",["require","exports","module","ace/range","ace/range_list","ace/lib/oop"],function(a,b){function h(a,b){a.row-=b.row,0==a.row&&(a.column-=b.column)
}function i(a,b){h(a.start,b),h(a.end,b)}function j(a,b){0==a.row&&(a.column+=b.column),a.row+=b.row}function k(a,b){j(a.start,b),j(a.end,b)}var e=(a("../range").Range,a("../range_list").RangeList),f=a("../lib/oop"),g=b.Fold=function(a,b){this.foldLine=null,this.placeholder=b,this.range=a,this.start=a.start,this.end=a.end,this.sameRow=a.start.row==a.end.row,this.subFolds=this.ranges=[]};f.inherits(g,e),function(){this.toString=function(){return'"'+this.placeholder+'" '+this.range.toString()},this.setFoldLine=function(a){this.foldLine=a,this.subFolds.forEach(function(b){b.setFoldLine(a)
})},this.clone=function(){var a=this.range.clone(),b=new g(a,this.placeholder);return this.subFolds.forEach(function(a){b.subFolds.push(a.clone())}),b.collapseChildren=this.collapseChildren,b},this.addSubFold=function(a){if(!this.range.isEqual(a)){if(!this.range.containsRange(a))throw new Error("A fold can't intersect already existing fold"+a.range+this.range);i(a,this.start);for(var b=a.start.row,c=a.start.column,d=0,e=-1;d<this.subFolds.length&&(e=this.subFolds[d].range.compare(b,c),1==e);d++);var f=this.subFolds[d];
if(0==e)return f.addSubFold(a);for(var b=a.range.end.row,c=a.range.end.column,g=d,e=-1;g<this.subFolds.length&&(e=this.subFolds[g].range.compare(b,c),1==e);g++);{this.subFolds[g]}if(0==e)throw new Error("A fold can't intersect already existing fold"+a.range+this.range);{this.subFolds.splice(d,g-d,a)}return a.setFoldLine(this.foldLine),a}},this.restoreRange=function(a){return k(a,this.start)}}.call(g.prototype)}),ace.define("ace/mode/text",["require","exports","module","ace/tokenizer","ace/mode/text_highlight_rules","ace/mode/behaviour","ace/unicode","ace/lib/lang","ace/token_iterator","ace/range"],function(a,b){var d=a("../tokenizer").Tokenizer,e=a("./text_highlight_rules").TextHighlightRules,f=a("./behaviour").Behaviour,g=a("../unicode"),h=a("../lib/lang"),i=a("../token_iterator").TokenIterator,j=a("../range").Range,k=function(){this.HighlightRules=e,this.$behaviour=new f
...
}var e=b.doc,f=!0,g=!0,i=1/0,j=b.getTabSize(),k=!1;if(this.lineCommentStart){if(Array.isArray(this.lineCommentStart))var n=this.lineCommentStart.map(h.escapeRegExp).join("|"),l=this.lineCommentStart[0];else var n=h.escapeRegExp(this.lineCommentStart),l=this.lineCommentStart;n=new RegExp("^(\\s*)(?:"+n+") ?"),k=b.getUseSoftTabs();var q=function(a,b){var c=a.match(n);if(c){var d=c[1].length,f=c[0].length;t(a,d,f)||" "!=c[0][f-1]||f--,e.removeInLine(b,d,f)}},s=l+" ",p=function(a,b){(!f||/\S/.test(a))&&(t(a,i,i)?e.insertInLine({row:b,column:i},s):e.insertInLine({row:b,column:i},l))
},r=function(a){return n.test(a)},t=function(a,b,c){for(var d=0;b--&&" "==a.charAt(b);)d++;if(d%j!=0)return!1;for(var d=0;" "==a.charAt(c++);)d++;return j>2?d%j!=j-1:d%j==0}}else{if(!this.blockComment)return!1;var l=this.blockComment.start,m=this.blockComment.end,n=new RegExp("^(\\s*)(?:"+h.escapeRegExp(l)+")"),o=new RegExp("(?:"+h.escapeRegExp(m)+")\\s*$"),p=function(a,b){r(a,b)||(!f||/\S/.test(a))&&(e.insertInLine({row:b,column:a.length},m),e.insertInLine({row:b,column:i},l))},q=function(a,b){var c;(c=a.match(o))&&e.removeInLine(b,a.length-c[0].length,a.length),(c=a.match(n))&&e.removeInLine(b,c[1].length,c[0].length)
},r=function(a,c){if(n.test(a))return!0;for(var d=b.getTokens(c),e=0;e<d.length;e++)if("comment"===d[e].type)return!0}}var v=1/0;u(function(a,b){var c=a.search(/\S/);-1!==c?(i>c&&(i=c),g&&!r(a,b)&&(g=!1)):v>a.length&&(v=a.length)}),1/0==i&&(i=v,f=!1,g=!1),k&&i%j!=0&&(i=Math.floor(i/j)*j),u(g?q:p)},this.toggleBlockComment=function(a,b,c,d){var e=this.blockComment;if(e){!e.start&&e[0]&&(e=e[0]);var l,m,f=new i(b,d.row,d.column),g=f.getCurrentToken(),k=(b.selection,b.selection.toOrientedRange());if(g&&/comment/.test(g.type)){for(var n,o;g&&/comment/.test(g.type);){var p=g.value.indexOf(e.start);
...
},this.$updateRowLengthCache=function(a,b){this.$rowLengthCache[a]=null,this.$rowLengthCache[b]=null},this.$updateWrapData=function(a,b){var g,i,c=this.doc.getAllLines(),d=this.getTabSize(),e=this.$wrapData,f=this.$wrapLimit,j=a;for(b=Math.min(b,c.length-1);b>=j;)i=this.getFoldLine(j,i),i?(g=[],i.walk(function(a,b,d,e){var f;if(null!=a){f=this.$getDisplayTokens(a,g.length),f[0]=h;for(var i=1;i<f.length;i++)f[i]=k}else f=this.$getDisplayTokens(c[b].substring(e,d),g.length);g=g.concat(f)}.bind(this),i.end.row,c[i.end.row].length+1),e[i.start.row]=this.$computeWrapSplits(g,f,d),j=i.end.row+1):(g=this.$getDisplayTokens(c[j]),e[j]=this.$computeWrapSplits(g,f,d),j++)
};var b=1,c=2,h=3,k=4,n=9,o=10,p=11,q=12;this.$computeWrapSplits=function(a,b){function i(b){var d=a.slice(e,b),g=d.length;d.join("").replace(/12/g,function(){g-=1}).replace(/2/g,function(){g-=1}),f+=g,c.push(f),e=b}if(0==a.length)return[];for(var c=[],d=a.length,e=0,f=0,g=this.$wrapAsCode;d-e>b;){var j=e+b;if(a[j-1]>=o&&a[j]>=o)i(j);else if(a[j]!=h&&a[j]!=k){for(var l=Math.max(j-(g?10:b-(b>>2)),e-1);j>l&&a[j]<h;)j--;if(g){for(;j>l&&a[j]<h;)j--;for(;j>l&&a[j]==n;)j--}else for(;j>l&&a[j]<o;)j--;j>l?i(++j):(j=e+b,i(j))
}else{for(j;j!=e-1&&a[j]!=h;j--);if(j>e){i(j);continue}for(j=e+b;j<a.length&&a[j]==k;j++);if(j==a.length)break;i(j)}}return c},this.$getDisplayTokens=function(a,d){var f,e=[];d=d||0;for(var g=0;g<a.length;g++){var h=a.charCodeAt(g);if(9==h){f=this.getScreenTabSize(e.length+d),e.push(p);for(var i=1;f>i;i++)e.push(q)}else 32==h?e.push(o):h>39&&48>h||h>57&&64>h?e.push(n):h>=4352&&r(h)?e.push(b,c):e.push(b)}return e},this.$getStringScreenWidth=function(a,b,c){if(0==b)return[0,0];null==b&&(b=1/0),c=c||0;var d,e;for(e=0;e<a.length&&(d=a.charCodeAt(e),c+=9==d?this.getScreenTabSize(c):d>=4352&&r(d)?2:1,!(c>b));e++);return[c,e]
...
var h=e.getFoldAt(d,e.getLine(d).length,1);h?e.removeFold(h):(e.addFold("...",g),a.renderer.scrollCursorIntoView({row:g.start.row,column:0}))}b.stop()}})}b.FoldHandler=d}),ace.define("ace/commands/default_commands",["require","exports","module","ace/lib/lang","ace/config"],function(a,b){function f(a,b){return{win:a,mac:b}}var d=a("../lib/lang"),e=a("../config");b.commands=[{name:"showSettingsMenu",bindKey:f("Ctrl-,","Command-,"),exec:function(a){e.loadModule("ace/ext/settings_menu",function(b){b.init(a),a.showSettingsMenu()
})},readOnly:!0},{name:"goToNextError",bindKey:f("Alt-E","Ctrl-E"),exec:function(a){e.loadModule("ace/ext/error_marker",function(b){b.showErrorMarker(a,1)})},scrollIntoView:"animate",readOnly:!0},{name:"goToPreviousError",bindKey:f("Alt-Shift-E","Ctrl-Shift-E"),exec:function(a){e.loadModule("ace/ext/error_marker",function(b){b.showErrorMarker(a,-1)})},scrollIntoView:"animate",readOnly:!0},{name:"selectall",bindKey:f("Ctrl-A","Command-A"),exec:function(a){a.selectAll()},readOnly:!0},{name:"centerselection",bindKey:f(null,"Ctrl-L"),exec:function(a){a.centerSelection()
},readOnly:!0},{name:"gotoline",bindKey:f("Ctrl-L","Command-L"),exec:function(a){var b=parseInt(prompt("Enter line number:"),10);isNaN(b)||a.gotoLine(b)},readOnly:!0},{name:"fold",bindKey:f("Alt-L|Ctrl-F1","Command-Alt-L|Command-F1"),exec:function(a){a.session.toggleFold(!1)},scrollIntoView:"center",readOnly:!0},{name:"unfold",bindKey:f("Alt-Shift-L|Ctrl-Shift-F1","Command-Alt-Shift-L|Command-Shift-F1"),exec:function(a){a.session.toggleFold(!0)},scrollIntoView:"center",readOnly:!0},{name:"toggleFoldWidget",bindKey:f("F2","F2"),exec:function(a){a.session.toggleFoldWidget()
},scrollIntoView:"center",readOnly:!0},{name:"toggleParentFoldWidget",bindKey:f("Alt-F2","Alt-F2"),exec:function(a){a.session.toggleFoldWidget(!0)},scrollIntoView:"center",readOnly:!0},{name:"foldall",bindKey:f("Ctrl-Alt-0","Ctrl-Command-Option-0"),exec:function(a){a.session.foldAll()},scrollIntoView:"center",readOnly:!0},{name:"foldOther",bindKey:f("Alt-0","Command-Option-0"),exec:function(a){a.session.foldAll(),a.session.unfold(a.selection.getAllRanges())},scrollIntoView:"center",readOnly:!0},{name:"unfoldall",bindKey:f("Alt-Shift-0","Command-Option-Shift-0"),exec:function(a){a.session.unfold()
},scrollIntoView:"center",readOnly:!0},{name:"findnext",bindKey:f("Ctrl-K","Command-G"),exec:function(a){a.findNext()},readOnly:!0},{name:"findprevious",bindKey:f("Ctrl-Shift-K","Command-Shift-G"),exec:function(a){a.findPrevious()},readOnly:!0},{name:"selectOrFindNext",bindKey:f("ALt-K","Ctrl-G"),exec:function(a){a.selection.isEmpty()?a.selection.selectWord():a.findNext()},readOnly:!0},{name:"selectOrFindPrevious",bindKey:f("Alt-Shift-K","Ctrl-Shift-G"),exec:function(a){a.selection.isEmpty()?a.selection.selectWord():a.findPrevious()
},readOnly:!0},{name:"find",bindKey:f("Ctrl-F","Command-F"),exec:function(a){e.loadModule("ace/ext/searchbox",function(b){b.Search(a)})},readOnly:!0},{name:"overwrite",bindKey:"Insert",exec:function(a){a.toggleOverwrite()},readOnly:!0},{name:"selecttostart",bindKey:f("Ctrl-Shift-Home","Command-Shift-Up"),exec:function(a){a.getSelection().selectFileStart()},multiSelectAction:"forEach",readOnly:!0,scrollIntoView:"animate",aceCommandGroup:"fileJump"},{name:"gotostart",bindKey:f("Ctrl-Home","Command-Home|Command-Up"),exec:function(a){a.navigateFileStart()
},multiSelectAction:"forEach",readOnly:!0,scrollIntoView:"animate",aceCommandGroup:"fileJump"},{name:"selectup",bindKey:f("Shift-Up","Shift-Up"),exec:function(a){a.getSelection().selectUp()},multiSelectAction:"forEach",readOnly:!0},{name:"golineup",bindKey:f("Up","Up|Ctrl-P"),exec:function(a,b){a.navigateUp(b.times)},multiSelectAction:"forEach",readOnly:!0},{name:"selecttoend",bindKey:f("Ctrl-Shift-End","Command-Shift-Down"),exec:function(a){a.getSelection().selectFileEnd()},multiSelectAction:"forEach",readOnly:!0,scrollIntoView:"animate",aceCommandGroup:"fileJump"},{name:"gotoend",bindKey:f("Ctrl-End","Command-End|Command-Down"),exec:function(a){a.navigateFileEnd()
},multiSelectAction:"forEach",readOnly:!0,scrollIntoView:"animate",aceCommandGroup:"fileJump"},{name:"selectdown",bindKey:f("Shift-Down","Shift-Down"),exec:function(a){a.getSelection().selectDown()},multiSelectAction:"forEach",scrollIntoView:"cursor",readOnly:!0},{name:"golinedown",bindKey:f("Down","Down|Ctrl-N"),exec:function(a,b){a.navigateDown(b.times)},multiSelectAction:"forEach",scrollIntoView:"cursor",readOnly:!0},{name:"selectwordleft",bindKey:f("Ctrl-Shift-Left","Option-Shift-Left"),exec:function(a){a.getSelection().selectWordLeft()
},multiSelectAction:"forEach",scrollIntoView:"cursor",readOnly:!0},{name:"gotowordleft",bindKey:f("Ctrl-Left","Option-Left"),exec:function(a){a.navigateWordLeft()},multiSelectAction:"forEach",scrollIntoView:"cursor",readOnly:!0},{name:"selecttolinestart",bindKey:f("Alt-Shift-Left","Command-Shift-Left"),exec:function(a){a.getSelection().selectLineStart()},multiSelectAction:"forEach",scrollIntoView:"cursor",readOnly:!0},{name:"gotolinestart",bindKey:f("Alt-Left|Home","Command-Left|Home|Ctrl-A"),exec:function(a){a.navigateLineStart()
},multiSelectAction:"forEach",scrollIntoView:"cursor",readOnly:!0},{name:"selectleft",bindKey:f("Shift-Left","Shift-Left"),exec:function(a){a.getSelection().selectLeft()},multiSelectAction:"forEach",scrollIntoView:"cursor",readOnly:!0},{name:"gotoleft",bindKey:f("Left","Left|Ctrl-B"),exec:function(a,b){a.navigateLeft(b.times)},multiSelectAction:"forEach",scrollIntoView:"cursor",readOnly:!0},{name:"selectwordright",bindKey:f("Ctrl-Shift-Right","Option-Shift-Right"),exec:function(a){a.getSelection().selectWordRight()
},multiSelectAction:"forEach",scrollIntoView:"cursor",readOnly:!0},{name:"gotowordright",bindKey:f("Ctrl-Right","Option-Right"),exec:function(a){a.navigateWordRight()},multiSelectAction:"forEach",scrollIntoView:"cursor",readOnly:!0},{name:"selecttolineend",bindKey:f("Alt-Shift-Right","Command-Shift-Right"),exec:function(a){a.getSelection().selectLineEnd()},multiSelectAction:"forEach",scrollIntoView:"cursor",readOnly:!0},{name:"gotolineend",bindKey:f("Alt-Right|End","Command-Right|End|Ctrl-E"),exec:function(a){a.navigateLineEnd()
},multiSelectAction:"forEach",scrollIntoView:"cursor",readOnly:!0},{name:"selectright",bindKey:f("Shift-Right","Shift-Right"),exec:function(a){a.getSelection().selectRight()},multiSelectAction:"forEach",scrollIntoView:"cursor",readOnly:!0},{name:"gotoright",bindKey:f("Right","Right|Ctrl-F"),exec:function(a,b){a.navigateRight(b.times)},multiSelectAction:"forEach",scrollIntoView:"cursor",readOnly:!0},{name:"selectpagedown",bindKey:"Shift-PageDown",exec:function(a){a.selectPageDown()},readOnly:!0},{name:"pagedown",bindKey:f(null,"Option-PageDown"),exec:function(a){a.scrollPageDown()
},readOnly:!0},{name:"gotopagedown",bindKey:f("PageDown","PageDown|Ctrl-V"),exec:function(a){a.gotoPageDown()},readOnly:!0},{name:"selectpageup",bindKey:"Shift-PageUp",exec:function(a){a.selectPageUp()},readOnly:!0},{name:"pageup",bindKey:f(null,"Option-PageUp"),exec:function(a){a.scrollPageUp()},readOnly:!0},{name:"gotopageup",bindKey:"PageUp",exec:function(a){a.gotoPageUp()},readOnly:!0},{name:"scrollup",bindKey:f("Ctrl-Up",null),exec:function(a){a.renderer.scrollBy(0,-2*a.renderer.layerConfig.lineHeight)},readOnly:!0},{name:"scrolldown",bindKey:f("Ctrl-Down",null),exec:function(a){a.renderer.scrollBy(0,2*a.renderer.layerConfig.lineHeight)
},readOnly:!0},{name:"selectlinestart",bindKey:"Shift-Home",exec:function(a){a.getSelection().selectLineStart()},multiSelectAction:"forEach",scrollIntoView:"cursor",readOnly:!0},{name:"selectlineend",bindKey:"Shift-End",exec:function(a){a.getSelection().selectLineEnd()},multiSelectAction:"forEach",scrollIntoView:"cursor",readOnly:!0},{name:"togglerecording",bindKey:f("Ctrl-Alt-E","Command-Option-E"),exec:function(a){a.commands.toggleRecording(a)},readOnly:!0},{name:"replaymacro",bindKey:f("Ctrl-Shift-E","Command-Shift-E"),exec:function(a){a.commands.replay(a)
},readOnly:!0},{name:"jumptomatching",bindKey:f("Ctrl-P","Ctrl-Shift-P"),exec:function(a){a.jumpToMatching()},multiSelectAction:"forEach",readOnly:!0},{name:"selecttomatching",bindKey:f("Ctrl-Shift-P",null),exec:function(a){a.jumpToMatching(!0)},multiSelectAction:"forEach",readOnly:!0},{name:"cut",exec:function(a){var b=a.getSelectionRange();a._emit("cut",b),a.selection.isEmpty()||(a.session.remove(b),a.clearSelection())},scrollIntoView:"cursor",multiSelectAction:"forEach"},{name:"removeline",bindKey:f("Ctrl-D","Command-D"),exec:function(a){a.removeLines()
},scrollIntoView:"cursor",multiSelectAction:"forEachLine"},{name:"duplicateSelection",bindKey:f("Ctrl-Shift-D","Command-Shift-D"),exec:function(a){a.duplicateSelection()},scrollIntoView:"cursor",multiSelectAction:"forEach"},{name:"sortlines",bindKey:f("Ctrl-Alt-S","Command-Alt-S"),exec:function(a){a.sortLines()},scrollIntoView:"selection",multiSelectAction:"forEachLine"},{name:"togglecomment",bindKey:f("Ctrl-/","Command-/"),exec:function(a){a.toggleCommentLines()},multiSelectAction:"forEachLine",scrollIntoView:"selectionPart"},{name:"toggleBlockComment",bindKey:f("Ctrl-Shift-/","Command-Shift-/"),exec:function(a){a.toggleBlockComment()
},multiSelectAction:"forEach",scrollIntoView:"selectionPart"},{name:"modifyNumberUp",bindKey:f("Ctrl-Shift-Up","Alt-Shift-Up"),exec:function(a){a.modifyNumber(1)},multiSelectAction:"forEach"},{name:"modifyNumberDown",bindKey:f("Ctrl-Shift-Down","Alt-Shift-Down"),exec:function(a){a.modifyNumber(-1)},multiSelectAction:"forEach"},{name:"replace",bindKey:f("Ctrl-H","Command-Option-F"),exec:function(a){e.loadModule("ace/ext/searchbox",function(b){b.Search(a,!0)})}},{name:"undo",bindKey:f("Ctrl-Z","Command-Z"),exec:function(a){a.undo()
}},{name:"redo",bindKey:f("Ctrl-Shift-Z|Ctrl-Y","Command-Shift-Z|Command-Y"),exec:function(a){a.redo()}},{name:"copylinesup",bindKey:f("Alt-Shift-Up","Command-Option-Up"),exec:function(a){a.copyLinesUp()},scrollIntoView:"cursor"},{name:"movelinesup",bindKey:f("Alt-Up","Option-Up"),exec:function(a){a.moveLinesUp()},scrollIntoView:"cursor"},{name:"copylinesdown",bindKey:f("Alt-Shift-Down","Command-Option-Down"),exec:function(a){a.copyLinesDown()},scrollIntoView:"cursor"},{name:"movelinesdown",bindKey:f("Alt-Down","Option-Down"),exec:function(a){a.moveLinesDown()
},scrollIntoView:"cursor"},{name:"del",bindKey:f("Delete","Delete|Ctrl-D|Shift-Delete"),exec:function(a){a.remove("right")},multiSelectAction:"forEach",scrollIntoView:"cursor"},{name:"backspace",bindKey:f("Shift-Backspace|Backspace","Ctrl-Backspace|Shift-Backspace|Backspace|Ctrl-H"),exec:function(a){a.remove("left")},multiSelectAction:"forEach",scrollIntoView:"cursor"},{name:"cut_or_delete",bindKey:f("Shift-Delete",null),exec:function(a){return a.selection.isEmpty()?(a.remove("left"),void 0):!1},multiSelectAction:"forEach",scrollIntoView:"cursor"},{name:"removetolinestart",bindKey:f("Alt-Backspace","Command-Backspace"),exec:function(a){a.removeToLineStart()
},multiSelectAction:"forEach",scrollIntoView:"cursor"},{name:"removetolineend",bindKey:f("Alt-Delete","Ctrl-K"),exec:function(a){a.removeToLineEnd()},multiSelectAction:"forEach",scrollIntoView:"cursor"},{name:"removewordleft",bindKey:f("Ctrl-Backspace","Alt-Backspace|Ctrl-Alt-Backspace"),exec:function(a){a.removeWordLeft()},multiSelectAction:"forEach",scrollIntoView:"cursor"},{name:"removewordright",bindKey:f("Ctrl-Delete","Alt-Delete"),exec:function(a){a.removeWordRight()},multiSelectAction:"forEach",scrollIntoView:"cursor"},{name:"outdent",bindKey:f("Shift-Tab","Shift-Tab"),exec:function(a){a.blockOutdent()
},multiSelectAction:"forEach",scrollIntoView:"selectionPart"},{name:"indent",bindKey:f("Tab","Tab"),exec:function(a){a.indent()},multiSelectAction:"forEach",scrollIntoView:"selectionPart"},{name:"blockoutdent",bindKey:f("Ctrl-[","Ctrl-["),exec:function(a){a.blockOutdent()},multiSelectAction:"forEachLine",scrollIntoView:"selectionPart"},{name:"blockindent",bindKey:f("Ctrl-]","Ctrl-]"),exec:function(a){a.blockIndent()},multiSelectAction:"forEachLine",scrollIntoView:"selectionPart"},{name:"insertstring",exec:function(a,b){a.insert(b)
},multiSelectAction:"forEach",scrollIntoView:"cursor"},{name:"inserttext",exec:function(a,b){a.insert(d.stringRepeat(b.text||"",b.times||1))},multiSelectAction:"forEach",scrollIntoView:"cursor"},{name:"splitline",bindKey:f(null,"Ctrl-O"),exec:function(a){a.splitLine()},multiSelectAction:"forEach",scrollIntoView:"cursor"},{name:"transposeletters",bindKey:f("Ctrl-T","Ctrl-T"),exec:function(a){a.transposeLetters()},multiSelectAction:function(a){a.transposeSelections(1)},scrollIntoView:"cursor"},{name:"touppercase",bindKey:f("Ctrl-U","Ctrl-U"),exec:function(a){a.toUpperCase()
},multiSelectAction:"forEach",scrollIntoView:"cursor"},{name:"tolowercase",bindKey:f("Ctrl-Shift-U","Ctrl-Shift-U"),exec:function(a){a.toLowerCase()},multiSelectAction:"forEach",scrollIntoView:"cursor"}]}),ace.define("ace/lib/event_emitter",["require","exports","module"],function(a,b){var d={},e=function(){this.propagationStopped=!0},f=function(){this.defaultPrevented=!0};d._emit=d._dispatchEvent=function(a,b){this._eventRegistry||(this._eventRegistry={}),this._defaultHandlers||(this._defaultHandlers={});var c=this._eventRegistry[a]||[],d=this._defaultHandlers[a];
...
},this.setCompositionText=function(){this.$moveTextAreaToCursor()},this.hideComposition=function(){this.$composition&&(e.removeCssClass(this.textarea,"ace_composition"),this.$keepTextAreaAtCursor=this.$composition.keepTextAreaAtCursor,this.textarea.style.cssText=this.$composition.cssText,this.$composition=null)},this.setTheme=function(a,b){function g(d){if(c.$themeId!=a)return b&&b();if(d.cssClass){e.importCssString(d.cssText,d.cssClass,c.container.ownerDocument),c.theme&&e.removeCssClass(c.container,c.theme.cssClass);
var f="padding"in d?d.padding:"padding"in(c.theme||{})?4:c.$padding;c.$padding&&f!=c.$padding&&c.setPadding(f),c.$theme=d.cssClass,c.theme=d,e.addCssClass(c.container,d.cssClass),e.setCssClass(c.container,"ace_dark",d.isDark),c.$size&&(c.$size.width=0,c.$updateSizeAsync()),c._dispatchEvent("themeLoaded",{theme:d}),b&&b()}}var c=this;if(this.$themeId=a,c._dispatchEvent("themeChange",{theme:a}),a&&"string"!=typeof a)g(a);else{var d=a||this.$options.theme.initialValue;f.loadModule(["theme",d],g)}},this.getTheme=function(){return this.$themeId
...
}),ace.define("ace/config",["require","exports","module","ace/lib/lang","ace/lib/oop","ace/lib/net","ace/lib/event_emitter"],function(b,c,d){"no use strict";function k(a){if(j.packaged=a||b.packaged||d.packaged||i.define&&define.packaged,!i.document)return"";for(var e={base:j.basePath},f="",g=document.getElementsByTagName("script"),h=0;h<g.length;h++){var k=g[h],m=k.src||k.getAttribute("src");if(m){for(var n=k.attributes,o=0,p=n.length;p>o;o++){var q=n[o];0===q.name.indexOf("data-ace-")&&(e[l(q.name.replace(/^data-ace-/,""))]=q.value)
}var r=m.match(/^(.*)\/ace(\-\w+)?\.js(\?|$)/);r&&(f=r[1])}}f&&(e.base=e.base||f,e.packaged=!0),e.basePath=e.base,e.workerPath=e.workerPath||e.base,e.modePath=e.modePath||e.base,e.themePath=e.themePath||e.base,delete e.base;for(var s in e)"undefined"!=typeof e[s]&&c.set(s,e[s])}function l(a){return a.replace(/-(.)/g,function(a,b){return b.toUpperCase()})}var e=b("./lib/lang"),f=b("./lib/oop"),g=b("./lib/net"),h=b("./lib/event_emitter").EventEmitter,i=function(){return this}(),j={packaged:!1,workerPath:null,modePath:null,themePath:null,basePath:a.rootPath+"/media/com_easyblog/scripts/vendors/ace",suffix:".js",$moduleUrls:{}};
c.get=function(a){if(!j.hasOwnProperty(a))throw new Error("Unknown config key: "+a);return j[a]},c.set=function(a,b){if(!j.hasOwnProperty(a))throw new Error("Unknown config key: "+a);j[a]=b},c.all=function(){return e.copyObject(j)},f.implement(c,h),c.moduleUrl=function(a,b){if(j.$moduleUrls[a])return j.$moduleUrls[a];var c=a.split("/");b=b||c[c.length-2]||"";var d="snippets"==b?"/":"-",e=c[c.length-1];if("-"==d){var f=new RegExp("^"+b+"[\\-_]|[\\-_]"+b+"$","g");e=e.replace(f,"")}(!e||e==b)&&c.length>1&&(e=c[c.length-2]);
var g=j[b+"Path"];return null==g?g=j.basePath:"/"==d&&(b=d=""),g&&"/"!=g.slice(-1)&&(g+="/"),g+b+d+e+this.get("suffix")},c.setModuleUrl=function(a,b){return j.$moduleUrls[a]=b},c.$loading={},c.loadModule=function(a,d){var e,f;Array.isArray(a)&&(f=a[0],a=a[1]);try{e=b(a)}catch(h){}if(e&&!c.$loading[a])return d&&d(e);if(c.$loading[a]||(c.$loading[a]=[]),c.$loading[a].push(d),!(c.$loading[a].length>1)){var i=function(){b([a],function(b){c._emit("load.module",{name:a,module:b});var d=c.$loading[a];c.$loading[a]=null,d.forEach(function(a){a&&a(b)
})})};return c.get("packaged")?(g.loadScript(c.moduleUrl(a,f),i),void 0):i()}},k(!0),c.init=k;var m={setOptions:function(a){Object.keys(a).forEach(function(b){this.setOption(b,a[b])},this)},getOptions:function(a){var b={};return a?Array.isArray(a)||(b=a,a=Object.keys(b)):a=Object.keys(this.$options),a.forEach(function(a){b[a]=this.getOption(a)},this),b},setOption:function(a,b){if(this["$"+a]!==b){var c=this.$options[a];if(!c)return"undefined"!=typeof console&&console.warn&&console.warn('misspelled option "'+a+'"'),void 0;
if(c.forwardTo)return this[c.forwardTo]&&this[c.forwardTo].setOption(a,b);c.handlesSet||(this["$"+a]=b),c&&c.set&&c.set.call(this,b)}},getOption:function(a){var b=this.$options[a];return b?b.forwardTo?this[b.forwardTo]&&this[b.forwardTo].getOption(a):b&&b.get?b.get.call(this):this["$"+a]:("undefined"!=typeof console&&console.warn&&console.warn('misspelled option "'+a+'"'),void 0)}},n={};c.defineOptions=function(a,b,c){return a.$options||(n[b]=a.$options={}),Object.keys(c).forEach(function(b){var d=c[b];"string"==typeof d&&(d={forwardTo:d}),d.name||(d.name=b),a.$options[d.name]=d,"initialValue"in d&&(a["$"+d.name]=d.initialValue)
}),f.implement(a,m),this},c.resetOptions=function(a){Object.keys(a.$options).forEach(function(b){var c=a.$options[b];"value"in c&&a.setOption(b,c.value)})},c.setDefaultValue=function(a,b,d){var e=n[a]||(n[a]={});e[b]&&(e.forwardTo?c.setDefaultValue(e.forwardTo,b,d):e[b].value=d)},c.setDefaultValues=function(a,b){Object.keys(b).forEach(function(d){c.setDefaultValue(a,d,b[d])})}}),ace.define("ace/layer/gutter",["require","exports","module","ace/lib/dom","ace/lib/oop","ace/lib/lang","ace/lib/event_emitter"],function(a,b){var d=a("../lib/dom"),e=a("../lib/oop"),f=a("../lib/lang"),g=a("../lib/event_emitter").EventEmitter,h=function(a){this.element=d.createElement("div"),this.element.className="ace_layer ace_gutter-layer",a.appendChild(this.element),this.setShowFoldWidgets(this.$showFoldWidgets),this.gutterWidth=0,this.$annotations=[],this.$updateAnnotations=this.$updateAnnotations.bind(this),this.$cells=[]
...
}}).call(h.prototype),b.Gutter=h}),ace.define("ace/mouse/dragdrop_handler",["require","exports","module","ace/lib/dom","ace/lib/event","ace/lib/useragent"],function(a,b){function j(a){function y(a,c){var d=Date.now(),e=!c||a.row!=c.row,f=!c||a.column!=c.column;if(!w||e||f)b.$blockScrolling+=1,b.moveCursorToPosition(a),b.$blockScrolling-=1,w=d,x={x:n,y:o};else{var g=k(x.x,x.y,n,o);g>i?w=null:d-w>=h&&(b.renderer.scrollCursorIntoView(),w=null)}}function z(a,c){var d=Date.now(),e=b.renderer.layerConfig.lineHeight,f=b.renderer.layerConfig.characterWidth,h=b.renderer.scroller.getBoundingClientRect(),i={x:{left:n-h.left,right:h.right-n},y:{top:o-h.top,bottom:h.bottom-o}},j=Math.min(i.x.left,i.x.right),k=Math.min(i.y.top,i.y.bottom),l={row:a.row,column:a.column};
2>=j/f&&(l.column+=i.x.left<i.x.right?-3:2),1>=k/e&&(l.row+=i.y.top<i.y.bottom?-1:1);var m=a.row!=l.row,p=a.column!=l.column,q=!c||a.row!=c.row;m||p&&!q?v?d-v>=g&&b.renderer.scrollCursorIntoView(l):v=d:v=null}function A(){var a=r;r=b.renderer.screenToTextCoordinates(n,o),y(r,a),z(r,a)}function B(){q=b.selection.toOrientedRange(),m=b.session.addMarker(q,"ace_selection",b.getSelectionStyle()),b.clearSelection(),b.isFocused()&&b.renderer.$cursorLayer.setBlinking(!1),clearInterval(p),p=setInterval(A,20),s=0,e.addListener(document,"mousemove",E)
}function C(){clearInterval(p),b.session.removeMarker(m),m=null,b.$blockScrolling+=1,b.selection.fromOrientedRange(q),b.$blockScrolling-=1,b.isFocused()&&!u&&b.renderer.$cursorLayer.setBlinking(!b.getReadOnly()),q=null,s=0,v=null,w=null,e.removeListener(document,"mousemove",E)}function E(){null==D&&(D=setTimeout(function(){null!=D&&m&&C()},20))}function F(a){var b=a.types;return!b||Array.prototype.some.call(b,function(a){return"text/plain"==a||"Text"==a})}function G(a){var b=["copy","copymove","all","uninitialized"],c=["move","copymove","linkmove","all","uninitialized"],d=f.isMac?a.altKey:a.ctrlKey,e="uninitialized";
try{e=a.dataTransfer.effectAllowed.toLowerCase()}catch(a){}var g="none";return d&&b.indexOf(e)>=0?g="copy":c.indexOf(e)>=0?g="move":b.indexOf(e)>=0&&(g="copy"),g}var b=a.editor,c=d.createElement("img");c.src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==",f.isOpera&&(c.style.cssText="width:1px;height:1px;position:fixed;top:0;left:0;z-index:2147483647;opacity:0;");var j=["dragWait","dragWaitEnd","startDrag","dragReadyEnd","onMouseDrag"];j.forEach(function(b){a[b]=this[b]},this),b.addEventListener("mousedown",this.onMouseDown.bind(a));
var m,n,o,p,q,r,t,u,v,w,x,l=b.container,s=0;this.onDragStart=function(a){if(this.cancelDrag||!l.draggable){var d=this;return setTimeout(function(){d.startSelect(),d.captureMouse(a)},0),a.preventDefault()}q=b.getSelectionRange();var e=a.dataTransfer;e.effectAllowed=b.getReadOnly()?"copy":"copyMove",f.isOpera&&(b.container.appendChild(c),c._top=c.offsetTop),e.setDragImage&&e.setDragImage(c,0,0),f.isOpera&&b.container.removeChild(c),e.clearData(),e.setData("Text",b.session.getTextRange()),u=!0,this.setState("drag")
},this.onDragEnd=function(a){if(l.draggable=!1,u=!1,this.setState(null),!b.getReadOnly()){var c=a.dataTransfer.dropEffect;t||"move"!=c||b.session.remove(b.getSelectionRange()),b.renderer.$cursorLayer.setBlinking(!0)}this.editor.unsetStyle("ace_dragging")},this.onDragEnter=function(a){return!b.getReadOnly()&&F(a.dataTransfer)?(m||B(),s++,a.dataTransfer.dropEffect=t=G(a),e.preventDefault(a)):void 0},this.onDragOver=function(a){return!b.getReadOnly()&&F(a.dataTransfer)?(m||(B(),s++),null!==D&&(D=null),n=a.clientX,o=a.clientY,a.dataTransfer.dropEffect=t=G(a),e.preventDefault(a)):void 0
},this.onDragLeave=function(a){return s--,0>=s&&m?(C(),t=null,e.preventDefault(a)):void 0},this.onDrop=function(a){if(m){var c=a.dataTransfer;if(u)switch(t){case"move":q=q.contains(r.row,r.column)?{start:r,end:r}:b.moveText(q,r);break;case"copy":q=b.moveText(q,r,!0)}else{var d=c.getData("Text");q={start:r,end:b.session.insert(r,d)},b.focus(),t=null}return C(),e.preventDefault(a)}},e.addListener(l,"dragstart",this.onDragStart.bind(a)),e.addListener(l,"dragend",this.onDragEnd.bind(a)),e.addListener(l,"dragenter",this.onDragEnter.bind(a)),e.addListener(l,"dragover",this.onDragOver.bind(a)),e.addListener(l,"dragleave",this.onDragLeave.bind(a)),e.addListener(l,"drop",this.onDrop.bind(a));
var D=null}function k(a,b,c,d){return Math.sqrt(Math.pow(c-a,2)+Math.pow(d-b,2))}var d=a("../lib/dom"),e=a("../lib/event"),f=a("../lib/useragent"),g=200,h=200,i=5;(function(){this.dragWait=function(){var a=Date.now()-this.mousedownEvent.time;a>this.editor.getDragDelay()&&this.startDrag()},this.dragWaitEnd=function(){var a=this.editor.container;a.draggable=!1,this.startSelect(this.mousedownEvent.getDocumentPosition()),this.selectEnd()},this.dragReadyEnd=function(){this.editor.renderer.$cursorLayer.setBlinking(!this.editor.getReadOnly()),this.editor.unsetStyle("ace_dragging"),this.dragWaitEnd()
},this.startDrag=function(){this.cancelDrag=!1;var a=this.editor.container;a.draggable=!0,this.editor.renderer.$cursorLayer.setBlinking(!1),this.editor.setStyle("ace_dragging"),this.setState("dragReady")},this.onMouseDrag=function(){var b=this.editor.container;if(f.isIE&&"dragReady"==this.state){var c=k(this.mousedownEvent.x,this.mousedownEvent.y,this.x,this.y);c>3&&b.dragDrop()}if("dragWait"===this.state){var c=k(this.mousedownEvent.x,this.mousedownEvent.y,this.x,this.y);c>0&&(b.draggable=!1,this.startSelect(this.mousedownEvent.getDocumentPosition()))
}},this.onMouseDown=function(a){if(this.$dragEnabled){this.mousedownEvent=a;var b=this.editor,c=a.inSelection(),d=a.getButton(),e=a.domEvent.detail||1;if(1===e&&0===d&&c){if(a.editor.inMultiSelectMode&&(a.getAccelKey()||a.getShiftKey()))return;this.mousedownEvent.time=Date.now();var g=a.domEvent.target||a.domEvent.srcElement;if("unselectable"in g&&(g.unselectable="on"),b.getDragDelay()){if(f.isWebKit){this.cancelDrag=!0;var h=b.container;h.draggable=!0}this.setState("dragWait")}else this.startDrag();this.captureMouse(a,this.onMouseDrag.bind(this)),a.defaultPrevented=!0
}}}}).call(j.prototype),b.DragdropHandler=j}),ace.define("ace/layer/marker",["require","exports","module","ace/range","ace/lib/dom"],function(a,b){var d=a("../range").Range,e=a("../lib/dom"),f=function(a){this.element=e.createElement("div"),this.element.className="ace_layer ace_marker-layer",a.appendChild(this.element)};(function(){this.$padding=0,this.setPadding=function(a){this.$padding=a},this.setSession=function(a){this.session=a},this.setMarkers=function(a){this.markers=a},this.update=function(a){var a=a||this.config;
...
for(var d=Math.max(b,a.firstRow),f=Math.min(c,a.lastRow),g=this.element.childNodes,h=0,i=a.firstRow;d>i;i++){var j=this.session.getFoldLine(i);if(j){if(j.containsRow(d)){d=j.start.row;break}i=j.end.row}h++}for(var i=d,j=this.session.getNextFoldLine(i),k=j?j.start.row:1/0;;){if(i>k&&(i=j.end.row+1,j=this.session.getNextFoldLine(i,j),k=j?j.start.row:1/0),i>f)break;var l=g[h++];if(l){var m=[];this.$renderLine(m,i,!this.$useLineGroups(),i==k?j:!1),l.style.height=a.lineHeight*this.session.getRowLength(i)+"px",e.setInnerHtml(l,m.join(""))
...
else for(;i.firstChild;)d.appendChild(i.firstChild);f++}return d},this.update=function(a){this.config=a;for(var b=[],c=a.firstRow,d=a.lastRow,f=c,g=this.session.getNextFoldLine(f),h=g?g.start.row:1/0;;){if(f>h&&(f=g.end.row+1,g=this.session.getNextFoldLine(f,g),h=g?g.start.row:1/0),f>d)break;this.$useLineGroups()&&b.push("<div class='ace_line_group' style='height:",a.lineHeight*this.session.getRowLength(f),"px'>"),this.$renderLine(b,f,!1,f==h?g:!1),this.$useLineGroups()&&b.push("</div>"),f++}this.element=e.setInnerHtml(this.element,b.join(""))
...
},this.$getFoldLineTokens=function(a,b){function e(a,b,c){for(var e=0,f=0;f+a[e].value.length<b;)if(f+=a[e].value.length,e++,e==a.length)return;if(f!=b){var g=a[e].value.substring(b-f);g.length>c-b&&(g=g.substring(0,c-b)),d.push({type:a[e].type,value:g}),f=b+g.length,e+=1}for(;c>f&&e<a.length;){var g=a[e].value;g.length+f>c?d.push({type:a[e].type,value:g.substring(0,c-f)}):d.push(a[e]),f+=g.length,e+=1}}var c=this.session,d=[],f=c.getTokens(a);return b.walk(function(a,b,g,h,i){null!=a?d.push({type:"fold",value:a}):(i&&(f=c.getTokens(b)),f.length&&e(f,h,g))
},b.end.row,this.session.getLine(b.end.row).length),d},this.$useLineGroups=function(){return this.session.getUseWrapMode()},this.destroy=function(){clearInterval(this.$pollSizeChangesTimer),this.$measureNode&&this.$measureNode.parentNode.removeChild(this.$measureNode),delete this.$measureNode}}).call(i.prototype),b.Text=i}),ace.define("ace/tooltip",["require","exports","module","ace/lib/oop","ace/lib/dom"],function(a,b){function f(a){this.isOpen=!1,this.$element=null,this.$parentNode=a}var e=(a("./lib/oop"),a("./lib/dom"));
(function(){this.$init=function(){return this.$element=e.createElement("div"),this.$element.className="ace_tooltip",this.$element.style.display="none",this.$parentNode.appendChild(this.$element),this.$element},this.getElement=function(){return this.$element||this.$init()},this.setText=function(a){e.setInnerText(this.getElement(),a)},this.setHtml=function(a){this.getElement().innerHTML=a},this.setPosition=function(a,b){this.getElement().style.left=a+"px",this.getElement().style.top=b+"px"},this.setClassName=function(a){e.addCssClass(this.getElement(),a)
},this.show=function(a,b,c){null!=a&&this.setText(a),null!=b&&null!=c&&this.setPosition(b,c),this.isOpen||(this.getElement().style.display="block",this.isOpen=!0)},this.hide=function(){this.isOpen&&(this.getElement().style.display="none",this.isOpen=!1)},this.getHeight=function(){return this.getElement().offsetHeight},this.getWidth=function(){return this.getElement().offsetWidth}}).call(f.prototype),b.Tooltip=f}),ace.define("ace/layer/cursor",["require","exports","module","ace/lib/dom"],function(a,b){var e,d=a("../lib/dom"),f=function(a){this.element=d.createElement("div"),this.element.className="ace_layer ace_cursor-layer",a.appendChild(this.element),void 0===e&&(e="opacity"in this.element),this.isVisible=!1,this.isBlinking=!0,this.blinkInterval=1e3,this.smoothBlinking=!1,this.cursors=[],this.cursor=this.addCursor(),d.addCssClass(this.element,"ace_hidden-cursors"),this.$updateCursors=this.$updateVisibility.bind(this)
...
},this.destroy=function(){clearInterval(this.intervalId),clearTimeout(this.timeoutId)}}).call(f.prototype),b.Cursor=f}),ace.define("ace/mouse/default_gutter_handler",["require","exports","module","ace/lib/dom","ace/lib/oop","ace/lib/event","ace/tooltip"],function(a,b){function h(a){function k(){var d=h.getDocumentPosition().row,f=c.$annotations[d];if(!f)return l();var g=b.session.getLength();if(d==g){var i=b.renderer.pixelToScreenCoordinates(0,h.y).row,k=h.$pos;if(i>b.session.documentToScreenRow(k.row,k.column))return l()
}if(j!=f)if(j=f.text.join("<br/>"),e.setHtml(j),e.show(),b.on("mousewheel",l),a.$tooltipFollowsMouse)m(h);else{var n=c.$cells[d].element,o=n.getBoundingClientRect(),p=e.getElement().style;p.left=o.right+"px",p.top=o.bottom+"px"}}function l(){g&&(g=clearTimeout(g)),j&&(e.hide(),j=null,b.removeEventListener("mousewheel",l))}function m(a){e.setPosition(a.x,a.y)}var b=a.editor,c=b.renderer.$gutterLayer,e=new i(b.container);a.editor.setDefaultHandler("guttermousedown",function(d){if(b.isFocused()&&0==d.getButton()){var e=c.getRegion(d);
if("foldWidgets"!=e){var f=d.getDocumentPosition().row,g=b.session.selection;if(d.getShiftKey())g.selectTo(f,0);else{if(2==d.domEvent.detail)return b.selectAll(),d.preventDefault();a.$clickSelection=b.selection.getLineRange(f)}return a.setState("selectByLines"),a.captureMouse(d),d.preventDefault()}}});var g,h,j;a.editor.setDefaultHandler("guttermousemove",function(b){var c=b.domEvent.target||b.domEvent.srcElement;return d.hasCssClass(c,"ace_fold-widget")?l():(j&&a.$tooltipFollowsMouse&&m(b),h=b,g||(g=setTimeout(function(){g=null,h&&!a.isMousePressed?k():l()
},50)),void 0)}),f.addListener(b.renderer.$gutter,"mouseout",function(){h=null,j&&!g&&(g=setTimeout(function(){g=null,l()},50))}),b.on("changeSession",l)}function i(a){g.call(this,a)}var d=a("../lib/dom"),e=a("../lib/oop"),f=a("../lib/event"),g=a("../tooltip").Tooltip;e.inherits(i,g),function(){this.setPosition=function(a,b){var c=window.innerWidth||document.documentElement.clientWidth,d=window.innerHeight||document.documentElement.clientHeight,e=this.getWidth(),f=this.getHeight();a+=15,b+=15,a+e>c&&(a-=a+e-c),b+f>d&&(b-=20+f),g.prototype.setPosition.call(this,a,b)
}}.call(i.prototype),b.GutterHandler=h}),ace.define("ace/scrollbar",["require","exports","module","ace/lib/oop","ace/lib/dom","ace/lib/event","ace/lib/event_emitter"],function(a,b){var d=a("./lib/oop"),e=a("./lib/dom"),f=a("./lib/event"),g=a("./lib/event_emitter").EventEmitter,h=function(a){this.element=e.createElement("div"),this.element.className="ace_scrollbar ace_scrollbar"+this.classSuffix,this.inner=e.createElement("div"),this.inner.className="ace_scrollbar-inner",this.element.appendChild(this.inner),a.appendChild(this.element),this.setVisible(!1),this.skipEvent=!1,f.addListener(this.element,"scroll",this.onScroll.bind(this)),f.addListener(this.element,"mousedown",f.preventDefault)
...
return e||200>c?(this.$lastScrollTime=b,d.renderer.scrollBy(a.wheelX*a.speed,a.wheelY*a.speed),a.stop()):void 0}}}).call(h.prototype),b.DefaultHandlers=h}),ace.define("ace/renderloop",["require","exports","module","ace/lib/event"],function(a,b){var d=a("./lib/event"),e=function(a,b){this.onRender=a,this.pending=!1,this.changes=0,this.window=b||window};(function(){this.schedule=function(a){if(this.changes=this.changes|a,!this.pending&&this.changes){this.pending=!0;var b=this;d.nextFrame(function(){b.pending=!1;
...
return void 0===b&&(this.charSizes[a]=this.$measureCharWidth(a)/this.$characterSize.width),b},this.destroy=function(){clearInterval(this.$pollSizeChangesTimer),this.el&&this.el.parentNode&&this.el.parentNode.removeChild(this.el)}}).call(i.prototype)}),ace.define("ace/keyboard/textinput",["require","exports","module","ace/lib/event","ace/lib/useragent","ace/lib/dom","ace/lib/lang"],function(a,b){var d=a("../lib/event"),e=a("../lib/useragent"),f=a("../lib/dom"),g=a("../lib/lang"),h=e.isChrome<18,i=function(a,b){function t(a){if(!m){if(B)b=0,d=a?0:c.value.length-1;
else var b=a?2:1,d=2;try{c.setSelectionRange(b,d)}catch(e){}}}function u(){m||(c.value=i,e.isWebKit&&s.schedule())}function M(){setTimeout(function(){n&&(c.style.cssText=n,n=""),null==b.renderer.$keepTextAreaAtCursor&&(b.renderer.$keepTextAreaAtCursor=!0,b.renderer.$moveTextAreaToCursor())},0)}var c=f.createElement("textarea");c.className="ace_text-input",e.isTouchPad&&c.setAttribute("x-palm-disable-auto-cap",!0),c.wrap="off",c.autocorrect="off",c.autocapitalize="off",c.spellcheck=!1,c.style.opacity="0",a.insertBefore(c,a.firstChild);
var i="",j=!1,k=!1,l=!1,m=!1,n="",o=!0;try{var p=document.activeElement===c}catch(q){}d.addListener(c,"blur",function(){b.onBlur(),p=!1}),d.addListener(c,"focus",function(){p=!0,b.onFocus(),t()}),this.focus=function(){c.focus()},this.blur=function(){c.blur()},this.isFocused=function(){return p};var r=g.delayedCall(function(){p&&t(o)}),s=g.delayedCall(function(){m||(c.value=i,p&&t())});e.isWebKit||b.addEventListener("changeSelection",function(){b.selection.isEmpty()!=o&&(o=!o,r.schedule())}),u(),p&&b.onFocus();
var v=function(a){return 0===a.selectionStart&&a.selectionEnd===a.value.length};if(!c.setSelectionRange&&c.createTextRange&&(c.setSelectionRange=function(a,b){var c=this.createTextRange();c.collapse(!0),c.moveStart("character",a),c.moveEnd("character",b),c.select()},v=function(a){try{var b=a.ownerDocument.selection.createRange()}catch(c){}return b&&b.parentElement()==a?b.text==a.value:!1}),e.isOldIE){var w=!1,x=function(a){if(!w){var b=c.value;if(!m&&b&&b!=i){if(a&&b==i[0])return y.schedule();D(b),w=!0,u(),w=!1
}}},y=g.delayedCall(x);d.addListener(c,"propertychange",x);var z={13:1,27:1};d.addListener(c,"keyup",function(a){return!m||c.value&&!z[a.keyCode]||setTimeout(K,0),(c.value.charCodeAt(0)||0)<129?y.call():(m?J():I(),void 0)}),d.addListener(c,"keydown",function(){y.schedule(50)})}var A=function(){j?j=!1:k?k=!1:v(c)?(b.selectAll(),t()):B&&t(b.selection.isEmpty())},B=null;this.setInputHandler=function(a){B=a},this.getInputHandler=function(){return B};var C=!1,D=function(a){B&&(a=B(a),B=null),l?(t(),a&&b.onPaste(a),l=!1):a==i.charAt(0)?C?b.execCommand("del",{source:"ace"}):b.execCommand("backspace",{source:"ace"}):(a.substring(0,2)==i?a=a.substr(2):a.charAt(0)==i.charAt(0)?a=a.substr(1):a.charAt(a.length-1)==i.charAt(0)&&(a=a.slice(0,-1)),a.charAt(a.length-1)==i.charAt(0)&&(a=a.slice(0,-1)),a&&b.onTextInput(a)),C&&(C=!1)
},E=function(){if(!m){var b=c.value;D(b),u()}},F=function(a){var e=b.getCopyText();if(!e)return d.preventDefault(a),void 0;var f=a.clipboardData||window.clipboardData;if(f&&!h){var g=f.setData("Text",e);g&&(b.onCut(),d.preventDefault(a))}g||(j=!0,c.value=e,c.select(),setTimeout(function(){j=!1,u(),t(),b.onCut()}))},G=function(a){var e=b.getCopyText();if(!e)return d.preventDefault(a),void 0;var f=a.clipboardData||window.clipboardData;if(f&&!h){var g=f.setData("Text",e);g&&(b.onCopy(),d.preventDefault(a))}g||(k=!0,c.value=e,c.select(),setTimeout(function(){k=!1,u(),t(),b.onCopy()
}))},H=function(a){var f=a.clipboardData||window.clipboardData;if(f){var g=f.getData("Text");g&&b.onPaste(g),e.isIE&&setTimeout(t),d.preventDefault(a)}else c.value="",l=!0};d.addCommandKeyListener(c,b.onCommandKey.bind(b)),d.addListener(c,"select",A),d.addListener(c,"input",E),d.addListener(c,"cut",F),d.addListener(c,"copy",G),d.addListener(c,"paste",H),"oncut"in c&&"oncopy"in c&&"onpaste"in c||d.addListener(a,"keydown",function(a){if((!e.isMac||a.metaKey)&&a.ctrlKey)switch(a.keyCode){case 67:G(a);break;case 86:H(a);
break;case 88:F(a)}});var I=function(){!m&&b.onCompositionStart&&(m={},b.onCompositionStart(),setTimeout(J,0),b.on("mousedown",K),b.selection.isEmpty()||(b.insert(""),b.session.markUndoGroup(),b.selection.clearSelection()),b.session.markUndoGroup())},J=function(){if(m&&b.onCompositionUpdate){var a=c.value.replace(/\x01/g,"");if(m.lastValue!==a&&(b.onCompositionUpdate(a),m.lastValue&&b.undo(),m.lastValue=a,m.lastValue)){var d=b.selection.getRange();b.insert(m.lastValue),b.session.markUndoGroup(),m.range=b.selection.getRange(),b.selection.setRange(d),b.selection.clearSelection()
}}},K=function(a){if(b.onCompositionEnd){var d=m;m=!1;var e=setTimeout(function(){e=null;var a=c.value.replace(/\x01/g,"");m||(a==d.lastValue?u():!d.lastValue&&a&&(u(),D(a)))});B=function(a){return e&&clearTimeout(e),a=a.replace(/\x01/g,""),a==d.lastValue?"":(d.lastValue&&e&&b.undo(),a)},b.onCompositionEnd(),b.removeListener("mousedown",K),"compositionend"==a.type&&d.range&&b.selection.setRange(d.range)}},L=g.delayedCall(J,50);if(d.addListener(c,"compositionstart",I),e.isGecko?d.addListener(c,"text",function(){L.schedule()
}):(d.addListener(c,"keyup",function(){L.schedule()}),d.addListener(c,"keydown",function(){L.schedule()})),d.addListener(c,"compositionend",K),this.getElement=function(){return c},this.setReadOnly=function(a){c.readOnly=a},this.onContextMenu=function(a){C=!0,n||(n=c.style.cssText),c.style.cssText="z-index:100000;"+(e.isIE?"opacity:0.1;":""),t(b.selection.isEmpty()),b._emit("nativecontextmenu",{target:b,domEvent:a});var g=b.container.getBoundingClientRect(),h=f.computedStyle(b.container),i=g.top+(parseInt(h.borderTopWidth)||0),j=g.left+(parseInt(g.borderLeftWidth)||0),k=g.bottom-i-c.clientHeight,l=function(a){c.style.left=a.clientX-j-2+"px",c.style.top=Math.min(a.clientY-i-2,k)+"px"
};l(a),"mousedown"==a.type&&(b.renderer.$keepTextAreaAtCursor&&(b.renderer.$keepTextAreaAtCursor=null),e.isWin&&d.capture(b.container,l,M))},this.onContextMenuClose=M,!e.isGecko||e.isMac){var N=function(a){b.textInput.onContextMenu(a),M()};d.addListener(b.renderer.scroller,"contextmenu",N),d.addListener(c,"contextmenu",N)}};b.TextInput=i}),ace.define("ace/lib/lang",["require","exports","module"],function(a,b){b.last=function(a){return a[a.length-1]},b.stringReverse=function(a){return a.split("").reverse().join("")
...
};return e.delay=function(a){c&&clearTimeout(c),c=setTimeout(d,a||b)},e.schedule=e,e.call=function(){this.cancel(),a()},e.cancel=function(){c&&clearTimeout(c),c=null},e.isPending=function(){return c},e}}),ace.define("ace/multi_select",["require","exports","module","ace/range_list","ace/range","ace/selection","ace/mouse/multi_select_handler","ace/lib/event","ace/lib/lang","ace/commands/multi_select_commands","ace/search","ace/edit_session","ace/editor","ace/config"],function(a,b){function m(a,b,c){return l.$options.wrap=!0,l.$options.needle=b,l.$options.backwards=-1==c,l.find(a)
}function p(a,b){return a.row==b.row&&a.column==b.column}function q(a){a.$multiselectOnSessionChange||(a.$onAddRange=a.$onAddRange.bind(a),a.$onRemoveRange=a.$onRemoveRange.bind(a),a.$onMultiSelect=a.$onMultiSelect.bind(a),a.$onSingleSelect=a.$onSingleSelect.bind(a),a.$multiselectOnSessionChange=b.onSessionChange.bind(a),a.$multiselectOnSessionChange(a),a.on("changeSession",a.$multiselectOnSessionChange),a.on("mousedown",g),a.commands.addCommands(j.defaultCommands),r(a))}function r(a){function d(){c&&(a.renderer.setMouseCursor(""),c=!1)
}var b=a.textInput.getElement(),c=!1;h.addListener(b,"keydown",function(b){18!=b.keyCode||b.ctrlKey||b.shiftKey||b.metaKey?c&&d():c||(a.renderer.setMouseCursor("crosshair"),c=!0)}),h.addListener(b,"keyup",d),h.addListener(b,"blur",d)}var d=a("./range_list").RangeList,e=a("./range").Range,f=a("./selection").Selection,g=a("./mouse/multi_select_handler").onMouseDown,h=a("./lib/event"),i=a("./lib/lang"),j=a("./commands/multi_select_commands");b.commands=j.defaultCommands.concat(j.multiSelectCommands);var k=a("./search").Search,l=new k,n=a("./edit_session").EditSession;
...
},this.$onRemoveRange=function(a){this.removeSelectionMarkers(a.ranges),this.renderer.updateCursor(),this.renderer.updateBackMarkers()},this.$onMultiSelect=function(){this.inMultiSelectMode||(this.inMultiSelectMode=!0,this.setStyle("ace_multiselect"),this.keyBinding.addKeyboardHandler(j.keyboardHandler),this.commands.setDefaultHandler("exec",this.$onMultiSelectExec),this.renderer.updateCursor(),this.renderer.updateBackMarkers())},this.$onSingleSelect=function(){this.session.multiSelect.inVirtualMode||(this.inMultiSelectMode=!1,this.unsetStyle("ace_multiselect"),this.keyBinding.removeKeyboardHandler(j.keyboardHandler),this.commands.removeDefaultHandler("exec",this.$onMultiSelectExec),this.renderer.updateCursor(),this.renderer.updateBackMarkers(),this._emit("changeSelection"))
},this.$onMultiSelectExec=function(a){var b=a.command,c=a.editor;if(c.multiSelect){if(b.multiSelectAction)"forEach"==b.multiSelectAction?d=c.forEachSelection(b,a.args):"forEachLine"==b.multiSelectAction?d=c.forEachSelection(b,a.args,!0):"single"==b.multiSelectAction?(c.exitMultiSelectMode(),d=b.exec(c,a.args||{})):d=b.multiSelectAction(c,a.args||{});else{var d=b.exec(c,a.args||{});c.multiSelect.addRange(c.multiSelect.toOrientedRange()),c.multiSelect.mergeOverlappingRanges()}return d}},this.forEachSelection=function(a,b,c){if(!this.inVirtualSelectionMode){var h,d=this.session,e=this.selection,g=e.rangeList,i=e._eventRegistry;
e._eventRegistry={};var j=new f(d);this.inVirtualSelectionMode=!0;for(var k=g.ranges.length;k--;){if(c)for(;k>0&&g.ranges[k].start.row==g.ranges[k-1].end.row;)k--;j.fromOrientedRange(g.ranges[k]),j.id=g.ranges[k].marker,this.selection=d.selection=j;var l=a.exec(this,b||{});void 0!==h&&(h=l),j.toOrientedRange(g.ranges[k])}j.detach(),this.selection=d.selection=e,this.inVirtualSelectionMode=!1,e._eventRegistry=i,e.mergeOverlappingRanges();var m=this.renderer.$scrollAnimation;return this.onCursorChange(),this.onSelectionChange(),m&&m.from==m.to&&this.renderer.animateScrolling(m.from),h
...
var d=this.$search.findAll(this.session);if(!d.length)return 0;this.$blockScrolling+=1;var e=this.multiSelect;c||e.toSingleRange(d[0]);for(var f=d.length;f--;)e.addRange(d[f],!0);return this.$blockScrolling-=1,d.length},this.selectMoreLines=function(a,b){var c=this.selection.toOrientedRange(),d=c.cursor==c.end,f=this.session.documentToScreenPosition(c.cursor);this.selection.$desiredColumn&&(f.column=this.selection.$desiredColumn);var g=this.session.screenToDocumentPosition(f.row+a,f.column);if(c.isEmpty())var i=g;
else var h=this.session.documentToScreenPosition(d?c.end:c.start),i=this.session.screenToDocumentPosition(h.row+a,h.column);if(d){var j=e.fromPoints(g,i);j.cursor=j.start}else{var j=e.fromPoints(i,g);j.cursor=j.end}if(j.desiredColumn=f.column,this.selection.inMultiSelectMode){if(b)var k=c.cursor}else this.selection.addRange(c);this.selection.addRange(j),k&&this.selection.substractPoint(k)},this.transposeSelections=function(a){for(var b=this.session,c=b.multiSelect,d=c.ranges,e=d.length;e--;){var f=d[e];if(f.isEmpty()){var g=b.getWordRange(f.start.row,f.start.column);
f.start.row=g.start.row,f.start.column=g.start.column,f.end.row=g.end.row,f.end.column=g.end.column}}c.mergeOverlappingRanges();for(var h=[],e=d.length;e--;){var f=d[e];h.unshift(b.getTextRange(f))}0>a?h.unshift(h.pop()):h.push(h.shift());for(var e=d.length;e--;){var f=d[e],g=f.clone();b.replace(f,h[e]),f.start.row=g.start.row,f.start.column=g.start.column}},this.selectMore=function(a,b){var c=this.session,d=c.multiSelect,e=d.toOrientedRange();e.isEmpty()&&(e=c.getWordRange(e.start.row,e.start.column),e.cursor=-1==a?e.start:e.end,this.multiSelect.addRange(e));
var f=c.getTextRange(e),g=m(c,f,a);g&&(g.cursor=-1==a?g.start:g.end,this.$blockScrolling+=1,this.session.unfold(g),this.multiSelect.addRange(g),this.$blockScrolling-=1,this.renderer.scrollCursorIntoView(null,.5)),b&&this.multiSelect.substractPoint(e.cursor)},this.alignCursors=function(){var a=this.session,b=a.multiSelect,c=b.ranges;if(c.length){var m=-1,n=c.filter(function(a){return a.cursor.row==m?!0:(m=a.cursor.row,void 0)});b.$onRemoveRange(n);var o=0,p=1/0,q=c.map(function(b){var c=b.cursor,d=a.getLine(c.row),e=d.substr(c.column).search(/\S/g);
return-1==e&&(e=0),c.column>o&&(o=c.column),p>e&&(p=e),e});c.forEach(function(b,c){var d=b.cursor,f=o-d.column,g=q[c]-p;f>g?a.insert(d,i.stringRepeat(" ",f-g)):a.remove(new e(d.row,d.column,d.row,d.column-f+g)),b.start.column=b.end.column=o,b.start.row=b.end.row=d.row,b.cursor=b.end}),b.fromOrientedRange(c[0]),this.renderer.updateCursor(),this.renderer.updateBackMarkers()}else{var d=this.selection.getRange(),f=d.start.row,g=d.end.row,h=f==g;if(h){var k,j=this.session.getLength();do k=this.session.getLine(g);
while(/[=:]/.test(k)&&++g<j);do k=this.session.getLine(f);while(/[=:]/.test(k)&&--f>0);0>f&&(f=0),g>=j&&(g=j-1)}var l=this.session.doc.removeLines(f,g);l=this.$reAlignText(l,h),this.session.doc.insert({row:f,column:0},l.join("\n")+"\n"),h||(d.start.column=0,d.end.column=l[l.length-1].length),this.selection.setRange(d)}},this.$reAlignText=function(a,b){function h(a){return i.stringRepeat(" ",a)}function j(a){return a[2]?h(e)+a[2]+h(f-a[2].length+g)+a[4].replace(/^([=:])\s+/,"$1 "):a[0]}function k(a){return a[2]?h(e+f-a[2].length)+a[2]+h(g," ")+a[4].replace(/^([=:])\s+/,"$1 "):a[0]
}function l(a){return a[2]?h(e)+a[2]+h(g)+a[4].replace(/^([=:])\s+/,"$1 "):a[0]}var e,f,g,c=!0,d=!0;return a.map(function(a){var b=a.match(/(\s*)(.*?)(\s*)([=:].*)/);return b?null==e?(e=b[1].length,f=b[2].length,g=b[3].length,b):(e+f+g!=b[1].length+b[2].length+b[3].length&&(d=!1),e!=b[1].length&&(c=!1),e>b[1].length&&(e=b[1].length),f<b[2].length&&(f=b[2].length),g>b[3].length&&(g=b[3].length),b):[a]}).map(b?j:c?d?k:j:l)}}).call(o.prototype),b.onSessionChange=function(a){var b=a.session;b.multiSelect||(b.$selectionMarkers=[],b.selection.$initRangeList(),b.multiSelect=b.selection),this.multiSelect=b.multiSelect;
...
},b.MultiSelect=q,a("./config").defineOptions(o.prototype,"editor",{enableMultiselect:{set:function(a){q(this),a?(this.on("changeSession",this.$multiselectOnSessionChange),this.on("mousedown",g)):(this.off("changeSession",this.$multiselectOnSessionChange),this.off("mousedown",g))},value:!0}})}),ace.define("ace/editor",["require","exports","module","ace/lib/fixoldbrowsers","ace/lib/oop","ace/lib/dom","ace/lib/lang","ace/lib/useragent","ace/keyboard/textinput","ace/mouse/mouse_handler","ace/mouse/fold_handler","ace/keyboard/keybinding","ace/edit_session","ace/search","ace/range","ace/lib/event_emitter","ace/commands/command_manager","ace/commands/default_commands","ace/config"],function(a,b){a("./lib/fixoldbrowsers");
...
}),ace.define("ace/mouse/multi_select_handler",["require","exports","module","ace/lib/event"],function(a,b){function e(a,b){return a.row==b.row&&a.column==b.column}function f(a){var b=a.domEvent,c=b.altKey,f=b.shiftKey,g=a.getAccelKey(),h=a.getButton();if(a.editor.inMultiSelectMode&&2==h)return a.editor.textInput.onContextMenu(a.domEvent),void 0;if(!g&&!c)return 0===h&&a.editor.inMultiSelectMode&&a.editor.exitMultiSelectMode(),void 0;var i=a.editor,j=i.selection,k=i.inMultiSelectMode,l=a.getDocumentPosition(),m=j.getCursor(),n=a.inSelection()||j.isEmpty()&&e(l,m),o=a.x,p=a.y,q=function(a){o=a.clientX,p=a.clientY
},r=function(){var a=i.renderer.pixelToScreenCoordinates(o,p),b=s.screenToDocumentPosition(a.row,a.column);e(u,a)&&e(b,j.selectionLead)||(u=a,i.selection.moveToPosition(b),i.renderer.scrollCursorIntoView(),i.removeSelectionMarkers(x),x=j.rectangularRangeBlock(u,t),x.forEach(i.addSelectionMarker,i),i.updateSelectionMarkers())},s=i.session,t=i.renderer.pixelToScreenCoordinates(o,p),u=t;if(!g||c||f||0!==h){if(c&&0===h){a.stop(),k&&!g?j.toSingleRange():!k&&g&&j.addRange();var x=[];f?(t=s.documentToScreenPosition(j.lead),r()):j.moveToPosition(l);
var y=function(){clearInterval(A),i.removeSelectionMarkers(x);for(var b=0;b<x.length;b++)j.addRange(x[b])},z=r;d.capture(i.container,q,y);var A=setInterval(function(){z()},20);return a.preventDefault()}}else{if(!k&&n)return;if(!k){var v=j.toOrientedRange();i.addSelectionMarker(v)}var w=j.rangeList.rangeAtPoint(l);i.$blockScrolling++,i.once("mouseup",function(){var a=j.toOrientedRange();w&&a.isEmpty()&&e(w.cursor,a.cursor)?j.substractPoint(a.cursor):(v&&(i.removeSelectionMarker(v),j.addRange(v)),j.addRange(a)),i.$blockScrolling--
})}}var d=a("../lib/event");b.onMouseDown=f}),ace.define("ace/lib/useragent",["require","exports","module"],function(a,b){if(b.OS={LINUX:"LINUX",MAC:"MAC",WINDOWS:"WINDOWS"},b.getOS=function(){return b.isMac?b.OS.MAC:b.isLinux?b.OS.LINUX:b.OS.WINDOWS},"object"==typeof navigator){var d=(navigator.platform.match(/mac|win|linux/i)||["other"])[0].toLowerCase(),e=navigator.userAgent;b.isWin="win"==d,b.isMac="mac"==d,b.isLinux="linux"==d,b.isIE=("Microsoft Internet Explorer"==navigator.appName||navigator.appName.indexOf("MSAppHost")>=0)&&parseFloat(navigator.userAgent.match(/(?:Trident\/[0-9]+[\.0-9]+;.*rv:|MSIE )([0-9]+[\.0-9]+)/)[1]),b.isOldIE=b.isIE&&b.isIE<9,b.isGecko=b.isMozilla=window.controllers&&"Gecko"===window.navigator.product,b.isOldGecko=b.isGecko&&parseInt((navigator.userAgent.match(/rv\:(\d+)/)||[])[1],10)<4,b.isOpera=window.opera&&"[object Opera]"==Object.prototype.toString.call(window.opera),b.isWebKit=parseFloat(e.split("WebKit/")[1])||void 0,b.isChrome=parseFloat(e.split(" Chrome/")[1])||void 0,b.isAIR=e.indexOf("AdobeAIR")>=0,b.isIPad=e.indexOf("iPad")>=0,b.isTouchPad=e.indexOf("TouchPad")>=0
...
for(var a=0;a<this.others.length;a++)this.others[a].detach();this.session.setUndoSelect(!0)},this.cancel=function(){if(-1===this.$undoStackDepth)throw Error("Canceling placeholders only supported with undo manager attached to session.");for(var a=this.session.getUndoManager(),b=(a.$undoStack||a.$undostack).length-this.$undoStackDepth,c=0;b>c;c++)a.undo(!0)}}).call(g.prototype),b.PlaceHolder=g}),ace.define("ace/lib/event",["require","exports","module","ace/lib/keys","ace/lib/useragent"],function(a,b){function g(a,b,c){var g=f(b);
if(!e.isMac&&h){if((h[91]||h[92])&&(g|=8),h.altGr){if(3==(3&g))return;h.altGr=0}if(18===c||17===c){var j=b.location||b.keyLocation;if(17===c&&1===j)i=b.timeStamp;else if(18===c&&3===g&&2===j){var k=-i;i=b.timeStamp,k+=i,3>k&&(h.altGr=!0)}}}if(c in d.MODIFIER_KEYS){switch(d.MODIFIER_KEYS[c]){case"Alt":g=2;break;case"Shift":g=4;break;case"Ctrl":g=1;break;default:g=8}c=-1}return 8&g&&(91===c||93===c)&&(c=-1),g||13!==c||!b.location&&3!==b.keyLocation||(a(b,g,-c),!b.defaultPrevented)?g||c in d.FUNCTION_KEYS||c in d.PRINTABLE_KEYS?a(b,g,c):!1:void 0
}var d=a("./keys"),e=a("./useragent");b.addListener=function(a,b,c){if(a.addEventListener)return a.addEventListener(b,c,!1);if(a.attachEvent){var d=function(){c.call(a,window.event)};c._wrapper=d,a.attachEvent("on"+b,d)}},b.removeListener=function(a,b,c){return a.removeEventListener?a.removeEventListener(b,c,!1):(a.detachEvent&&a.detachEvent("on"+b,c._wrapper||c),void 0)},b.stopEvent=function(a){return b.stopPropagation(a),b.preventDefault(a),!1},b.stopPropagation=function(a){a.stopPropagation?a.stopPropagation():a.cancelBubble=!0
},b.preventDefault=function(a){a.preventDefault?a.preventDefault():a.returnValue=!1},b.getButton=function(a){return"dblclick"==a.type?0:"contextmenu"==a.type||a.ctrlKey&&e.isMac?2:a.preventDefault?a.button:{1:0,2:2,4:1}[a.button]},b.capture=function(a,c,d){function e(a){c&&c(a),d&&d(a),b.removeListener(document,"mousemove",c,!0),b.removeListener(document,"mouseup",e,!0),b.removeListener(document,"dragstart",e,!0)}return b.addListener(document,"mousemove",c,!0),b.addListener(document,"mouseup",e,!0),b.addListener(document,"dragstart",e,!0),e
...
})},b.addMultiMouseDownListener=function(a,c,d,f){var h,i,j,g=0,k={2:"dblclick",3:"tripleclick",4:"quadclick"};b.addListener(a,"mousedown",function(a){if(0!==b.getButton(a)?g=0:a.detail>1?(g++,g>4&&(g=1)):g=1,e.isIE){var c=Math.abs(a.clientX-h)>5||Math.abs(a.clientY-i)>5;c&&(g=1),1==g&&(h=a.clientX,i=a.clientY)}if(d[f]("mousedown",a),g>4)g=0;else if(g>1)return d[f](k[g],a)}),e.isOldIE&&b.addListener(a,"dblclick",function(a){g=2,j&&clearTimeout(j),j=setTimeout(function(){j=null},c[g-1]||600),d[f]("mousedown",a),d[f](k[g],a)
})};var f=!e.isMac||!e.isOpera||"KeyboardEvent"in window?function(a){return 0|(a.ctrlKey?1:0)|(a.altKey?2:0)|(a.shiftKey?4:0)|(a.metaKey?8:0)}:function(a){return 0|(a.metaKey?1:0)|(a.altKey?2:0)|(a.shiftKey?4:0)|(a.ctrlKey?8:0)};b.getModifierString=function(a){return d.KEY_MODS[f(a)]};var h=null,i=0;if(b.addCommandKeyListener=function(a,c){var d=b.addListener;if(e.isOldGecko||e.isOpera&&!("KeyboardEvent"in window)){var f=null;d(a,"keydown",function(a){f=a.keyCode}),d(a,"keypress",function(a){return g(c,a,f)})
}else{var i=null;d(a,"keydown",function(a){h[a.keyCode]=!0;var b=g(c,a,a.keyCode);return i=a.defaultPrevented,b}),d(a,"keypress",function(a){i&&(a.ctrlKey||a.altKey||a.shiftKey||a.metaKey)&&(b.stopEvent(a),i=null)}),d(a,"keyup",function(a){h[a.keyCode]=null}),h||(h=Object.create(null),d(window,"focus",function(){h=Object.create(null)}))}},window.postMessage&&!e.isOldIE){var j=1;b.nextTick=function(a,c){c=c||window;var d="zero-timeout-message-"+j;b.addListener(c,"message",function e(f){f.data==d&&(b.stopPropagation(f),b.removeListener(c,"message",e),a())
...
var d=a("../lib/dom");d.importCssString(b.cssText,b.cssClass)}),ace.define("ace/lib/es5-shim",["require","exports","module"],function(){function d(){}function u(a){try{return Object.defineProperty(a,"sentinel",{}),"sentinel"in a}catch(b){}}function J(a){return a=+a,a!==a?a=0:0!==a&&a!==1/0&&a!==-(1/0)&&(a=(a>0||-1)*Math.floor(Math.abs(a))),a}Function.prototype.bind||(Function.prototype.bind=function(a){var b=this;if("function"!=typeof b)throw new TypeError("Function.prototype.bind called on incompatible "+b);
var c=h.call(arguments,1),e=function(){if(this instanceof e){var d=b.apply(this,c.concat(h.call(arguments)));return Object(d)===d?d:this}return b.apply(a,c.concat(h.call(arguments)))};return b.prototype&&(d.prototype=b.prototype,e.prototype=new d,d.prototype=null),e});var k,l,m,n,o,e=Function.prototype.call,f=Array.prototype,g=Object.prototype,h=f.slice,i=e.bind(g.toString),j=e.bind(g.hasOwnProperty);if((o=j(g,"__defineGetter__"))&&(k=e.bind(g.__defineGetter__),l=e.bind(g.__defineSetter__),m=e.bind(g.__lookupGetter__),n=e.bind(g.__lookupSetter__)),2!=[1,2].splice(0).length)if(function(){function a(a){var b=new Array(a+2);
return b[0]=b[1]=0,b}var c,b=[];return b.splice.apply(b,a(20)),b.splice.apply(b,a(26)),c=b.length,b.splice(5,0,"XXX"),c+1==b.length,c+1==b.length?!0:void 0}()){var p=Array.prototype.splice;Array.prototype.splice=function(a,b){return arguments.length?p.apply(this,[void 0===a?0:a,void 0===b?this.length-a:b].concat(h.call(arguments,2))):[]}}else Array.prototype.splice=function(a,b){var c=this.length;a>0?a>c&&(a=c):void 0==a?a=0:0>a&&(a=Math.max(c+a,0)),c>a+b||(b=c-a);var d=this.slice(a,a+b),e=h.call(arguments,2),f=e.length;
if(a===c)f&&this.push.apply(this,e);else{var g=Math.min(b,c-a),i=a+g,j=i+f-g,k=c-i,l=c-g;if(i>j)for(var m=0;k>m;++m)this[j+m]=this[i+m];else if(j>i)for(m=k;m--;)this[j+m]=this[i+m];if(f&&a===l)this.length=l,this.push.apply(this,e);else for(this.length=l+f,m=0;f>m;++m)this[a+m]=e[m]}return d};Array.isArray||(Array.isArray=function(a){return"[object Array]"==i(a)});var q=Object("a"),r="a"!=q[0]||!(0 in q);if(Array.prototype.forEach||(Array.prototype.forEach=function(a){var b=M(this),c=r&&"[object String]"==i(this)?this.split(""):b,d=arguments[1],e=-1,f=c.length>>>0;
if("[object Function]"!=i(a))throw new TypeError;for(;++e<f;)e in c&&a.call(d,c[e],e,b)}),Array.prototype.map||(Array.prototype.map=function(a){var b=M(this),c=r&&"[object String]"==i(this)?this.split(""):b,d=c.length>>>0,e=Array(d),f=arguments[1];if("[object Function]"!=i(a))throw new TypeError(a+" is not a function");for(var g=0;d>g;g++)g in c&&(e[g]=a.call(f,c[g],g,b));return e}),Array.prototype.filter||(Array.prototype.filter=function(a){var f,b=M(this),c=r&&"[object String]"==i(this)?this.split(""):b,d=c.length>>>0,e=[],g=arguments[1];
if("[object Function]"!=i(a))throw new TypeError(a+" is not a function");for(var h=0;d>h;h++)h in c&&(f=c[h],a.call(g,f,h,b)&&e.push(f));return e}),Array.prototype.every||(Array.prototype.every=function(a){var b=M(this),c=r&&"[object String]"==i(this)?this.split(""):b,d=c.length>>>0,e=arguments[1];if("[object Function]"!=i(a))throw new TypeError(a+" is not a function");for(var f=0;d>f;f++)if(f in c&&!a.call(e,c[f],f,b))return!1;return!0}),Array.prototype.some||(Array.prototype.some=function(a){var b=M(this),c=r&&"[object String]"==i(this)?this.split(""):b,d=c.length>>>0,e=arguments[1];
if("[object Function]"!=i(a))throw new TypeError(a+" is not a function");for(var f=0;d>f;f++)if(f in c&&a.call(e,c[f],f,b))return!0;return!1}),Array.prototype.reduce||(Array.prototype.reduce=function(a){var b=M(this),c=r&&"[object String]"==i(this)?this.split(""):b,d=c.length>>>0;if("[object Function]"!=i(a))throw new TypeError(a+" is not a function");if(!d&&1==arguments.length)throw new TypeError("reduce of empty array with no initial value");var f,e=0;if(arguments.length>=2)f=arguments[1];else for(;;){if(e in c){f=c[e++];
break}if(++e>=d)throw new TypeError("reduce of empty array with no initial value")}for(;d>e;e++)e in c&&(f=a.call(void 0,f,c[e],e,b));return f}),Array.prototype.reduceRight||(Array.prototype.reduceRight=function(a){var b=M(this),c=r&&"[object String]"==i(this)?this.split(""):b,d=c.length>>>0;if("[object Function]"!=i(a))throw new TypeError(a+" is not a function");if(!d&&1==arguments.length)throw new TypeError("reduceRight of empty array with no initial value");var e,f=d-1;if(arguments.length>=2)e=arguments[1];
else for(;;){if(f in c){e=c[f--];break}if(--f<0)throw new TypeError("reduceRight of empty array with no initial value")}do f in this&&(e=a.call(void 0,e,c[f],f,b));while(f--);return e}),Array.prototype.indexOf&&-1==[0,1].indexOf(1,2)||(Array.prototype.indexOf=function(a){var b=r&&"[object String]"==i(this)?this.split(""):M(this),c=b.length>>>0;if(!c)return-1;var d=0;for(arguments.length>1&&(d=J(arguments[1])),d=d>=0?d:Math.max(0,c+d);c>d;d++)if(d in b&&b[d]===a)return d;return-1}),Array.prototype.lastIndexOf&&-1==[0,1].lastIndexOf(0,-3)||(Array.prototype.lastIndexOf=function(a){var b=r&&"[object String]"==i(this)?this.split(""):M(this),c=b.length>>>0;
if(!c)return-1;var d=c-1;for(arguments.length>1&&(d=Math.min(d,J(arguments[1]))),d=d>=0?d:c-Math.abs(d);d>=0;d--)if(d in b&&a===b[d])return d;return-1}),Object.getPrototypeOf||(Object.getPrototypeOf=function(a){return a.__proto__||(a.constructor?a.constructor.prototype:g)}),!Object.getOwnPropertyDescriptor){var s="Object.getOwnPropertyDescriptor called on a non-object: ";Object.getOwnPropertyDescriptor=function(a,b){if("object"!=typeof a&&"function"!=typeof a||null===a)throw new TypeError(s+a);if(j(a,b)){var c,d,e;
if(c={enumerable:!0,configurable:!0},o){var f=a.__proto__;a.__proto__=g;var d=m(a,b),e=n(a,b);if(a.__proto__=f,d||e)return d&&(c.get=d),e&&(c.set=e),c}return c.value=a[b],c}}}if(Object.getOwnPropertyNames||(Object.getOwnPropertyNames=function(a){return Object.keys(a)}),!Object.create){var t;t=null===Object.prototype.__proto__?function(){return{__proto__:null}}:function(){var a={};for(var b in a)a[b]=null;return a.constructor=a.hasOwnProperty=a.propertyIsEnumerable=a.isPrototypeOf=a.toLocaleString=a.toString=a.valueOf=a.__proto__=null,a
},Object.create=function(a,b){var c;if(null===a)c=t();else{if("object"!=typeof a)throw new TypeError("typeof prototype["+typeof a+"] != 'object'");var d=function(){};d.prototype=a,c=new d,c.__proto__=a}return void 0!==b&&Object.defineProperties(c,b),c}}if(Object.defineProperty){var v=u({}),w="undefined"==typeof document||u(document.createElement("div"));if(!v||!w)var x=Object.defineProperty}if(!Object.defineProperty||x){var y="Property description must be an object: ",z="Object.defineProperty called on non-object: ",A="getters & setters can not be defined on this javascript engine";
Object.defineProperty=function(a,b,c){if("object"!=typeof a&&"function"!=typeof a||null===a)throw new TypeError(z+a);if("object"!=typeof c&&"function"!=typeof c||null===c)throw new TypeError(y+c);if(x)try{return x.call(Object,a,b,c)}catch(d){}if(j(c,"value"))if(o&&(m(a,b)||n(a,b))){var e=a.__proto__;a.__proto__=g,delete a[b],a[b]=c.value,a.__proto__=e}else a[b]=c.value;else{if(!o)throw new TypeError(A);j(c,"get")&&k(a,b,c.get),j(c,"set")&&l(a,b,c.set)}return a}}Object.defineProperties||(Object.defineProperties=function(a,b){for(var c in b)j(b,c)&&Object.defineProperty(a,c,b[c]);
return a}),Object.seal||(Object.seal=function(a){return a}),Object.freeze||(Object.freeze=function(a){return a});try{Object.freeze(function(){})}catch(B){Object.freeze=function(a){return function(b){return"function"==typeof b?b:a(b)}}(Object.freeze)}if(Object.preventExtensions||(Object.preventExtensions=function(a){return a}),Object.isSealed||(Object.isSealed=function(){return!1}),Object.isFrozen||(Object.isFrozen=function(){return!1}),Object.isExtensible||(Object.isExtensible=function(a){if(Object(a)===a)throw new TypeError;
for(var b="";j(a,b);)b+="?";a[b]=!0;var c=j(a,b);return delete a[b],c}),!Object.keys){var C=!0,D=["toString","toLocaleString","valueOf","hasOwnProperty","isPrototypeOf","propertyIsEnumerable","constructor"],E=D.length;for(var F in{toString:null})C=!1;Object.keys=function jb(a){if("object"!=typeof a&&"function"!=typeof a||null===a)throw new TypeError("Object.keys called on a non-object");var jb=[];for(var b in a)j(a,b)&&jb.push(b);if(C)for(var c=0,d=E;d>c;c++){var e=D[c];j(a,e)&&jb.push(e)}return jb}}Date.now||(Date.now=function(){return(new Date).getTime()
});var G="	\n\f\r \xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029\ufeff";if(!String.prototype.trim||G.trim()){G="["+G+"]";var H=new RegExp("^"+G+G+"*"),I=new RegExp(G+G+"*$");String.prototype.trim=function(){return String(this).replace(H,"").replace(I,"")}}var M=function(a){if(null==a)throw new TypeError("can't convert "+a+" to object");return Object(a)}}),ace.define("ace/lib/regexp",["require","exports","module"],function(){function g(a){return(a.global?"g":"")+(a.ignoreCase?"i":"")+(a.multiline?"m":"")+(a.extended?"x":"")+(a.sticky?"y":"")
}function h(a,b,c){if(Array.prototype.indexOf)return a.indexOf(b,c);for(var d=c||0;d<a.length;d++)if(a[d]===b)return d;return-1}var d={exec:RegExp.prototype.exec,test:RegExp.prototype.test,match:String.prototype.match,replace:String.prototype.replace,split:String.prototype.split},e=void 0===d.exec.call(/()??/,"")[1],f=function(){var a=/^/g;return d.test.call(a,""),!a.lastIndex}();f&&e||(RegExp.prototype.exec=function(a){var c,i,b=d.exec.apply(this,arguments);if("string"==typeof a&&b){if(!e&&b.length>1&&h(b,"")>-1&&(i=RegExp(this.source,d.replace.call(g(this),"g","")),d.replace.call(a.slice(b.index),i,function(){for(var a=1;a<arguments.length-2;a++)void 0===arguments[a]&&(b[a]=void 0)
})),this._xregexp&&this._xregexp.captureNames)for(var j=1;j<b.length;j++)c=this._xregexp.captureNames[j-1],c&&(b[c]=b[j]);!f&&this.global&&!b[0].length&&this.lastIndex>b.index&&this.lastIndex--}return b},f||(RegExp.prototype.test=function(a){var b=d.exec.call(this,a);return b&&this.global&&!b[0].length&&this.lastIndex>b.index&&this.lastIndex--,!!b}))}),ace.define("ace/ext/error_marker",["require","exports","module","ace/line_widgets","ace/lib/dom","ace/range"],function(a,b){function g(a,b,c){for(var d=0,e=a.length-1;e>=d;){var f=d+e>>1,g=c(b,a[f]);
if(g>0)d=f+1;else{if(!(0>g))return f;e=f-1}}return-(d+1)}function h(a,b,c){var d=a.getAnnotations().sort(f.comparePoints);if(d.length){var e=g(d,{row:b,column:-1},f.comparePoints);0>e&&(e=-e-1),e>=d.length-1?e=c>0?0:d.length-1:0===e&&0>c&&(e=d.length-1);var h=d[e];if(h&&c){if(h.row===b){do h=d[e+=c];while(h&&h.row===b);if(!h)return d.slice()}var i=[];b=h.row;do i[0>c?"unshift":"push"](h),h=d[e+=c];while(h&&h.row==b);return i.length&&i}}}var d=a("ace/line_widgets").LineWidgets,e=a("ace/lib/dom"),f=a("ace/range").Range;
b.showErrorMarker=function(a,b){var c=a.session;c.widgetManager||(c.widgetManager=new d(c),c.widgetManager.attach(a));var f=a.getCursorPosition(),g=f.row,i=c.lineWidgets&&c.lineWidgets[g];i?i.destroy():g-=b;var k,j=h(c,g,b);if(j){var l=j[0];f.column=(l.pos&&"number"!=typeof l.column?l.pos.sc:l.column)||0,f.row=l.row,k=a.renderer.$gutterLayer.$annotations[f.row]}else{if(i)return;k={text:["Looks good!"],className:"ace_ok"}}a.session.unfold(f.row),a.selection.moveToPosition(f);var m={row:f.row,fixedWidth:!0,coverGutter:!0,el:e.createElement("div")},n=m.el.appendChild(e.createElement("div")),o=m.el.appendChild(e.createElement("div"));
o.className="error_widget_arrow "+k.className;var p=a.renderer.$cursorLayer.getPixelPosition(f).left;o.style.left=p+a.renderer.gutterWidth-5+"px",m.el.className="error_widget_wrapper",n.className="error_widget "+k.className,n.innerHTML=k.text.join("<br>"),n.appendChild(e.createElement("div"));var q=function(a,b,c){return 0!==b||"esc"!==c&&"return"!==c?void 0:(m.destroy(),{command:"null"})};m.destroy=function(){a.$mouseHandler.isMousePressed||(a.keyBinding.removeKeyboardHandler(q),c.widgetManager.removeLineWidget(m),a.off("changeSelection",m.destroy),a.off("changeSession",m.destroy),a.off("mouseup",m.destroy),a.off("change",m.destroy))
},a.keyBinding.addKeyboardHandler(q),a.on("changeSelection",m.destroy),a.on("changeSession",m.destroy),a.on("mouseup",m.destroy),a.on("change",m.destroy),a.session.widgetManager.addLineWidget(m),m.el.onmousedown=a.focus.bind(a),a.renderer.scrollCursorIntoView(null,.5,{bottom:m.el.offsetHeight})},e.importCssString("    .error_widget_wrapper {        background: inherit;        color: inherit;        border:none    }    .error_widget {        border-top: solid 2px;        border-bottom: solid 2px;        margin: 5px 0;        padding: 10px 40px;        white-space: pre-wrap;    }    .error_widget.ace_error, .error_widget_arrow.ace_error{        border-color: #ff5a5a    }    .error_widget.ace_warning, .error_widget_arrow.ace_warning{        border-color: #F1D817    }    .error_widget.ace_info, .error_widget_arrow.ace_info{        border-color: #5a5a5a    }    .error_widget.ace_ok, .error_widget_arrow.ace_ok{        border-color: #5aaa5a    }    .error_widget_arrow {        position: absolute;        border: solid 5px;        border-top-color: transparent!important;        border-right-color: transparent!important;        border-left-color: transparent!important;        top: -5px;    }","")
}),ace.define("ace/lib/fixoldbrowsers",["require","exports","module","ace/lib/regexp","ace/lib/es5-shim"],function(a){a("./regexp"),a("./es5-shim")}),ace.define("ace/line_widgets",["require","exports","module","ace/lib/oop","ace/lib/dom","ace/range"],function(a,b){function g(a){this.session=a,this.session.widgetManager=this,this.session.getRowLength=this.getRowLength,this.session.$getWidgetScreenLength=this.$getWidgetScreenLength,this.updateOnChange=this.updateOnChange.bind(this),this.renderWidgets=this.renderWidgets.bind(this),this.measureWidgets=this.measureWidgets.bind(this),this.session._changedWidgets=[],this.detach=this.detach.bind(this),this.session.on("change",this.updateOnChange)
}{var e=(a("./lib/oop"),a("./lib/dom"));a("./range").Range}(function(){this.getRowLength=function(a){var b;return b=this.lineWidgets?this.lineWidgets[a]&&this.lineWidgets[a].rowCount||0:0,this.$useWrapMode&&this.$wrapData[a]?this.$wrapData[a].length+1+b:1+b},this.$getWidgetScreenLength=function(){var a=0;return this.lineWidgets.forEach(function(b){b&&b.rowCount&&(a+=b.rowCount)}),a},this.attach=function(a){a.widgetManager&&a.widgetManager!=this&&a.widgetManager.detach(),this.editor!=a&&(this.detach(),this.editor=a,this.editor.on("changeSession",this.detach),a.widgetManager=this,a.setOption("enableLineWidgets",!0),a.renderer.on("beforeRender",this.measureWidgets),a.renderer.on("afterRender",this.renderWidgets))
...
}}}}}).call(g.prototype),b.LineWidgets=g}),ace.define("ace/document",["require","exports","module","ace/lib/oop","ace/lib/event_emitter","ace/range","ace/anchor"],function(a,b){var d=a("./lib/oop"),e=a("./lib/event_emitter").EventEmitter,f=a("./range").Range,g=a("./anchor").Anchor,h=function(a){this.$lines=[],0===a.length?this.$lines=[""]:Array.isArray(a)?this._insertLines(0,a):this.insert({row:0,column:0},a)};(function(){d.implement(this,e),this.setValue=function(a){var b=this.getLength();this.remove(new f(0,0,b,this.getLine(b-1).length)),this.insert({row:0,column:0},a)
...
return e+a.column}}).call(h.prototype),b.Document=h}),function(){ace.require(["ace/ace"],function(a){a&&a.config.init(!0),window.ace||(window.ace=a);for(var b in a)a.hasOwnProperty(b)&&(ace[b]=a[b])})}()};c(),b.resolveWith(c)};FD50.module("ace",a)}();