	...
	open: function(options) {
		...
		switch (contentType) {
			...
			case "iframe":
				...
				// Convert any html entities to the correct url format
				var iframeUrl = $('<div />').html(content).text();
...
FD50.module("dialog", moduleFactory);
