!function(){var a=function(a){var b=this,c=a,d=function(){!function(a){function f(){return a("<div/>")}var b=Math.abs,c=Math.max,d=Math.min,e=function(a){return a};a.imgAreaSelect=function(g,h){function X(a){return a+s.left-w.left}function Y(a){return a+s.top-w.top}function Z(a){return a-s.left+w.left}function $(a){return a-s.top+w.top}function _(a){return a.pageX-w.left}function ab(a){return a.pageY-w.top}function bb(a){var b=a||B,c=a||C;return{x1:e(O.x1*b),y1:e(O.y1*c),x2:e(O.x2*b),y2:e(O.y2*c),width:e(O.x2*b)-e(O.x1*b),height:e(O.y2*c)-e(O.y1*c)}
...
}),b.instance?a(this).data("imgAreaSelect"):this}}(c)};d(),b.resolveWith(d)};FD50.module("imgareaselect",a)}();