...
class plgEventBookingAcym extends JPlugin
{
	/**
	 * Application object.
	 *
	...
	public function __construct(& $subject, $config)
	{
		...
		JFactory::getLanguage()->load('plg_eventbooking_acym', JPATH_ADMINISTRATOR);
	}
	...
	public function onEditEvent($row)
	{
		...
		return ['title' => JText::_('PLG_EB_ACYM_LIST_SETTINGS'),
		        'form'  => ob_get_clean(),
		];
	}
        ...
        <table class="admintable adminform" style="width: 90%;">
            <tr>
                <td width="220" class="key">
					<?php echo JText::_('PLG_EB_ACYM_ASSIGN_TO_LIST_USER'); ?>
                </td>
                <td>
					<?php echo JHtml::_('select.genericlist', $allLists, 'acymailing_list_ids[]', 'class="inputbox" multiple="multiple" size="10"', 'id', 'name', $listIds) ?>
                </td>
                <td>
					<?php echo JText::_('PLG_EB_ACYM_ASSIGN_TO_LIST_USER_EXPLAIN'); ?>
                </td>
            </tr>
        </table>
		<?php
