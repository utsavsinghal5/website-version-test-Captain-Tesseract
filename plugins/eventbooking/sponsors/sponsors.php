...
class plgEventBookingSponsors extends JPlugin
{
	/**
	 * Application object.
	 *
	...
	public function onEditEvent($row)
	{
		...
		return ['title' => JText::_('EB_SPONSORS'),
	...
	public function onAfterSaveEvent($row, $data, $isNew)
	{
		...
		foreach ($sponsors as $sponsor)
		{
			...
			$rowSponsor = JTable::getInstance('Sponsor', 'EventbookingTable');
	...
	private function drawSettingForm($row)
	{
		...
		JFactory::getApplication()->triggerEvent('onContentPrepareForm', [$form, $formData]);
	...
	public function onEventDisplay($row)
	{
		...
		return ['title'    => JText::_('EB_EVENT_SPONSORS'),
