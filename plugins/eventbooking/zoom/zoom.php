...
class plgEventbookingZoom extends JPlugin
{
	/**
	 * Application object.
	 *
	...
	public function onEditEvent($row)
	{
		...
		return ['title' => JText::_('PLG_EVENTBOOKING_ZOOM_SETTINGS'),
		        'form'  => ob_get_clean(),
		];
	}
	...
	private function drawSettingForm($row)
	{
        ...
        <div class="control-group">
            <label class="control-label">
				<?php echo EventbookingHelperHtml::getFieldLabel('zoom_meeting_id', JText::_('EB_MEETING_ID'), JText::_('EB_MEETING_ID_EXPLAIN')); ?>
            </label>
            <div class="controls">
        ...
        <div class="control-group">
            <label class="control-label">
				<?php echo EventbookingHelperHtml::getFieldLabel('zoom_webinar_id', JText::_('EB_WEBINAR_ID'), JText::_('EB_WEBINAR_ID_EXPLAIN')); ?>
            </label>
            <div class="controls">
