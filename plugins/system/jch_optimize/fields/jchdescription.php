...
class JFormFieldJchdescription extends JFormField
{
	...
	protected function getInput()
	{
		...
		switch ($attributes['section'])
		{
			...
			case 'version':
				$header      = '';
				$description = '<h4>(Version 6.1.1)</h4>'. '<br />'
				. '<p class="alert alert-info alert-block">Upgrade to the pro version now using coupon code JCHGOPRO20 for a 20% discount!!</p>';
				break;
