        ...
        <div class="general-tabs">
            ...
            <div class="tab-content">
                <div id="slideshow-general-options" class="row-fluid tab-pane active">
                    <div class="ba-settings-group items-list not-field-slideshow">
...
?>
                    ...
                    <div class="ba-settings-group">
                        ...
                        <div class="ba-settings-item slideshow-options thumbnails-navigation-options">
                            ...
                            <div class="ba-range-wrapper">
                                <span class="ba-range-liner"></span>
                                <input type="range" class="ba-range" min="0" max="1500">
                                <input type="number" data-option="width" data-group="thumbnails" data-callback="sectionRules"
                                    class="set-value-css">
                            </div>
                        </div>
                        <div class="ba-settings-item slideshow-options thumbnails-navigation-options">
                            ...
                            <div class="ba-range-wrapper">
                                <span class="ba-range-liner"></span>
                                <input type="range" class="ba-range" min="0" max="1500">
                                <input type="number" data-option="height" data-group="thumbnails" data-callback="sectionRules"
                                    class="set-value-css">
                            </div>
                        </div>
                        <div class="ba-settings-item slideshow-options thumbnails-navigation-options">
                    ...
                    <div class="ba-settings-group not-field-slideshow">
